...
OPCUAServerEndPoint.prototype.__defineGetter__("bytesWritten",function() {
    ...
    return this.bytesWrittenInOldChannels + chnls.reduce(function(accumulated,endpoint) { return accumulated + endpoint.bytesWritten},0);
});

OPCUAServerEndPoint.prototype.__defineGetter__("bytesRead",function() {
    var chnls = _.values(this._channels);
    return  this.bytesReadInOldChannels + chnls.reduce(function(accumulated,endpoint) { return accumulated + endpoint.bytesRead},0);
});

OPCUAServerEndPoint.prototype.__defineGetter__("transactionsCount",function() {
    var chnls = _.values(this._channels);
    return  this.transactionsCountOldChannels + chnls.reduce(function(accumulated,endpoint) { return accumulated + endpoint.transactionsCount},0);
});
