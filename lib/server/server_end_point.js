...
const UserIdentityTokenType = s.UserIdentityTokenType;
...
const ServerSecureChannelLayer = require("lib/server/server_secure_channel_layer").ServerSecureChannelLayer;
const EndpointDescription = require("lib/services/get_endpoints_service").EndpointDescription;
...
function _makeEndpointDescription(options) {
    ...
    const securityPolicyUri = securityPolicy_m.toURI(options.securityPolicy);
...
function matching_endpoint(securityMode, securityPolicy, endpoint) {
    ...
    const endpoint_securityPolicy = securityPolicy_m.fromURI(endpoint.securityPolicyUri);
