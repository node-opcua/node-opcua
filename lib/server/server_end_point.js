...
OPCUAServerEndPoint.prototype.endpointDescriptions = function () {
    ...
    if (!self._endpoints) {
        ...
        if (!crypto_utils.isFullySupported()) {
            ...
            self._endpoints.push(_makeEndpointDescription(port, cert, s.MessageSecurityMode.SIGN, SecurityPolicy.Basic256));
            self._endpoints.push(_makeEndpointDescription(port, cert, s.MessageSecurityMode.SIGNANDENCRYPT, SecurityPolicy.Basic256));
