...
function OPCUAServerEndPoint(server, port,options) {
    ...
    self._server = net.createServer(
        ...
        function (socket) {
            ...
            //xx serverCertificate: self.serverCertificate;
 ...
 * @return {Buffer}
 */
OPCUAServerEndPoint.prototype.getCertificate = function() { return this.server.getCertificate(); };

/**
 * @method getPrivateKey
 * @return {Buffer} the privateKey
 */
OPCUAServerEndPoint.prototype.getPrivateKey = function() { return this.server.getPrivateKey(); };
...
//
//    assert(securityMode  instanceof s.MessageSecurityMode);
...
////            securityPolicyUri = "http://opcfoundation.org/UA/SecurityPolicy#Basic128";
...
OPCUAServerEndPoint.prototype.endpointDescriptions = function () {
    ...
    if (!self._endpoints) {
        ...
        self._endpoints.push(_makeEndpointDescription(port,cert,s.MessageSecurityMode.NONE          ,SecurityPolicy.None));
        self._endpoints.push(_makeEndpointDescription(port,cert,s.MessageSecurityMode.SIGN          ,SecurityPolicy.Basic256Rsa15));
        self._endpoints.push(_makeEndpointDescription(port,cert,s.MessageSecurityMode.SIGN          ,SecurityPolicy.Basic128Rsa15));
        self._endpoints.push(_makeEndpointDescription(port,cert,s.MessageSecurityMode.SIGNANDENCRYPT,SecurityPolicy.Basic256Rsa15));
        self._endpoints.push(_makeEndpointDescription(port,cert,s.MessageSecurityMode.SIGNANDENCRYPT,SecurityPolicy.Basic128Rsa15));
    }
