...
OPCUAServerEndPoint.prototype.endpointDescriptions = function () {
    ...
    if (!self._endpoints) {
        ...
        //        self._endpoints.push(_makeEndpointDescription(port, cert256, s.MessageSecurityMode.SIGN, SecurityPolicy.Basic256Rsa15));
        //        self._endpoints.push(_makeEndpointDescription(port, cert256, s.MessageSecurityMode.SIGNANDENCRYPT, SecurityPolicy.Basic256Rsa15));
        //    }
    }
