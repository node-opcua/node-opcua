...
function OPCUABaseServer(options) {
    ...
    var default_certificate_file =path.join(folder,"../../certificates/server_cert_1024.pem");
    options.certificateFile = options.certificateFile || default_certificate_file;

    var default_private_key_file =path.join(folder,"../../certificates/server_key_1024.pem");
