...
var MessageBuilder  = require("../secure_channel_service").MessageBuilder;
...
function ServerSecureChannelLayer() {
    ...
    self.messageBuilder.on("raw_buffer", function (full_message_body) {
...
ServerSecureChannelLayer.prototype._wait_for_open_secure_channel_request = function(callback,timeout) {
    ...
    self.messageBuilder.once("message",function(message){
...
ServerSecureChannelLayer.prototype._on_OpenSecureChannelRequest = function(request,callback) {
    ...
    if(request._description.name != "OpenSecureChannelRequest") {
    ...
    self.messageBuilder.on("message", function (request) {
