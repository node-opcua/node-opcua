...
ServerSecureChannelLayer.prototype._prepare_security_header = function(request,message) {
    ...
    var self = this;
    //xx console.log("MESSAGE securityPolicyUri",message.securityHeader.securityPolicyUri);
    //xx console.log("        securityMode     ",request.securityMode);
    ...
    switch(request.securityMode.value) {
        ...
        case MessageSecurityMode.SIGN.value:
            self.securityHeader = new AsymmetricAlgorithmSecurityHeader({
                securityPolicyUri: message.securityHeader.securityPolicyUri,
        ...
        case MessageSecurityMode.SIGNANDENCRYPT.value:
            ...
            var thumbprint = crypto_utils.makeSHA1Thumbprint(self.receiverCertificate);
...
ServerSecureChannelLayer.prototype._handle_OpenSecureChannelRequest = function (message) {
    ...
    self._process_certificates(message,function() {
        ...
        self.messageBuilder.derivedKeys = self.derivedClientKeys;
...
ServerSecureChannelLayer.prototype._check_receiverCertificateThumbprint =  function (securityHeader) {
    ...
    if (securityHeader.receiverCertificateThumbprint ) {
        ...
        //xx console.log("myCertificateThumbPrint  ", hexDump(myCertificateThumbPrint));
        //xx console.log("receiverCertificateThumbprint  ", hexDump(securityHeader.receiverCertificateThumbprint));
...
ServerSecureChannelLayer.prototype._on_initial_OpenSecureChannelRequest = function (message, callback) {
    ...
    switch(self.securityMode.value) {
        ...
        case MessageSecurityMode.SIGN.value:
            ...
            if (self.securityHeader.receiverCertificateThumbprint) {
                callback(new Error("SIGN mode :  expect certificate  thumbprint to be  null !"));
                return;
            }
            break;
        ...
        case MessageSecurityMode.SIGNANDENCRYPT.value:
            ...
            break;
        default:
            callback(new Error("Invalid security received !!!"));
            return;
    }
