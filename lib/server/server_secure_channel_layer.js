...
const crypto_utils = require("lib/misc/crypto_utils");
...
const MessageChunker = require("lib/misc/message_chunker").MessageChunker;
...
const MessageSecurityMode = s.MessageSecurityMode;
const ChannelSecurityToken = s.ChannelSecurityToken;
const ServiceFault = s.ServiceFault;
...
const SecurityTokenRequestType = endpoints_service.SecurityTokenRequestType;
...
const analyze_object_binary_encoding = require("lib/misc/packet_analyzer").analyze_object_binary_encoding;
...
const get_clock_tick = require("lib/misc/utils").get_clock_tick;
...
ServerSecureChannelLayer.prototype.init = function (socket, callback) {
  ...
  const ServerTCP_transport = require("lib/transport/server_tcp_transport").ServerTCP_transport;
