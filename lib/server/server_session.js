...
const ContinuationPointManager = require("lib/server/continuation_point_manager").ContinuationPointManager;
...
const WatchDog = require("lib/misc/watchdog").WatchDog;
...
const SessionDiagnostics = require("schemas/39394884f696ff0bf66bacc9a8032cc074e0158e/SessionDiagnostics").SessionDiagnostics;
...
const Subscription = require("lib/server/subscription").Subscription;
