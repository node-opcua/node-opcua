...
ServerEngine.prototype.initialize = function(options,callback) {
    ...
    generate_address_space(self.address_space, options.nodeset_filename,function(){
        ...
        self.bindVariable(server_ServerArray_Id,{
            get: function(){
                console.log(" READING server_ServerArray_Id");
                return new Variant({
                    dataType: DataType.String,
                    arrayType: VariantArrayType.Array,
                    value: [
        ...
        self.bindVariable(server_ServerStatus_State,{
            get: function(){
                console.log(" READING server_ServerStatus_State");
                return new Variant({
                    dataType: DataType.String,
                    arrayType: VariantArrayType.Array,
                    value: [
...
ServerEngine.prototype.findNodeIdByBrowseName = function(browseName) {
    var self = this;
    assert(self.address_space instanceof AddressSpace); // initialize not called
    var obj = self.address_space.findObjectByBrowseName(browseName);
 ...
 * @return {Subscription}
 */
ServerEngine.prototype.getSubscriptionCount = function () {
