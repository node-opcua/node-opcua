...
// binding methods
function getMonitoredItemId(inputArguments,context,callback) {
    ...
    console.log(result.serverHandles);
    console.log(result.clientHandles);

    var callMethodResponse = {
    ...
    callback(null, callMethodResponse);
...
ServerEngine.prototype.initialize = function (options, callback) {
    ...
    generate_address_space(self.address_space, options.nodeset_filename, function () {
        ...
        self.bindMethod(MethodIds.Server_GetMonitoredItems,getMonitoredItemId.bind(self));
