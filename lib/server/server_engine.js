...
var mini_nodeset_filename = mini_nodeset_filename = path.join(__dirname,"./mini.Node.Set2.xml");
...
ServerEngine.prototype.initialize = function (options, callback) {
    ...
    console.log("Loading ",options.nodeset_filename, "...");
    ...
    generate_address_space(self.address_space, options.nodeset_filename, function () {
        ...
        console.log("Loading ",options.nodeset_filename, " done : ",endTime - startTime," ms");
