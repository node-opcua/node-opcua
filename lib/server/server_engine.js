...
ServerEngine.prototype.initialize = function (options, callback) {
    ...
    generate_address_space(self.address_space, options.nodeset_filename, function () {
        ...
        bindVariableIfPresent(makeNodeId(VariableIds.Server_ServerStatus), {
            ...
            get: function() { return serverStatus_var; },
            set: null
        });
        ...
        bindVariableIfPresent(makeNodeId(VariableIds.Server_ServerStatus_BuildInfo), {
            ...
            get: function () { return buildInfo_var; },
            set: null
        });


        var serverNamespaceUrn_var =new Variant({
        ...
        bindVariableIfPresent(server_ServerStatus_State, {
            ...
            get: function () { return serverState_var;},
            set: null // read only
        });
...
function _DEPRECATED_RENAMED(oldName,newName) {
    return function() {
        console.log((" WARNING : method " + oldName + " is deprecated and has been renamed as "+newName).yellow);
        this.constructor.prototype[newName].apply(this,arguments);
    }
}
...
ServerEngine.prototype.addMethod = function (parentObject, options) {
    ...
    var inputArguments = self.address_space.addProperty(method, {
    ...
    var outputArguments = self.address_space.addProperty(method, {
        typeDefinition: "PropertyType",
