...
ServerEngine.prototype.createSession = function (options) {
    ...
    session.on("timeout", function () {
        ...
        console.log("Server: closing SESSION ".cyan, session.sessionName.yellow, " because of timeout = ".cyan, session.sessionTimeout, " has expired without a keep alive".cyan);
