...
const NodeIdType = require("lib/datamodel/nodeid").NodeIdType;
...
const BrowseDirection = browse_service.BrowseDirection;
const BrowseResult = browse_service.BrowseResult;
...
const isValidVariant = require("lib/datamodel/variant").isValidVariant;
const LocalizedText = require("lib/datamodel/localized_text").LocalizedText;
const BuildInfo = require("lib/datamodel/buildinfo").BuildInfo;

const util = require("util");


const StatusCodes = require("lib/datamodel/opcua_status_code").StatusCodes;
const StatusCode = require("lib/datamodel/opcua_status_code").StatusCode;

const _ = require("underscore");

const address_space = require("lib/address_space/address_space");
...
const ServerSession = require("lib/server/server_session").ServerSession;
...
const ReferenceType = require("lib/address_space/referenceType").ReferenceType;


const EventEmitter = require("events").EventEmitter;

const ServerState = require("schemas/39394884f696ff0bf66bacc9a8032cc074e0158e/ServerState_enum").ServerState;
const ServerStatus = require("_generated_/_auto_generated_ServerStatus").ServerStatus;

const ServerDiagnosticsSummary = require("_generated_/_auto_generated_ServerDiagnosticsSummary").ServerDiagnosticsSummary;
...
const eoan = require("lib/address_space/extension_object_array_node");

const ServerSidePublishEngine = require("lib/server/server_publish_engine").ServerSidePublishEngine;
 ...
 */
ServerEngine.prototype.secondsTillShutdown = () => // ToDo: implement a correct solution here
1;


const CallMethodResult = require("lib/services/call_service").CallMethodResult;
// binding methods
...
const Argument = require("lib/datamodel/argument_list").Argument;
...
const apply_timestamps = require("lib/datamodel/datavalue").apply_timestamps;
...
const WriteValue = require("lib/services/write_service").WriteValue;
...
const TransferResult = require("_generated_/_auto_generated_TransferResult").TransferResult;
/**
 *
 * @param session           {ServerSession}
