 ...
 *
 */
ServerEngine.prototype.bindVariable = _DEPRECATED_SOON_REMOVED("bindVariable",function (nodeId, options) {
    return  __bindVariable(this,nodeId,options);
}," use node.bind() instead");
