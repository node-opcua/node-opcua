 ...
 * @return {BaseNode}
 */
ServerEngine.prototype.findNode = _DEPRECATED_SOON_REMOVED("ServerEngine#findNode",function (nodeId) {
    var self = this;
    assert(self.addressSpace instanceof AddressSpace); // initialize not called
    return self.addressSpace.findNode(nodeId);
},"");
 ...
 *
 *  @method historyRead
 *  @param readRequest {HistoryReadRequest}
 *  @param readRequest.requestHeader  {RequestHeader}
 *  @param readRequest.historyReadDetails  {HistoryReadDetails}
 *  @param readRequest.timestampsToReturn  {TimestampsToReturn}
 *  @param readRequest.releaseContinuationPoints  {Boolean}
 *  @param readRequest.nodesToRead {HistoryReadValueId[]}
 *  @param callback {Function}
 *  @param callback.err
 *  @param callback.results {HistoryReadResult[]}
 */
...
ServerEngine.prototype.bindVariable = function (nodeId, options) {
    ...
    var obj = this.addressSpace.findNode(nodeId);
