...
ServerEngine.prototype.readSingleNode = function (nodeId,attributeId) {
    ...
    if (!obj) {
        ...
        // Object Not Found
        return { statusCode: StatusCodes.Bad_NodeIdUnknown.value };
    } else {
        // check access
        ...
        switch(attributeId) {
            ...
            case AttributeIds.Description:
                options.value = { dataType: DataType.LocalizedText, value: { locale:"en", text:""} };
                break;
            case AttributeIds.WriteMask:
                console.log(" warning WriteMask not implemented "+ nodeId.toString());
