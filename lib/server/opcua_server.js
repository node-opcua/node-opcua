...
OPCUAServer.prototype.getDiscoveryUrls = function() {
    var self = this;
    // build discoveryUrl by scanning end points
    ...
    function buildUri(endpoint) {
        return "opc.tcp://" + get_fully_qualified_domain_name() + ":" + endpoint.port.toString();
    }
    return  self.endpoints.map(buildUri);
}
/**
