...
OPCUAServer.prototype._on_CreateSessionRequest = function(message,channel)  {
    ...
    session.serverNonce = crypto.randomBytes(32);
    //xx console.log("XXXXXXX _on_CreateSessionRequest NONCE ",session.serverNonce.toString("hex").cyan);
...
OPCUAServer.prototype._on_ActivateSessionRequest = function(message,channel)  {
    ...
    //xx console.log("XXXXXXX _on_ActivateSessionRequest NONCE ",session.serverNonce.toString("hex").cyan);
...
OPCUAServer.prototype._on_GetEndpointsRequest = function (message, channel) {
    ...
    //xx console.log("xxxxxx _on_GetEndpointsRequest ".yellow,request);
