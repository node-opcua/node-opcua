...
OPCUAServer.prototype._apply_on_SessionObject = function (ResponseClass, message, channel, action_to_perform) {
    ...
    function sendError(statusCode) { return g_sendError(channel,message,ResponseClass,statusCode); }
...
OPCUAServer.prototype._on_CloseSessionRequest = function (message, channel) {
    ...
    function sendError(statusCode) { return g_sendError(channel,message,CloseSessionResponse,statusCode); }
...
OPCUAServer.prototype._on_BrowseRequest = function (message, channel) {
    ...
    var server = this;
    var diagnostic = {};
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,BrowseResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_BrowseNextRequest = function (message, channel) {
    ...
    //xx var server = this;
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,BrowseNextResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_ReadRequest = function (message, channel) {
    ...
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,ReadResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_WriteRequest = function (message, channel) {
    ...
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,WriteResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_CreateSubscriptionRequest = function (message, channel) {
    ...
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,CreateSubscriptionResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_DeleteSubscriptionsRequest = function (message, channel) {
    ...
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,DeleteSubscriptionsResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_CreateMonitoredItemsRequest = function (message, channel) {
    ...
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,CreateMonitoredItemsResponse,statusCode,diagnotisc); }
    ...
    this._apply_on_SessionObject(CreateMonitoredItemsResponse, message, channel, function (session) {
        ...
        var results = request.itemsToCreate.map(function (monitoredItemCreateRequest) {
            ...
            function handle_error(statusCode) {
                return new MonitoredItemCreateResult({ statusCode: statusCode});
            }
            ...
            if (filter && filter instanceof subscription_service.EventFilter && itemToMonitor.attributeId !== AttributeIds.EventNotifier) {
                ...
                return handle_error(StatusCodes.BadMonitoredItemFilterInvalid);
            }
            ...
            if (filter && itemToMonitor.attributeId !== AttributeIds.EventNotifier &&  itemToMonitor.attributeId !== AttributeIds.Value) {
                return handle_error(StatusCodes.BadMonitoredItemFilterUnsupported);
            }
            ...
            var monitoredItemCreateResult = subscription.createMonitoredItem(
                timestampsToReturn, monitoredItemCreateRequest, node,itemToMonitor);

            if (monitoredItemCreateResult.statusCode === StatusCodes.Good) {
...
OPCUAServer.prototype._on_ModifySubscriptionRequest = function(message,channel) {
    ...
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,ModifySubscriptionResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_ModifyMonitoredItemsRequest = function(message,channel) {
    ...
    function sendError(statusCode) { return g_sendError(channel,message,ModifyMonitoredItemsResponse,statusCode); }
...
OPCUAServer.prototype._on_SetPublishingModeRequest = function (message, channel) {
    ...
    function sendError(statusCode,diagnotisc) { return g_sendError(channel,message,SetPublishingModeResponse,statusCode,diagnotisc); }
...
OPCUAServer.prototype._on_DeleteMonitoredItemsRequest = function (message, channel) {
    ...
    function sendError(statusCode) { return g_sendError(channel,message,DeleteMonitoredItemsResponse,statusCode); }
...
OPCUAServer.prototype._on_RepublishRequest = function (message, channel) {
    ...
    function sendError(statusCode) { return g_sendError(channel,message,RepublishResponse,statusCode); }
...
OPCUAServer.prototype._on_SetMonitoringModeRequest = function (message, channel) {
    ...
    function sendError(statusCode) { return g_sendError(channel,message,SetMonitoringModeResponse,statusCode); }
...
OPCUAServer.prototype._on_TranslateBrowsePathsToNodeIdsRequest = function (message, channel) {
    ...
    var server = this;
    function sendError(statusCode) { return g_sendError(channel,message,TranslateBrowsePathsToNodeIdsResponse,statusCode); }
...
OPCUAServer.prototype._on_CallRequest = function (message, channel) {
    ...
    function sendError(statusCode) { return g_sendError(channel,message,CallResponse,statusCode); }
 ...
 * @param callback
 */
OPCUAServer.prototype._registerServer = function (discovery_server_endpointUrl, isOnLine,callback) {
        ...
        function (callback) {
            ...
            client.connect(discovery_server_endpointUrl,function(err) {
                if (!err) {
                    ...
                    client.disconnect(function(){ callback(err); });
                }
            });
        },
