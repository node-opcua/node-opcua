...
///**
// * Get the server certificate ( 256 byte long)
// * @method getCertificate256
// * @return {Buffer} the X509v3 DER form certificate
// */
//OPCUAServer.prototype.getCertificate256 = function () {
//
//    return this.getCertificate();
//
//    if (!this.certificate256) {
//        // create fake certificate
//        var folder = path.resolve(__dirname);
//        var certificate_filename = path.join(folder,"/../../certificates/server_cert256.pem");
//        if (fs.existsSync(certificate_filename)) {
//            this.certificate256 = crypto_utils.readCertificate(certificate_filename);
//
//            debugLog(" Loading 2048bit certificate thumbprint :",crypto_utils.makeSHA1Thumbprint(this.certificate256).toString("hex"));
//
//            // verify that certificate has the correct size : a.k.a 256
//            var key = crypto_utils.extractPublicKeyFromCertificateSync(this.certificate256);
//            var key_length = crypto_utils.rsa_length(key);
//            // xx console.log("xxxxxxxxxxxxxxxxxxxx LENGTH=",crypto_utils.rsa_length(key));
//            assert(key_length === 256, " certifcation must have a 2048 bits/256 Bytes long key");
//        }
//    }
//    return this.certificate256;
//};
//
///**
...
// * @return {Buffer}
// */
//OPCUAServer.prototype.getPrivateKey256 = function() {
//
//    return this.getPrivateKey();
//
//    if (!this._private_key_pem256) {
//        // create fake certificate
//        var folder = path.resolve(__dirname);
//        var privatekey_filename = path.join(folder,"/../../certificates/server_key256.pem");
//        if (fs.existsSync(privatekey_filename)) {
//            this._private_key_pem256 = crypto_utils.readKeyPem(privatekey_filename);
//        }
//    }
//    return this._private_key_pem256;
//};
