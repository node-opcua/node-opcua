...
OPCUAServer.prototype._on_ActivateSessionRequest = function (message, channel) {
    ...
    server.raiseEvent("AuditCreateSessionEventType",{
        ...
        sourceName: { dataType: "String",  value: "Session/ActivateSession" },
         clientSoftwareCertificates: { dataType: "SignedSoftwareCertificate",  arrayType: VariantArrayType.Array, value: [] },
        ...
        userIdentityToken:   { dataType: "UserIdentityToken",  value : userIdentityTokenPasswordRemoved(session.userIdentityToken)},
