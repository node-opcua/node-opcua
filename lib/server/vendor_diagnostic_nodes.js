...
function install_optional_cpu_and_memory_usage_node(server) {
  ...
  const folder = engine.addressSpace.findNode(opcua.ObjectIds.Server_VendorServerInfo);
...
export {install_optional_cpu_and_memory_usage_node};
