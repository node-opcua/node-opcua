...
function OPCUADiscoveryServer(options) {
    ...
    var default_certificate_file = constructFilename("certificates/discoveryServer_cert_2048.pem");
    options.certificateFile = options.certificateFile || default_certificate_file;

    var default_private_key_file = constructFilename("certificates/discoveryServer_key_2048.pem");
