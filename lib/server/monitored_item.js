...
MonitoredItem.prototype.__defineSetter__("node",() => {
...
const extractEventFields = require("lib/tools/tools_event_filter").extractEventFields;
...
const check_deadband = require("lib/datamodel/deadband_checker").check_deadband;
 ...
 */
MonitoredItem.prototype.recordValue = function (dataValue,force) {
  const self = this;
...
MonitoredItem.prototype._setOverflowBit = (notification) => {
