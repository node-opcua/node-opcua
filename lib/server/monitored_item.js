...
function MonitoredItem(options) {
    ...
    self.queueSize = Math.max(1,self.queueSize);
...
MonitoredItem.prototype.recordValue = function (dataValue) {
    ...
    var self = this;
    // store last value
    self.oldDataValue = dataValue instanceof DataValue ? dataValue : new DataValue(dataValue);
...
MonitoredItem.prototype.modify = function(options)  {
