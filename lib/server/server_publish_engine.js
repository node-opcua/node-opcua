...
ServerSidePublishEngine.prototype.process_subscriptionAcknowledgements = function (subscriptionAcknowledgements) {
    ...
    var results = subscriptionAcknowledgements.map(function (subscriptionAcknowledgement) {
        ...
        if (!subscription) {
            ...
            // expecting a existing subscription
            throw new Error("expecting a existing subscription : "+ subscriptionAcknowledgement.subscriptionId +
            " to proceed with subscriptionAcknowledgement="+subscriptionAcknowledgement.toString());
        }
