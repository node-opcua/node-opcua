...
ServerSidePublishEngine.prototype._feed_late_subscription = function () {
    ...
    var starving_subscriptions = self.findLateSubscriptionsSortedByPriority();
...
ServerSidePublishEngine.prototype._on_PublishRequest = function (request, callback) {
    ...
    if (self.isSessionClosed) {
        ...
        if (self._closed_subscriptions.length > 0) {
            ...
            if (self._feed_closed_subscription()) {
                return;
            }
        }
...
ServerSidePublishEngine.prototype.findLateSubscriptionsSortedByPriority= function () {
    ...
    late_subscriptions = _(late_subscriptions).sortBy("priority").reverse();
