...
Subscription.prototype.modify = function(param) {
    ...
    param.requestedPublishingInterval  = param.requestedPublishingInterval;
...
Subscription.prototype._attempt_to_publish_notification = function () {
    ...
    if (publishEngine.pendingPublishRequestCount > 0) {
        ...
        console.log(" _attempt_to_publish_notification  self.state = SubscriptionState.LATE");
    }
...
Subscription.prototype.process_subscription = function() {
    ...
    console.log("process_subscription",self.hasPendingNotifications);
    ...
    if (self.hasPendingNotifications && self.publishingEnabled) {
        ...
        if (self.state === SubscriptionState.NORMAL && self.hasPendingNotifications > 0) {
            ...
            // TO DO : fix me ,
            console.log("xxxxx pendingPublishRequestCount > 0 && normal state => retrigger tick event immediately ");
...
Subscription.prototype._tick = function () {
    ...
    if (self.lifeTimeHasExpired) {
        ...
        var publishEngine = self.publishEngine;
        if (publishEngine.pendingPublishRequestCount === 0) {
            console.log("xxxxxxxxxxxxxxxxxxxxx normal tick -> LATE");
            self.state = SubscriptionState.LATE;
            return;
        }
        console.log("xxxxxxxxxxxxxxxxxxxxx normal tick");
...
Subscription.prototype.getMessageForSequenceNumber = function(sequenceNumber) {
    ...
    function filter_func(e) { return e.sequenceNumber === sequenceNumber; }
 ...
 */
Subscription.prototype.createMonitoredItem = function(timestampsToReturn,monitoredItemCreateRequest,node,itemToMonitor) {
