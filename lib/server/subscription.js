...
const SubscriptionDiagnostics = require("schemas/39394884f696ff0bf66bacc9a8032cc074e0158e/SubscriptionDiagnostics").SubscriptionDiagnostics;
...
Subscription.prototype.__defineGetter__("disabledMonitoredItemCount", function () {
  return  _.reduce(_.values(this.monitoredItems),(cumul, monitoredItem) => cumul + ((monitoredItem.monitoringMode === MonitoringMode.Disabled) ? 1 : 0),0);
});
 ...
 * @type {Number}
 */
Subscription.prototype.__defineGetter__("unacknowledgedMessageCount", () => 0);


const MonitoredItem = require("lib/server/monitored_item").MonitoredItem;


const MonitoredItemCreateRequest = require("lib/services/subscription_service").MonitoredItemCreateRequest;
...
const checkSelectClauses = require("lib/tools/tools_event_filter").checkSelectClauses;
...
const is_valid_dataEncoding = require("lib/misc/data_encoding").is_valid_dataEncoding;
...
Subscription.prototype._createMonitoredItemStep3 = (monitoredItem, monitoredItemCreateRequest) => {
