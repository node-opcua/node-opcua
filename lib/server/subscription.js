...
Subscription.prototype.adjustSamplingInterval = function(samplingInterval) {
...
Subscription.prototype.createMonitoredItem = function(timestampsToReturn,monitoredItemCreateRequest) {
    ...
    // TODO: test for BadMonitoringModeInvalid
    ...
    requestedParameters.samplingInterval = self.adjustSamplingInterval(requestedParameters.samplingInterval);

    //xx console.log("xxxxxx ajusted samplingInterval".cyan,requestedParameters.samplingInterval);


    var monitoredItemCreateResult = new MonitoredItemCreateResult({
        statusCode: StatusCodes.Good,
        monitoredItemId: monitoredItemId,
        revisedSamplingInterval: requestedParameters.samplingInterval,
        revisedQueueSize: requestedParameters.queueSize,
        filterResult: null
    });
