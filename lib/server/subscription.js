...
function _adjust_maxLifeTimeCount(maxLifeTimeCount,maxKeepAliveCount) {
    maxLifeTimeCount = maxLifeTimeCount || 1;
    // let's make sure that maxLifeTimeCount is at least three time maxKeepAliveCount
    maxLifeTimeCount = Math.max(maxLifeTimeCount,maxKeepAliveCount * 3);
...
function Subscription(options) {
     ...
     * @default 1
     */
    self.maxLifeTimeCount = _adjust_maxLifeTimeCount(options.maxLifeTimeCount, self.maxKeepAliveCount);
