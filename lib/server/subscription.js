...
Subscription.prototype.terminate = function () {
    ...
    console.log(" deleting monitored items",keys);
 ...
 *  acknowledged yet.
 *
 *  @methods getAvailableSequenceNumbers
 *  @return {Integer[]}
 *
 */
...
var MonitoredItemCreateRequest = require("../subscription_service").MonitoredItemCreateRequest;
 ...
 * @returns {subscription_service.MonitoredItemCreateResult}
 */
