...
function Subscription(options) {
    ...
    self.publishingEnabled = (options.publishingEnabled === null) ? true : options.publishingEnabled;
...
Subscription.prototype._sendKeepAliveResponse = function() {
    ...
    return self.publishEngine.send_keep_alive_response(self.id, future_sequence_number);
};
...
Subscription.prototype.createMonitoredItem = function(timestampsToReturn,monitoredItemCreateRequest,node) {
    ...
    //xxx console.log("xxxxxx ajusted samplingInterval".cyan,requestedParameters.samplingInterval);
