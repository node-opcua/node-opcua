...
var DiagnosticInfoIdentifier_Description = {
    ...
    fields: [
        { name: "namespaceUri"    ,     fieldType: "Int32" },
        { name: "symbolicId"    ,     fieldType: "Int32" },
        { name: "locale"    ,     fieldType: "Int32" },
        { name: "localizedText"    ,     fieldType: "Int32" }
    ]
...
var DiagnosticInfo_Description = {
    ...
    fields: [
        ...
        { name: "additionalInfo",        fieldType: "String" },
        { name: "innerStatusCode",       fieldType: "StatusCode" },
        { name: "innerDiagnosticInfo",   fieldType: "DiagnosticInfo" }
    ]
};
