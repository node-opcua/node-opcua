...
factories.registerObject({name:"StatusCode",subtype:"UInt32"}); // 7.33 Part 4 - P 143


factories.registerObject({name:"String"    ,subtype:"UAString"});
...
factories.registerObject(SessionAuthenticationToken_Schema);
...
var ResponseHeader_Schema = {
    ...
    fields: [
        ...
        { name: "serviceDiagnostics",  fieldType:"DiagnosticInfo" , comment: "The diagnostics associated with the ServiceResult." },
...
exports.MessageSecurityMode = factories.registerObject(EnumMessageSecurityMode_Schema);
...
exports.UserIdentityTokenType = factories.registerObject(EnumUserIdentityTokenType_Schema);



var EnumApplicationType_Schema = {
...
exports.EnumApplicationType = factories.registerObject(EnumApplicationType_Schema);
...
exports.SecurityTokenRequestType = factories.registerObject(EnumSecurityTokenRequestType_Schema);
...
exports.FindServersRequest = factories.registerObject(FindServersRequest_Schema);
...
exports.FindServersResponse = factories.registerObject(FindServersResponse_Schema);
...
var DiagnosticInfo_EncodingByte = exports.DiagnosticInfo_EncodingByte = factories.registerObject(DiagnosticInfo_EncodingByte_Schema);
