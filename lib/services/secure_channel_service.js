...
//function makeAlgorithmSecurityHeader(securityMode,certificate) {
//
//    securityMode =  securityMode ||  s.MessageSecurityMode.NONE;
...
//            securityHeader.senderCertificate = certificate;
...
//
//        default:
//            throw new Error("Invalid security mode " + securityMode);
//    }
//    return securityHeader;
//}
//exports.makeAlgorithmSecurityHeader = makeAlgorithmSecurityHeader;
 ...
 * @param options.signatureSize  {Integer}  [undefined]
...
var SecureMessageChunkManager = function (msgType, options, securityHeader,sequenceNumberGenerator) {
    ...
    var params = {
        ...
        encrypt_block:     options.encrypt_block
    };
 ...
 *
 * @param options.signatureSize  {Integer} [default=0]
...
MessageChunker.prototype.chunkSecureMessage = function(msgType,options,message,messageChunkCallback) {
    ...
    if (msgType === "OPN") {
        ...
        //unused ... makeAlgorithmSecurityHeader()
