 ...
 */
export var CallMethodRequest = require("_generated_/_auto_generated_CallMethodRequest").CallMethodRequest;

/**
 * @class CallRequest
 */
export var CallRequest = require("_generated_/_auto_generated_CallRequest").CallRequest;

/**
 * @class CallMethodResult
 */
export var CallMethodResult = require("_generated_/_auto_generated_CallMethodResult").CallMethodResult;

/**
 * @class CallResponse
 */
export var CallResponse = require("_generated_/_auto_generated_CallResponse").CallResponse;
