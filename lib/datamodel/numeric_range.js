...
var NumericRangeType = new Enum(["Empty", "SingleValue", "ArrayRange", "MatrixRange"]);
...
NumericRange.prototype._check_range = function () {
    ...
    if (this.type === NumericRangeType.ArrayRange) {
        if (this.value[0] >= this.value[1]) {
            throw new Error(" Range : Invalid range specified low >= bound");
        }
    }
};
...
NumericRange.prototype.extract_values = function (array) {
    ...
    switch (this.type) {
        ...
        case NumericRangeType.ArrayRange:
            ...
            return  array.slice(low_index, high_index + 1);
