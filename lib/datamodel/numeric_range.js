...
NumericRange.prototype.set_values = function (arrayToAlter,newValues) {
    ...
    assert(_.isArray(arrayToAlter) || (arrayToAlter.buffer instanceof ArrayBuffer ));
    assert(_.isArray(newValues)    || (newValues.buffer instanceof ArrayBuffer ));
    ...
    var insertInPlace = (_.isArray(arrayToAlter) ? insertInPlaceStandardArray: insertInPlaceTypedArray);
    return {
