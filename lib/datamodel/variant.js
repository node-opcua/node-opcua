...
function coerceVariantType(dataType, value)
{
    switch(dataType) {
        ...
        case DataType.UInt32:
            ...
            if (value instanceof Object && value.value && value.key ) {
...
function isValidVariant(arrayType,dataType,value) {
    ...
    switch(arrayType) {
        ...
        default:
            throw new Error(" invalid VariantArrayType " + arrayType);
            return false;
    }
}
...
var Variant_Schema = {
    ...
    isValid: function(self) {
        assert(isValidVariant(self.arrayType,self.dataType,self.value));
        return true;
    }
