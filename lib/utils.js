 ...
 * @returns {boolean} returns true if the DEBUG environment variable indicates
 * that the provided source file shall display debug trace
 *
 */
...
function redirectToFile(tmpfile,action_func,callback)
{
    ...
    console.log = function(d) { //
        f.write(util.format(d) + '\n');
        //xx old_console_log.call(this,util.format(d));
    };
    // async version
    action_func();
