...
_ResponseReceiver.prototype._handle_response= function(messageChunk) {
    ...
    debugLog("CLIENT RECEIVED " + (JSON.stringify(messageHeader)+"").yellow +  "\n" +
             hexDump(messageChunk).blue.bold);
 ...
 * @param callback
 */
OPCUAClient.prototype.sendSecureOpcUARequest = function(msgType,requestMessage,responseClass,callback) {
    ...
    secure_channel.chunkSecureMessage(msgType,options,requestMessage,function(messageChunk){
