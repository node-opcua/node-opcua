...
var anonymousIdentityToken = ec.makeNodeId(nodeids.AnonymousIdentityToken); // No user information is available
var userNameIdentityToken  = ec.makeNodeId(nodeids.UserNameIdentityToken);   // A user identified by user name and password.
var X509IdentityToken      = ec.makeNodeId(nodeids.X509IdentityToken);           // A user identified by an X509v3 Certificate
var issuedIdentityToken    = ec.makeNodeId(nodeids.IssuedIdentityToken);        // A user identified by a WS-SecurityToken.
