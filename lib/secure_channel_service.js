...
var SecureMessageChunkManager = function(requestId,securityHeader)
{
...
function chunkSecureMessage(requestId,message,messageChunkCallback) {
    var ec = require("./encode_decode");
    ...
    r.pipe(ChunkStream(new SecureMessageChunkManager(requestId))).on("data",function(messageChunk) {
