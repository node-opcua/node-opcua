...
var SecureMessageChunkManager = function (msgType, options, securityHeader,sequenceNumberGenerator) {
    ...
    if (msgType == 'MSG') {
        this.sequenceHeader.tokenId = options.tokenId;
        assert(  this.sequenceHeader.tokenId && this.sequenceHeader.tokenId != 0xDEADBEEF,"please set tokenId :  " + this.sequenceHeader.tokenId);
    }
