...
//xx var AsymmetricAlgorithmSecurityHeader = require("./secure_channel_service").AsymmetricAlgorithmSecurityHeader;
//xx var SymmetricAlgorithmSecurityHeader = require("./secure_channel_service").SymmetricAlgorithmSecurityHeader;
...
var SecureMessageChunkManager = function (msgType, options, securityHeader) {
...
function chunkSecureMessage(msgType, options, message, messageChunkCallback) {
    ...
    if (msgType == "OPN") {
        var securityHeader = makeAlgorithmSecurityHeader();
    }
    r.pipe(chunkStream(new SecureMessageChunkManager(msgType, options, securityHeader))).on("data",function (messageChunk) {
...
MessageBuilder.prototype._validateSequenceNumber = function (sequenceNumber) {
    ...
    console.log(" Sequence Number = ".yellow.bold,sequenceNumber);
