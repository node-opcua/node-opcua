        ...
        if (obj.hasOwnProperty(field.name)) {
            ...
            if (_.isArray(member)) {
                ...
                for (var i =0;i<nb;i++) {
                    ...
                    element = _decode_member_(element,fieldType,stream) || member;
                    member.push(element);
                }
            } else {
...
function UAObjectFactoryBuild(_description)
{
    ...
    classConstructor.prototype.encode = function(stream) {
        if (description.encode) {
            // use encode version specified in the description object instead of default one
    ...
    classConstructor.prototype.decode = function(stream) {
        if (description.decode) {
            // use encode version specified in the description object instead of default one
            description.decode(this,stream);
        } else  {
