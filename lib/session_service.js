...
exports.AnonymousIdentityToken = factories.UAObjectFactoryBuild(AnonymousIdentityToken_Description);


var UserNameIdentityToken_Description = {
    name:"UserNameIdentityToken",
    comment: "A token representing a user identified by a user name and password",
    fields: [
        // base type : UserIdentityToken
        { name: "policyId",             fieldType:"String", documentation:"The policy id specified in a user token policy for the endpoint being used."},
        //
...
exports.UserNameIdentityToken = factories.UAObjectFactoryBuild(UserNameIdentityToken_Description);


var X509IdentityToken_Description = {
    name:"X509IdentityToken",
    comment: "A token representing a user identified by an X509 certificate.",
    fields: [
        // base type : UserIdentityToken
        { name: "policyId",                    fieldType:"String",     documentation:"The policy id specified in a user token policy for the endpoint being used."},
        //
...
exports.X509IdentityToken = factories.UAObjectFactoryBuild(X509IdentityToken_Description);

var IssuedIdentityToken_Description = {
    name:"IssuedIdentityToken",
    comment: "A token representing a user identified by a WS-Security XML token.",
    fields: [
        // base type : UserIdentityToken
        { name: "policyId",              fieldType:"String",     documentation:"The policy id specified in a user token policy for the endpoint being used."},
        //
...
exports.IssuedIdentityToken = factories.UAObjectFactoryBuild(IssuedIdentityToken_Description);
