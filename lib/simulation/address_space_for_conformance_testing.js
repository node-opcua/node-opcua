...
function add_variable_array(server_engine, parent, dataTypeName, default_value, realType) {
    ...
    var variable = _add_variable(server_engine, parent, dataTypeName, realType,current_value, true, "");
...
function add_simulation_variables(server_engine, scalarFolder) {
    ...
    function change_randomly() {
        values_to_change.forEach(function (element) {
            ...
            //xx console.log(" -----------> element" , element.variable.browseName);
...
function add_scalar_static_variables(server_engine, scalarFolder) {
    ...
    typeAndDefaultValue.forEach(function (e) {
        var dataType = e.type;
        var realType = e.realType || dataType;
        add_variable_array(server_engine, scalarStaticArray, dataType, e.defaultValue,realType);
    });
    // add static Mass
