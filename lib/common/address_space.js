 ...
 * @returns {BaseNode}
 */
AddressSpace.prototype.findObjectByBrowsePath = function (startingNode,path) {

    var browseDescription = exports.constructBrowsePath(startingNode,path);
    this.__address_space.browsePath
};
...
function constructBrowsePath(startingNode ,path) {
    ...
    var elements = arr.map(function(browsePathElement){
        ...
        // handle browsePathElement with namespace indexesx
...
AddressSpace.prototype.findDataType = function(dataTypename) {
   // startingNode i=24  :
   // BaseDataType
