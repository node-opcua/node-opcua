 ...
 * @constructor
 * This SystemOffNormalAlarmType is raised by the Server when the Server’s Certificate
 * is within the ExpirationLimit of expiration. This alarm automatically returns to
 * normal when the certificate is updated.
 */
class UACertificateExpirationAlarm {
  getExpirationDate() {
