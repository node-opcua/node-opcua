...
//
// /**
//  * @method getActiveStateValue
//  * @return {Boolean}
//  */
// UAAlarmConditionBase.prototype.getActiveStateValue = function() {
//     var alarm = this;
//     return alarm.activeState.getValue();
// };
//
// UAAlarmConditionBase.prototype.setActiveStateValue = function() {
//     var alarm = this;
//     return alarm.activeState.getValue();
// };
...
function _automatically_unshelve(shelvingState){
    ...
    console.log("Automatically unshelve variable");
...
function _oneShotShelve_method(inputArguments, context, callback) {
    ...
    console.log("shelvingState._timer",shelvingState._timer);
    // set automatic unshelving timer
    assert(!shelvingState._timer);

    if (maxTimeShelved != UAAlarmConditionBase.MaxDuration) {
        shelvingState._timer = setTimeout(_automatically_unshelve,shelvingState._duration);
    }
