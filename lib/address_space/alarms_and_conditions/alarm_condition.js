...
UAAlarmConditionBase.instantiate = function (addressSpace, alarmConditionTypeId, options, data) {
    ...
    if (alarmNode.shelvingState) {
        ...
        // transitions into the Un-shelved state. For the TimedShelved state this time is initialised
        // with the ShelvingTime argument of the TimedShelve Method call. For the OneShotShelved state
        // the UnshelveTime will be a constant set to the maximum Duration except if a MaxTimeShelved
