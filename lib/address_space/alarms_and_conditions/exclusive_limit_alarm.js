...
//xx       // be careful ! confirmedState is optional
//xx        if (self.confirmedState) {
//xx            self.currentBranch().setConfirmedState(false);
//xx        }
        ...
        alarm.raiseNewCondition(newConditionInfo);
        //xx alarm.raiseNewBranchState(alarm.currentBranch());
    }
};
