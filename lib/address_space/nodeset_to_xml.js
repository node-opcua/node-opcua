...
function _dumpValue(xw, node) {
    ...
    var dataTypeName = addressSpace.findObject(node.dataType).browseName.toString(); // value.dataType.toString();
...
function dumpUAVariable(xw, node) {
    ...
    var dataTypeNode = addressSpace.findObject(node.dataType);
    if (!dataTypeNode) {
...
function visitUANode(node, options) {
    ...
    function process_reference(reference) {
        ...
        if (!options.index_el[k]) {
            ...
            var o = addressSpace.findObject(k);
            if (o) {
...
function dumpXml(node, options) {
    ...
    function resolveDataTypeName(dataType) {
        ...
        var o = addressSpace.findObject(dataType.toString());
    ...
    function buildUpAliases(node, options) {
        ...
        function inner(reference) {
            ...
            var o = addressSpace.findObject(reference.nodeId);
            if (o) {
