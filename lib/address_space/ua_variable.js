...
const extractRange = require("lib/datamodel/datavalue").extractRange;
...
const makeAccessLevel = require("lib/datamodel/access_level").makeAccessLevel;
...
const is_dataEncoding = require("lib/misc/data_encoding").is_dataEncoding;
...
const findBuiltInType = require("lib/misc/factories_builtin_types").findBuiltInType;
...
const sameVariant = require("lib/datamodel/variant_tools").sameVariant;
 ...
 */
UAVariable.prototype.historyRead = function (historyReadDetails, indexRange, dataEncoding, continuationPoint, callback) {
...
const sameDataValue = require("lib/datamodel/datavalue").sameDataValue;
