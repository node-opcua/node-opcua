...
function _bindComponent(variable,address_space,prop, name,dataTypeId) {
    ...
    if(dt.isSupertypeOf(structure)) {
        ...
        dt.definition.forEach(function(field) {
            ...
            if (component.length === 1) {
                ...
                //xx console.log("xxxxxxxxxxxxxxxx = ".bgCyan,field.dataType.toString(), field.name ,x,basicType.toString().yellow,field.dataType.toString() );

                var name = lowerFirstLetter(field.name.toString());
                _bindComponent(self,address_space,component[0], name, field.dataType);
            }
        });
    }
};
