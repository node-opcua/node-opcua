...
UAStateMachine.prototype.getStates = function() {
    ...
    comp = comp.filter(function(c){
        return c.typeDefinitionObj === initialStateType ||c.typeDefinitionObj === stateType;
    });
...
UAStateMachine.prototype.getTransitions = function() {
    ...
    comp = comp.filter(function(c){
        return c.typeDefinitionObj === transitionType;
    });
...
UAStateMachine.prototype.setState = function(toStateNode) {
    ...
    if (transitionNode) {
        ...
        console.log("Warning".red, " cannot raise event :  transition is missing");
    }
};
