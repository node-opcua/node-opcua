...
import { DataType, Variant, VariantArrayType } from "lib/datamodel/variant";
import { LocalizedText, coerceLocalizedText } from "lib/datamodel/localized_text";
...
function install(AddressSpace) {
  ...
  AddressSpace.prototype.addEnumerationType = function AddressSpace(options) { // eslint-disable-line no-param-reassign
