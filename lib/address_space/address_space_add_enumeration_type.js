...
AddressSpace.prototype.addEnumerationType = function (options) {
    ...
    var enumType = self._createObject(opts);
    ...
    var enumStrings = self.addProperty(enumType, {
    ...
    // TODO enumStrings.browseName;
    // a datatype deriving from i=29 Enumeration
    // console.log("enumStrings",enumStrings.toString());
    return enumType;
};
