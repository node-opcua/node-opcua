...
AddressSpace.prototype.normalizeReferenceType = function (params) {
    ...
    params.isForward = util.isNullOrUndefined(params.isForward) ? true : params.isForward;
...
AddressSpace.prototype._addVariable = function (parentObject, hierarchyType, options) {
    ...
    var valueRank = util.isNullOrUndefined(options.valueRank) ? -1 : options.valueRank;
