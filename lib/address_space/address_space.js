...
require("./address_space_state_machine").install(AddressSpace);
require("./address_space_historical_data_node").install(AddressSpace);
...
// Alarm & Conditions
//
require("lib/address_space/address_space_conditions").install(AddressSpace);
