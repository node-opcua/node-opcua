...
AddressSpace.prototype._addVariable = function (parentObject, hierarchyType, options) {
    ...
    var valueRank = utils.isNullOrUndefined(options.valueRank) ? -1 : options.valueRank;
    ...
    variable.propagate_back_references();
...
AddressSpace.prototype.addObject = function (options) {
    ...
    references.push({referenceType: "HasTypeDefinition", isForward: true, nodeId: typeDefinition});
