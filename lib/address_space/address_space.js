...
Object.defineProperty(AddressSpace.prototype,"rootFolder", {
    get: function () {
        return this.findObject(this.resolveNodeId("RootFolder"));
    }
});
...
AddressSpace.prototype.deleteObject = function (objectOrNodeId) {
    ...
    assert(this._nodeid_index[indexName] === object);
...
AddressSpace.prototype._coerceObject = function (obj) {
    ...
    if (!(obj instanceof BaseNode)) {
        ...
        if (typeof obj === "string") {
            // coerce parent folder to an object
            obj = self.findObject(self.resolveNodeId(obj)) || obj;
        }
