 ...
 * 
 */
AddressSpace.prototype.deleteObject = function (nodeOrNodeId) {

    var self = this;
    var object =null;

    if (nodeOrNodeId instanceof NodeId) {
        var nodeId = nodeOrNodeId;
        object = this.findNode(nodeId);
...
AddressSpace.prototype._createNode = function (options) {
    ...
    assert(_.isObject(this.findNode(obj.nodeId)) && " Where is the object ?");
    return obj;
};
...
AddressSpace.prototype._coerceObject = function (obj) {
    ...
    if (!(obj instanceof BaseNode)) {
        ...
        if (typeof obj === "string") {
            // coerce parent folder to an object
            obj = self.findNode(self.resolveNodeId(obj)) || obj;
        }
        if (!obj || !obj.typeDefinition) {
            obj = self.findNode(obj) || obj;
            if (!obj || !obj.typeDefinition) {
