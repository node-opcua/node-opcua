...
/**
 * define a complex Variable containing a array of extensions object
 * each elements of the array are also accessible as a component variable.
 *
 */
...
function createExtObjArrayNode(parentFolder,options) {
    ...
    var variable = addressSpace.addVariable(parentFolder,inner_options);
...
function removeElement(arr,elementIndex) {
    ...
    addressSpace.deleteObject(node.nodeId);
