...
var makeServerStatus = function (address_space) {
   ...
   // nodeset.ApplicationDescription = nodeset.ApplicationDescription || registerDataType(address_space, "ApplicationDescription",force);
    ...
    nodeset.ServerDiagnosticsSummary = nodeset.ServerDiagnosticsSummary || registerDataType(address_space, "ServerDiagnosticsSummary",force);
    nodeset.SubscriptionDiagnostics = nodeset.SubscriptionDiagnostics || registerDataType(address_space,"SubscriptionDiagnostics",force);
