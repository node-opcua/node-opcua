...
function makeStructure(dataType,bForce) {
  console.log('calling make structure')
  bForce = !!bForce;
  ...
  console.log(1111111112, {
    bForce, 
    id: dataType.binaryEncodingNodeId,
    has: hasConstructor(dataType.binaryEncodingNodeId),
    namespace: dataType.binaryEncodingNodeId.namespace
  });
  ...
  if (!bForce && (hasConstructor(dataType.binaryEncodingNodeId) ||   dataType.binaryEncodingNodeId.namespace === 0)) {
        ...
        console.log("it's this that returns 0", getConstructor(dataType.binaryEncodingNodeId))
...
console.log('ohhhhj')
  ...
  generateFile(namespaceUri,schema);
}
