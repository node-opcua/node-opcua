...
function generate_address_space(address_space, xmlFiles, callback) {
    ...
    function _register_namespace_uri(namespace_uri) {
        ...
        namespaceCounter += 1;
        var index = address_space.registerNamespace(namespace_uri);
    ...
    //   <Field Name="Running" Value="0" [ValueRank="1"]/>
    //</Definition>
            ...
            "Field": {
                ...
                finish: function () {
                    this.parent.array.push({
                        ...
                        valueRank: this.attrs.ValueRank,
    ...
    var state_UADataType = {
        init: function (name, attrs) {
            ...
            this.obj.nodeId = convertToNodeId(attrs.NodeId) || null;
            this.obj.browseName = convertQualifiedName(attrs.BrowseName);
            this.obj.displayName = undefined;
            this.obj.description = undefined;
        },
        finish: function () {
            address_space._createObject(this.obj);
            assert(address_space.findObject(this.obj.nodeId));
        },
        parser: {
            "DisplayName": {
                finish: function () {
        ...
        "Argument": {
            ...
            parser: {
                ...
                "Description": {
                    finish: function () {
                        this.text = this.text || "";
                        this.parent.argument.description = coerceLocalizedText(this.text.trim());
                    }
                }
            },
            finish: function () {
