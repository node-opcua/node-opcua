...
function findAllSubTypes(referenceType) {
    ...
    var addressSpace = referenceType.__address_space;
    ...
    function _findAllSubType(referenceType) {
        ...
        references.forEach(function (_r) {
            ...
            //xx console.log(_r.toString(), subType.browseName.toString());
        });
    }
...
ReferenceType.prototype.getAllSubtypes = function() {
    ...
    if (this._cache._allSubTypesVersion < ReferenceTypeCounter) {
