...
var _slow_isSubtypeOf = function (self, Class, baseType) {
    ...
    for (var i = 0; i < subTypes.length; i++) {
        ...
        var subType = self.__address_space.findObject(subTypeId);
        if (subType.nodeId === baseType.nodeId) {
            return true;
        } else {
            if (_slow_isSubtypeOf(subType, Class, baseType)) {
                return true;
            }
        }
    }
...
exports.construct_isSubTypeOf = function (Class) {
    ...
    return wrap_memoize(function (baseType) {
        ...
        return _slow_isSubtypeOf(this, Class, baseType);
    }, hasher_func);
};

exports.construct_slow_isSubTypeOf = function (Class) {
