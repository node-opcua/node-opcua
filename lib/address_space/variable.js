 ...
 * @param nodeId
 * @returns {boolean} true if the variant datatype is compatible with the Variable DataType
 */
function validateDataType(__address_space,dataTypeNodeId,variantDataType,nodeId) {
    ...
    if (doDebug) {
        ...
        console.log(" Variable data Type is    = ".cyan,    destUADataType.browseName);
        console.log(" which matches basic Type = ".cyan,    builtInUADataType.browseName);
        console.log("        Actual   dataType = ".yellow,  variantUADataType.browseName);
    }
...
function check_valid_array(dataType,array) {
    ...
    switch(dataType) {
        ...
        case DataType.Byte:    return array instanceof Uint8Array || array instanceof Buffer;
    }
    return false;
}
 ...
 * @param statusCode
 */
Variable.prototype.setValueFromSource = function(variant,statusCode) {
    ...
    self.asyncRefresh = function(callback) {
        ...
        self.refreshFunc.call(self,function(err,dataValue) {
            if(!err && dataValue) {
                ...
                var _dataValue= { statusCode: StatusCodes.BadNoDataAvailable };
                self._internal_set_dataValue(self._dataValue, null);
            }
...
Variable.prototype._internal_set_dataValue = function (dataValue, indexRange) {
...
Variable.prototype.bindVariable = function (options) {
    ...
    function bind_variant(options) {
        var self = this;
        var variant = new Variant(options);
        function _get() {
            return variant;
        }
        _Variable_bind_with_simple_get.call(self,{get:_get});
...
Variable.prototype.getWriteMask = function() {
    return BaseNode.prototype.getWriteMask.call(this);
};

Variable.prototype.getUserWriteMask = function() {
...
Variable.prototype.clone = function() {
    ...
    return self._clone(Variable,options);
