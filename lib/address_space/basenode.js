...
//xx var Variant = require("lib/datamodel/variant").Variant;
...
function BaseNode(options) {
    ...
    this._references = options.references.map(function(o) { return new Reference(o); });
 ...
 *
 * @method getMethods
 * @returns {Array<UAObject>} returns an array with Method objects.
 */
...
/**
 * returns true if the object has some methods
 * @property hasMethods
 * @type {Boolean}
 */
...
BaseNode.prototype.readAttribute = function (attributeId) {
    ...
    switch (attributeId) {
        ...
        default:
            options.value = null;
            console.log(" BaseNode : '" + this.browseName +"' nodeid=",this.nodeId.toString(), " cannot get attribute ",AttributeNameById[attributeId],"(",attributeId,")");
...
BaseNode.prototype.browseNodeByTargetName = function (relativePath) {
    ...
    references.forEach(function (reference) {
        ...
        if (obj) {
            //xx console.log(" obj.nodeId = ",obj.nodeId,relativePath.targetName);
            //xx  if (obj.browseName.namespace === relativePath.targetName.namespaceIndex) {
...
var _makeReferenceDescription = function (address_space, reference) {
    ...
    if (!obj) {
        //xx console.log("xxxxxxxxxxxxxxxxx Cannot find Object with ID ".red,reference.nodeId.toString());
