...
exports.install = function (AddressSpace) {
    ...
    AddressSpace.prototype.constructEventData = function (eventTypeId, options) {
        ...
        // sourceName
        var sourceNode = addressSpace.findNode(options.sourceNode.value);
        ...
        function populate_data(self, data) {
        ...
        populate_data(eventTypeNode, data);
