...
const AttributeNameById = require("lib/datamodel/attributeIds").AttributeNameById;
const ResultMask = require("schemas/ResultMask_enum").ResultMask;
const NodeClass = require("schemas/NodeClass_enum").NodeClass;
...
const lowerFirstLetter = require("lib/misc/utils").lowerFirstLetter;
const capitalizeFirstLetter = require("lib/misc/utils").capitalizeFirstLetter;

const doDebug = false;

const Reference = require("lib/address_space/reference").Reference;
const sameNodeId = require("lib/datamodel/nodeid").sameNodeId;
...
BaseNode.prototype.getWriteMask = () => 0;

BaseNode.prototype.getUserWriteMask = () => 0;
/**
 ...
 * @async
 */
BaseNode.prototype.writeAttribute = (writeValue, callback) => {
...
var _makeReferenceDescription = (addressSpace, reference, resultMask) => {
    ...
    const referenceDescription = new browse_service.ReferenceDescription(data);
...
function _filter_by_nodeclass(self, references, nodeClassMask) {
    ...
    return references.filter(reference => {
        ...
        const value = browse_service.makeNodeClassMask(nodeClassName);
