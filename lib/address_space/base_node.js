...
//     });
// }
// BaseNode.prototype._clone_children_references_old = function (newParent,optionalFilter, extraInfo) {
//
//     var self = this;
//
...
BaseNode.prototype._clone_children_references = function (newParent,optionalFilter, extraInfo) {
    ...
    // find all reference
    var componentsRef = this.findReferencesEx("HasComponent", BrowseDirection.Forward);
    _clone_collection_new(newParent,componentsRef, optionalFilter, extraInfo);

    var propertiesRef = this.findReferencesEx("HasProperty",  BrowseDirection.Forward);
    _clone_collection_new(newParent,propertiesRef, optionalFilter, extraInfo);
