...
exports.NodeClass = factories.UAObjectFactoryBuild(EnumNodeClass_Description);


var ViewDescription_Description = {
...
var ViewDescription = factories.UAObjectFactoryBuild(ViewDescription_Description);


var BrowseDescription_Description = {
...
exports.BrowseDescription = factories.UAObjectFactoryBuild(BrowseDescription_Description);


var ReferenceDescription_Description = {
...
var ReferenceDescription = factories.UAObjectFactoryBuild(ReferenceDescription_Description);

factories.UAObjectFactoryBuild({name:"ContinuationPoint",subtype:"ByteString"});
factories.UAObjectFactoryBuild({name:"Counter",subtype:"UInt32"});

var BrowseResult_Description = {
    name: "BrowseResult",
...
var BrowseResult = factories.UAObjectFactoryBuild(BrowseResult_Description);


var EnumBrowseDirection_Description = {
...
exports.BrowseDirection = factories.UAObjectFactoryBuild(EnumBrowseDirection_Description);


var BrowseRequest_Description = {
  name:"BrowseRequest",
...
exports.BrowseRequest= factories.UAObjectFactoryBuild(BrowseRequest_Description);


var BrowseResponse_Description = {
    name:"BrowseResponse",
    comment: "Browse the references for one or more nodes from the server address space.",
    fields: [
...
exports.BrowseResponse = factories.UAObjectFactoryBuild(BrowseResponse_Description);


var BrowseNextRequest_Description = {
...
exports.BrowseNextRequest= factories.UAObjectFactoryBuild(BrowseNextRequest_Description);

var BrowseNextResponse_Description = {
...
exports.BrowseNextResponse = factories.UAObjectFactoryBuild(BrowseNextResponse_Description);
