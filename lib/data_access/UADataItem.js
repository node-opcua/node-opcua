...
function add_dataItem_stuff(variable,options) {
    ...
    var address_space = variable.__address_space;
    assert(address_space instanceof AddressSpace);

    if (options.hasOwnProperty("definition")) {

        variable.$definition = new Variant({ dataType: DataType.String, value: options.definition});
       ...
       address_space.addVariable(variable,{
            ...
            value: { get: function() { return variable.$definition; }}
        });
    }
    ...
    if (options.hasOwnProperty("valuePrecision")) {
        ...
        variable.$valuePrecision = new Variant({ dataType: DataType.Double, value: options.valuePrecision});
        ...
        address_space.addVariable(variable,{
            ...
            dataType: "Number",
            typeDefinition: "PropertyType",
            value: { get: function() { return variable.$valuePrecision; }}
        });
    }
}
