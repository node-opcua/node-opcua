...
var AxisInformation_Schema = {
    ...
    fields: [
        {name: "engineeringUnits",  fieldType: "EUInformation",         documentation: "Holds the information about the engineering units for a given axis."},
        {name: "eURange",           fieldType: "Range",                 documentation: "Limits of the range of the axis"},
        {name: "title",             fieldType: "Localizedtext",         documentation: "User readable axis title, useful when the units are %, the Title may be “Particle size"},
        {name: "axisScaleType",     fieldType: "AxisScaleEnumeration",  documentation: "LINEAR, LOG, LN, defined by AxisSteps"},
        {name: "axisSteps",         fieldType: "Double",  isArray: true,documentation: "Specific value of each axis steps, may be set to “Null” if not used"}
    ]
};
