...
var EUInformation_Schema = {
    name: "EUInformation",
    fields: [
        {name: "namespaceUri",  fieldType: "String", defaultValue:defaultUri, documentation: "Identifies the organization (company, standards organization) that defines the EUInformation."},
        {name: "unitId", fieldType: "Int32", documentation: "Identifier for programmatic evaluation. −1 is used if a unitId is not available."},
        ...
        {name: "displayName", fieldType: "LocalizedText", documentation: "The displayName of the engineering  ( for instance 'm/s' )" },
        {name: "description", fieldType: "LocalizedText", documentation: "Contains the full name of the engineering unit such as ”hour” or ”meter per second"}
