 ...
 * VariableType to identify an AnalogItem. Properties describe the possible ranges of  AnalogItems.
 *
 *
 * @example:
 *
    ...
    address_space.addVariable(variable,{
        ...
        value: {
            ...
            set: function(variant) {
                // note: at this time we do not allow EURange modification
                return StatusCodes.BadNotSupported;
/*
                // TODO
                // changing  EURange should cause a SemanticChange notification
                assert(variant.dataType ===DataType.ExtensionObject);
                variable.$engineeringUnitsRange.low = variant.value.low;
                variable.$engineeringUnitsRange.high = variant.high;
 ...
 */
    ...
    if (options.hasOwnProperty("engineeringUnits")) {
        ...
        variable.$engineeringUnits =  new EUInformation(options.engineeringUnits);
        assert(variable.$engineeringUnits instanceof EUInformation,"expecting engineering units");
        ...
        address_space.addVariable(variable,{
            ...
            value: { get: function() {
                return new Variant({
                    dataType: DataType.ExtensionObject, value: variable.$engineeringUnits
                });
            }}
        });
    }
