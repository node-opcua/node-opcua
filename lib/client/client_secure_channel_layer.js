...
const verify_message_chunk = require("lib/misc/chunk_manager").verify_message_chunk;
...
const MessageSecurityMode = endpoints_service.MessageSecurityMode;
...
const ClientTCP_transport = require("lib/transport/client_tcp_transport").ClientTCP_transport;
const AsymmetricAlgorithmSecurityHeader = require("lib/services/secure_channel_service").AsymmetricAlgorithmSecurityHeader;
 ...
 * @constructor
 */
const ClientSecureChannelLayer = function (options) {
  options = options || {};
