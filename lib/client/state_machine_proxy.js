...
/**
 * find all components of a give object that are of type
 * @param nodeId
 * @param callback
 */
function findAllComponentsOfType(session, nodeId, typeDefinition, callback) {
    ...
    session.browseNode(nodesToBrowse, function (err, results) {
