...
var TimestampsToReturn = require("../services/read_service").TimestampsToReturn;

//xx var OPCUAClient = require("./opcua_client").OPCUAClient;
...
ClientSubscription.prototype.monitor = function (itemToMonitor, requestedParameters, timestampsToReturn ,done) {
    ...
    var ClientMonitoredItem = require("./client_monitored_item").ClientMonitoredItem;
