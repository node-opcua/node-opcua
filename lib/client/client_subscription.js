...
const TimestampsToReturn = require("lib/services/read_service").TimestampsToReturn;

const ClientSession = require("lib/client/opcua_client").ClientSession;

const ClientMonitoredItem = require("lib/client/client_monitored_item").ClientMonitoredItem;

const StatusCodes = require("lib/datamodel/opcua_status_code").StatusCodes;

const NodeId = require("lib/datamodel/nodeid.js");
 ...
 * @param done
 */
ClientSubscription.prototype.monitorItems = (itemsToCreate, timestampsToReturn, done) => {
