...
const resultMask = browse_service.makeResultMask("ReferenceType | IsForward | BrowseName | NodeClass | TypeDefinition");
...
const ClientSession = require("lib/client/client_session").ClientSession;
