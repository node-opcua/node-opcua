            ...
            session.read(nodesToRead, 1, function (err, node2reads, results) {
                ...
                if (!err) {
                    ...
                    if (results[3].statusCode === StatusCodes.Good) {
                        console.log("AccessLevel ", results[3].value.toString())
...
UAProxyManager.prototype._monitor_value = function(proxyObject) {
    ...
    //xx console.log("xxxxxx installing monitored Item",monitoredItem.itemToMonitor.nodeId.toString(),monitoredItem.itemToMonitor.attributeId);
