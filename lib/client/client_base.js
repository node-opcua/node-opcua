...
var readCertificate = require("../misc/crypto_utils").readCertificate;
 ...
 * @param options.mode {MessageSecurityMode} [MessageSecurityMode.None}
 * @constructor
 */
function OPCUAClientBase(options) {
    ...
    this._certificate = readCertificate(folder + "/../../certificates/client_cert.pem");
    this._server_endpoints = [];
    this._secureChannel = null;

    this.defaultSecureTokenLifetime = options.defaultSecureTokenLifetime || 30000;

    this.mode = options.mode || MessageSecurityMode.NONE;
