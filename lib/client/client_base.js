 ...
 * @param [options.certificateFile="certificates/client_cert.pem"] {String} client certificate pem file.
 * @param [options.privateKeyFile="certificates/client_key.pem"] {String} client private key pem file.
 * @constructor
 */
function OPCUAClientBase(options) {
    ...
    var default_certificate_file =path.join(folder,"../../certificates/client_cert.pem");
    options.certificateFile = options.certificateFile || default_certificate_file;

    var default_private_key_file =path.join(folder,"../../certificates/client_key.pem");
