...
NodeCrawler.prototype._readOperationalLimits = function (callback) {
    ...
    const self = this;
    const n1 = makeNodeId(opcua.VariableIds.Server_ServerCapabilities_OperationLimits_MaxNodesPerRead);
    const n2 = makeNodeId(opcua.VariableIds.Server_ServerCapabilities_OperationLimits_MaxNodesPerBrowse);
    const nodesToRead = [
...
const resultMask = opcua.browse_service.makeResultMask("ReferenceType | IsForward | BrowseName | NodeClass | TypeDefinition");
