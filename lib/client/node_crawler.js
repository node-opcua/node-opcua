    ...
    _.zip(_objectsToBrowse, results).forEach(function (pair) {
        ...
        async.series([
            ...
            function(callback) {
              ...
              self._defer_readNode(obj.nodeId, AttributeIds.DataType, function (err, dataType) {
                  ...
                  self._defer_readNode(dataType, AttributeIds.BrowseName,function(err,dataTypeBrowseName){
            ...
            function(callback) {
              self._defer_readNode(obj.nodeId, AttributeIds.Value, function (err, dataValue) {
