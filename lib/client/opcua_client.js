...
import  { createFastUninitializedBuffer } from "../misc/buffer_utils";
import { UserIdentityTokenType } from "../datamodel/structures";
import { ClientSession } from "../client/client_session";
import utils from "../misc/utils";
import { exploreCertificate } from "../misc/crypto_explore_certificate";
import get_fully_qualified_domain_name from "../misc/hostname";

const { SecurityPolicy } = securityPolicy_m;
...
function createUserNameIdentityToken(session, userName, password) {
  ...
  let securityPolicy = securityPolicy_m.fromURI(userTokenPolicy.securityPolicyUri);
