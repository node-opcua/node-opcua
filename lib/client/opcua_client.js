 ...
 * @param [options.applicationName="NodeOPCUA-Client"] {string} the application name
 * @constructor
 */
...
OPCUAClient.prototype._createSession = function (callback) {
    ...
    var applicationUri = "urn:" + hostname + ":" + this.applicationName;

    console.log("ApplicationURI = ".yellow,applicationUri);
    ...
    assert(this._secureChannel.securityMode === endpoints_service.MessageSecurityMode.NONE || request.clientNonce!=null  );
