...
,                               Bad_NoData: { name:                             'Bad_NoData' , value:    155  ,description: "No data exists for the requested time range or event filter."}
,                               Bad_NoData: { name:                             'Bad_NoData' , value:    155  ,description: "No data found to provide upper or lower bound value."}
...
,                            Good_MoreData: { name:                          'Good_MoreData' , value:    166  ,description: "The requested number of Aggregates does not match the requested number of NodeIds."}
,                            Good_MoreData: { name:                          'Good_MoreData' , value:    166  ,description: "The requested Aggregate is not support by the server."}
,                            Good_MoreData: { name:                          'Good_MoreData' , value:    166  ,description: "The aggregate value could not be derived due to invalid data inputs."}
,                            Good_MoreData: { name:                          'Good_MoreData' , value:    166  ,description: "The aggregate configuration is not valid for specified node."}
,                            Good_MoreData: { name:                          'Good_MoreData' , value:    166  ,description: "The request pecifies fields which are not valid for the EventType or cannot be saved by the historian."}
