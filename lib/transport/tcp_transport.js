...
var readRawMessageHeader = require("../../lib/chunk_manager").readRawMessageHeader;
var PacketAssembler     =  require("../../lib/chunk_manager").PacketAssembler;
...
TCP_transport.prototype._install_one_time_message_receiver = function(callback) {
    ...
    function __abort_1pending_op(err) {
        if (self._timerId ) {
    ...
    self._timerId = setTimeout(function(){
        __abort_1pending_op(new Error("Timeout in waiting for data on socket"));
    },self.timeout);
    ...
    self._socket.once("data",function(data){
        ...
        __abort_1pending_op(new Error("Connection aborted by server"));
    });
};
...
ClientTCP_transport.prototype.disconnect = function(callback) {
...
ServerTCP_transport.prototype.end = function() {
    var self = this;
    // abruptly close this socket
    setImmediate(function() {self._socket.end();});
};
