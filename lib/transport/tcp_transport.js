...
function _start_timeout_timer() {
    ...
    self._timerId = setTimeout(function () {
        ...
        _fulfill_pending_promises.call(self,new Error("Timeout in waiting for data on socket"));
...
TCP_transport.prototype._install_socket = function (socket) {
    ...
    self.name = " Transport " + counter; counter+=1;
    assert(socket);
    ...
    self._socket.on("data", function (data) {
        ...
        _on_socket_ended_message.call(self);
