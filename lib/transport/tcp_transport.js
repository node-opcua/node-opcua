...
const writeTCPMessageHeader = require("lib/nodeopcua").writeTCPMessageHeader;
const readRawMessageHeader =  require("lib/misc/message_builder_base").readRawMessageHeader;
const PacketAssembler = require("lib/transport/packet_assembler").PacketAssembler;
...
exports.setFakeTransport = socket_like_mock => {
    fakeSocket = socket_like_mock;
};

exports.getFakeTransport = () => fakeSocket;
