...
export const registerBasicType = require("lib/misc/factories_basic_type").registerBasicType;
export const registerBuiltInType = require("lib/misc/factories_builtin_types").registerType;
export const unregisterType = require("lib/misc/factories_builtin_types").unregisterType;
export const findSimpleType = require("lib/misc/factories_builtin_types").findSimpleType;
export const findBuiltInType = require("lib/misc/factories_builtin_types").findBuiltInType;
export const constructObject = require("lib/misc/factories_factories").constructObject;
export const getFactory = require("lib/misc/factories_factories").getFactory;
