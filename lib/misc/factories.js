...
export var registerBasicType = require("lib/misc/factories_basic_type").registerBasicType;
export var registerBuiltInType = require("lib/misc/factories_builtin_types").registerType;
export var unregisterType = require("lib/misc/factories_builtin_types").unregisterType;
export var findSimpleType = require("lib/misc/factories_builtin_types").findSimpleType;
export var findBuiltInType = require("lib/misc/factories_builtin_types").findBuiltInType;
export var constructObject = require("lib/misc/factories_factories").constructObject;
export var getFactory = require("lib/misc/factories_factories").getFactory;
