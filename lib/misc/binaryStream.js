...
BinaryStream.prototype.writeUInt32 = function (value) {
    ...
    if (0) {
        var b1 = (this._buffer[this.length - 4] === value % 256);
        var b2 = (this._buffer[this.length - 3] === (value >>> 8) % 256);
        var b3 = (this._buffer[this.length - 2] === (value >>> 16) % 256);
        var b4 = (this._buffer[this.length - 1] === (value >>> 24) % 256);

        if (!b1 || !b2 || !b3 || !b4) {
            var a = hexDump(this._buffer.slice(this.length - 4, this.length));
            console.log(" cccccc = ", value);
            console.log(" cccccc = ", a.cyan);
        }
    }
