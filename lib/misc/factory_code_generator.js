...
var schema_helpers =  require("./factories_schema_helpers");
...
function get_class_javascript_filename_local(schema_name) {
    ...
    //xx var filename = "./" + path.relative(exports.folder_for_generated_file,generate_source);
    //xx var filename =normalize_require_file(exports.folder_for_generated_file,generate_source);
    //xx console.log(" xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx ",generate_source);
    //xx console.log(" xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx   --> ",filename);
    //xx  return filename;
    //xx return "./_auto_generated_" + schema_name + ".js";
}
...
function produce_code(schema_file, schema_name, source_file) {
    ...
    var is_complex_type;
    var i, field, fieldType, member, __member, dtm;
...
// -------------------------------------------------------------------------
    ...
    /// write("var install_initial_value                    = schema_helpers.install_initial_value;");
    ...
    ///xxxx write("var factories  = require('../lib/misc/factories_factories')._private.factories;");
...
// -------------------------------------------------------------------------
    ...
    complexTypes.forEach(function (field) {
        ...
        console.log("folder_for_source_file ",folder_for_source_file);
...
// -------------------------------------------------------------------------
    ...
    write("//xx " + classname + ".prototype._schema = {name : \"" + classname + "\" };");
