...
function display_public_key_Encryption_missing_message() {
    ...
    console.warn("              $ npm install ursa".yellow.bold);
    console.warn("");
}
...
assert(exports.RSA_PKCS1_OAEP_PADDING && exports.RSA_PKCS1_PADDING );
console.log("xxxxxxxxxxxx exports.RSA_PKCS1_PADDING",exports.RSA_PKCS1_PADDING,ursa.RSA_PKCS1_PADDING,constants.RSA_PKCS1_PADDING);
console.log("xxxxxxxxxxxx exports.RSA_PKCS1_OAEP_PADDING",exports.RSA_PKCS1_OAEP_PADDING,ursa.RSA_PKCS1_OAEP_PADDING,constants.RSA_PKCS1_OAEP_PADDING);
...
function publicEncrypt_native(buffer, public_key,algorithm) {
    ...
    assert(algorithm === crypto_utils.RSA_PKCS1_PADDING || crypto_utils === constants.RSA_PKCS1_OAEP_PADDING);

    assert(buffer instanceof Buffer, "Expecting a buffer");
    return crypto.publicEncrypt({
       key: public_key,
       padding:  crypto_utils.RSA_PKCS1_PADDING
    }, buffer);
}
...
exports.isFullySupported = function () {
    return ursa || crypto.hasOwnProperty("publicEncrypt");
};
...
exports.exploreCertificate = function (certificate) {
    ...
    //xx console.log(x509.getIssuer(senderCertificatePem));
    var certificate = x509.parseCert(senderCertificatePem);

    certificate.publicKeyLength = certificate.publicKey.n.length / 2.0;
    return certificate;
};

/**
 * extract the publickey from a certificate - usign the pem module
 *
