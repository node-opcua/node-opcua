...
const sc = require("lib/datamodel/opcua_status_code");
...
const _defaultType = [
  ...
  {
    name: "ByteString",
    encode: ec.encodeByteString,
    decode: ec.decodeByteString,
  ...
  {
    name: "NodeId",
    encode: ec.encodeNodeId,
    decode: ec.decodeNodeId,
  ...
  {
    name: "ExpandedNodeId",
    encode: ec.encodeExpandedNodeId,
    decode: ec.decodeExpandedNodeId,
...
exports.unregisterType = (typeName) => {
