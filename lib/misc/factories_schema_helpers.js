...
const TypeSchema = require("lib/misc/factories_builtin_types").TypeSchema;
 ...
 * @return {*}
 */
exports.initialize_field = (field, value) => {
 ...
 * @return {Array}
 */
exports.initialize_field_array = (field, valueArray) => {
    const _t = field.schema;
