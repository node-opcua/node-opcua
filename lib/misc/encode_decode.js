...
(function () {
    ...
    var A = factor / F;
    var B = offset * A;
    var oh = Math.floor(offset / 0xFFFFFFFF);
    var ol = offset % 0xFFFFFFFF;
    var fff = ( 0xFFFFFFFF / factor);
    ...
    function bn_dateToHundredNanoSecondFrom1601_fast(date) {
        ...
        var value_l = ( ( t % F + offset % F ) * ( factor % F ) ) % F;
    ...
    function bn_hundredNanoSecondFrom1601ToDate_fast(high, low) {
        ...
        // faster implementation of bn_hundredNanoSecondFrom1601ToDate_big_number
        //   (h * F + l)/f    - o=
        //    h / f * F + l/f - o=
        //
        //    h   = ((h div f)* f + h % f)
        ...
        var value1 = (Math.floor(high / factor) - oh ) * 0xFFFFFFFF + Math.floor(( high % factor ) * fff + low / factor) - ol;
...
exports.encodeDateTime = function (date, stream) {
    ...
    assert(date instanceof Date);
    var hl = exports.bn_dateToHundredNanoSecondFrom1601(date);
    var hi = hl[0];
    var lo = hl[1];
...
exports.decodeDateTime = function (stream) {
    ...
    return exports.bn_hundredNanoSecondFrom1601ToDate(hi, lo);
};
