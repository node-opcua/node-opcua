...
exports.makeExpandedNodeId = require("./../datamodel/expanded_nodeid").makeExpandedNodeId;
...
var isValidInt8 = exports.isValidInt8 = function (value) {
    if (!_.isFinite(value)) return false;
...
var isValidUInt8 = exports.isValidUInt8 = function (value) {
    if (!_.isFinite(value)) return false;
...
exports.randomUInt64 = function () {
    return new Int64(getRandomInt(0, 0xFFFFFFFF),getRandomInt(0, 0xFFFFFFFF));
};
exports.encodeUInt64 = function (value, stream) {
   for (var i=0;i<8;i++) {
       stream.writeByte(value.buffer[i]);
   }
};
exports.decodeUInt64 = function (stream) {
    var value = new Int64();
    for (var i=0;i<8;i++) {
        value.buffer[i] =stream.readByte();
    }
    return value;
};
...
exports.randomInt64  = exports.randomUInt64;
exports.encodeInt64  = exports.encodeUInt64;
exports.decodeInt64  = exports.decodeUInt64;



exports.coerceBoolean = function coerceBoolean(val) {
   return !!(+val||String(val).toLowerCase().replace(!!0,''))
}
exports.coerceInt8 = function coerceInt8(value) {
    return parseInt(value,10);
};
exports.coerceInt8 = function coerceUInt8(value) {
    return parseInt(value,10);
};
exports.coerceInt8 = function coerceByte(value) {
    return parseInt(value, 10);
};
exports.coerceInt8 = function coerceSByte(value) {
    return parseInt(value,10);
};
exports.coerceInt8 = function coerceUInt16(value) {
    return parseInt(value,10);
};
exports.coerceInt8 = function coerceInt16(value) {
    return parseInt(value, 10);
};
exports.coerceInt8 = function coerceUInt32(value) {
    return parseInt(value,10);
};
exports.coerceInt8 = function coerceInt32(value) {
    return parseInt(value, 10);
};
