...
var is_guid = require("./../datamodel/guid").is_guid;
...
exports.isValidUAString = function(value) {
    return typeof value === "string";
};
exports.randomUAString = function() {
...
isValidByte = exports.isValidByte = function(value) {
    if (!_.isFinite(value)) return false;
...
exports.encodeNodeId = function(nodeId,stream)
{
    ...
    switch(encoding_byte) {
        case EnumNodeIdEncoding.TwoBytes.value:
            ...
            assert(is_uint8(nodeId.namespace));
        ...
        case EnumNodeIdEncoding.Numeric.value:
            assert(_.isNumber(nodeId.namespace));
            assert(is_uint16(nodeId.namespace));
            // assert(is_uint32(nodeId.value));
