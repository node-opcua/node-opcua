...
var isValidBoolean = exports.isValidBoolean = value => typeof value === "boolean";
...
exports.decodeBoolean = stream => stream.readUInt8() ? true : false;
...
var minFloat = -3.40 * (10 ** 38);
var maxFloat = 3.40 * (10 ** 38);
...
var _decodeNodeId = (encoding_byte, stream) => {
    var value;
    var namespace;
    /*jslint bitwise: true */
    encoding_byte &= 0x3F;
