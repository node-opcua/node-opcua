...
function roundToFloat(float) {
    ...
    var r = Math.pow(10,-nbDigits+7);
    /// console.log("xxxxxx nbDigits ",float,nbDigits,r,float*r);
...
exports.coerceUInt64 = function(value) {
    ...
    if (typeof value === "string") {
        var v = value.split(",");
        var high =parseInt(v[0],10);
        var low  =parseInt(v[1],10);
        return exports.constructInt64(high,low);
    }
    if (value>0xFFFFFFFF) {
