...
const MessageBuilderBase = require("lib/misc/message_builder_base").MessageBuilderBase;


const chooseSecurityHeader = require("lib/services/secure_channel_service").chooseSecurityHeader;


const SymmetricAlgorithmSecurityHeader = require("lib/services/secure_channel_service").SymmetricAlgorithmSecurityHeader;
...
const MessageSecurityMode = require("schemas/MessageSecurityMode_enum").MessageSecurityMode;

const crypto_utils = require("lib/misc/crypto_utils");

const decodeStatusCode = require("lib/datamodel/opcua_status_code").decodeStatusCode;
const decodeString = require("lib/misc/encode_decode").decodeString;
 ...
 */
const MessageBuilder = function (options) {
