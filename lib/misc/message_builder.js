...
function reduce_length (binaryStream, byte_to_remove) {
    binaryStream._buffer = binaryStream._buffer.slice(0,binaryStream._buffer.length -byte_to_remove);
}
...
MessageBuilder.prototype._decrypt = function(binaryStream) {
    ...
    if( msgType === "OPN") {
        ...
        if (sp === SecurityPolicy.None) {
            ...
            // remove signature
            reduce_length(binaryStream,signatureLength);
            ...
            if (this.securityHeader.receiverCertificateThumbprint) {
                ...
                reduce_length(binaryStream,nbPaddingBytes);
