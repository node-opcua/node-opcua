...
MessageBuilder.prototype._decrypt_OPN = function(binaryStream) {
    ...
    if (this.securityPolicy === SecurityPolicy.None) {
        ...
        assert(this.signatureLength === 128 || this.signatureLength === 256);
...
MessageBuilder.prototype._decrypt = function(binaryStream) {
    ...
    if( msgType === "OPN") {
        ...
        if (this.securityPolicy === SecurityPolicy.None || !this.securityPolicy  ) {
            ...
            //xx if (this.derivedKeys ) {
            //xx    console.log(this.derivedKeys );
            //xx    process.exit(1);
            //xx }
            //xx assert(this.derivedKeys === null);
            ...
            assert(this.derivedKeys !== null);
            assert(this.derivedKeys.signatureLength," must provide a signature length");
            ...
            this.signatureLength = derivedKeys.signatureLength;

            // remove signature
            binaryStream._buffer = crypto_utils.reduceLength(binaryStream._buffer,this.signatureLength);
