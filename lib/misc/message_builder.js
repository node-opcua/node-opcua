...
var SymmetricAlgorithmSecurityHeader = require("./../services/secure_channel_service").SymmetricAlgorithmSecurityHeader;
...
var MessageBuilder = function(options) {
    ...
    this.securityMode = MessageSecurityMode.INVALID; // not known yet
...
MessageBuilder.prototype.setSecurity = function(securityMode,securityPolicy) {
    ...
    assert(this.securityPolicy !== undefined);
    assert(this.securityMode !== undefined);
};
...
MessageBuilder.prototype._decrypt_OPN = function(binaryStream) {
    ...
    var signatureIsOK =  this.cryptoFactory.asymmetricVerify(chunk,this.securityHeader.senderCertificate);
...
MessageBuilder.prototype._decrypt_MSG = function(binaryStream) {
    ...
    //xx console.log("xxxxxxxxxxxxxxx packet to verisign".cyan);
    //xx console.log(derivedKeys);
    //xx console.log(hexDump(chunk).red);
...
MessageBuilder.prototype._read_headers = function(binaryStream) {
    ...
    if (msgType === "HEL" || msgType === "ACK" )  {
        ...
        if (msgType === "OPN" ) {
            ...
            this.cryptoFactory = SecurityPolicy.getCryptoFactory(this.securityPolicy);
        }
