...
{
    return crypto_utils.publicEncrypt(buffer,publicKey,crypto_utils.RSA_PKCS1_PADDING);
}
...
function getCryptoFactory(securityPolicy) {
    ...
    switch(securityPolicy.key) {
        ...
        case SecurityPolicy.Basic128Rsa15.key:
            ...
            data.symmetricEncrypt           = RSAPKCS1V15_Encrypt;
        ...
        case SecurityPolicy.Basic256.key:
            ...
            /* asymmetric encryption algorithm */
            data.symmetricEncrypt           = RSAOAEP_Encrypt;
