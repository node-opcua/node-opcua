...
{
    return crypto_utils.privateDecrypt_long(buffer,privateKey,128,crypto_utils.RSA_PKCS1_OAEP_PADDING);
}
// --------------------
...
{
    return crypto_utils.publicEncrypt_long(buffer, publicKey,128,42,crypto_utils.RSA_PKCS1_OAEP_PADDING);
}
...
function getCryptoFactory(securityPolicy) {
    ...
    switch(securityPolicy.key) {
        ...
        case SecurityPolicy.Basic256Rsa15.key:
            return null;
