...
export { trace_from_this_projet_only };
...
export { buffer_ellipsis };
export { compare_buffers };
export { make_debugLog };
export { checkDebugFlag };
export { setDebugFlag };
export { redirectToFile };
export { makeBuffer as makebuffer };
export { replaceBufferWithHexDump };
export { hexDump };
export { toHex };
export { display_trace_from_this_projet_only };
export { dumpIf };
export { dump };
export { get_clock_tick };
...
export function constructFilename(dir) {
...
export function _DEPRECATED_SOON_REMOVED(name, func, extra_info) {
...
// istanbul ignore next
export function _DEPRECATED_RENAMED(oldName, newName) {
  return function (...args) {
