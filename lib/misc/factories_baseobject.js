...
const BinaryStreamSizeCalculator = require("lib/misc/binaryStream").BinaryStreamSizeCalculator;
const assert = require("better-assert");
const _ = require("underscore");
const hexDump = require("lib/misc/utils").hexDump;

const getFactory = require("lib/misc/factories_factories").getFactory;
const _defaultTypeMap = require("lib/misc/factories_builtin_types")._defaultTypeMap;

const get_base_schema = require("lib/misc/factories_schema_helpers").get_base_schema;
 ...
 */
BaseUAObject.prototype.encode = () => /*stream,options*/{
 ...
 */
BaseUAObject.prototype.decode = () => /*stream,options*/{
 ...
 * @return {String}
 */
BaseUAObject.prototype.toString = function(...args) {
...
BaseUAObject.prototype.explore = function(...args) {
...
BaseUAObject.prototype.toJSON = function(...args) {
