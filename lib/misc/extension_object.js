...
function constructEmptyExtensionObject(nodeId) {
    return factories.constructObject(nodeId);
}
...
factories.registerBuiltInType("ExtensionObject", encodeExtensionObject, decodeExtensionObject, function () {
    return null;
});
