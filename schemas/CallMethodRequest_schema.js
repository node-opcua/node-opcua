...
var CallMethodRequest_Schema = {
     ...
     *
     */
        {name: "objectId",  fieldType:"NodeId",  documentation:"The NodeId shall be that of the Object or ObjectType that " +
     ...
     */
        {name: "inputArguments", fieldType:"BaseDataType", isArray: true, documentation:"The list of input argument values." }
    ]
};
