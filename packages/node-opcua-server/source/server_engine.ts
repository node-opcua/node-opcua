...
import { makeNodeId, NodeId, NodeIdLike, NodeIdType, resolveNodeId, coerceNodeId } from "node-opcua-nodeid";
...
import { DataTypeIds, MethodIds, VariableIds, ObjectIds } from "node-opcua-constants";
