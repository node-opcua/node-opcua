...
describe("preventing server to start with invalid certificates/private key combination", () => {
    it("KP1: should raise a exception when attempting to start a server with key pair mistmatch", async () => {
        const certificateFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_cert_2048.pem");
        const privateKeyFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_key_1024.pem");
    ...
    it("KP2: should raise a warning when attempting to start a server with a key length <=1024", async () => {
        ...
        const certificateFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_cert_1024.pem");
        const privateKeyFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_key_1024.pem");
    ...
    it("KP3: should raise a warning when attempting to start a server with a out of date certificate", async () => {
        ...
        const certificateFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_cert_2048_outofdate.pem");
        const privateKeyFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_key_2048.pem");
    ...
    it("KP4: should raise a warning when attempting to start a server with a certificate that is not yet active", async () => {
        ...
        const certificateFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_cert_2048_not_active_yet.pem");
        const privateKeyFile = path.join(__dirname, "../../node-opcua-samples/certificates/server_key_2048.pem");
