...
describe("SM1 - Subscriptions and MonitoredItems", function () {
    ...
    it("should return an error when filter is DataChangeFilter deadband is out of bound", function (done) {
        ...
        on_subscription(function (subscription) {
            ...
            const createResult1 = subscription.createMonitoredItem(
                addressSpace,
                TimestampsToReturn.Both,
                monitoredItemCreateRequest1
            );
            ...
            const createResult2 = subscription.createMonitoredItem(
                addressSpace,
                TimestampsToReturn.Both,
            ...
            const createResult3 = subscription.createMonitoredItem(
                addressSpace,
                TimestampsToReturn.Both,
