import { OPCUAClient, ClientSession, MethodIds, ObjectIds, DataType, ServerState, coerceLocalizedText, StatusCodes } from "node-opcua-client";
           ...
           await client.withSessionAsync(test.endpointUrl, async (session) =>{
              const result = await session.call({
                ...
                inputArguments: [
                    ...
                    { dataType: DataType.LocalizedText, value: coerceLocalizedText({ text: "For maintenance", locale: "en_US" }) },
