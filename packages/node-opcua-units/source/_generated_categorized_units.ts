...
export const categorizedUnits = {
    ...
    Space_and_Time: {
        ...
        angle: {
            ...
            "degree[unit_of_angle]": makeEUInformation("DD", "°", "degree [unit of angle] (1,745 329 × 10⁻² rad)"),
        ...
        area: {
            ...
            "square_mile(based_on_U.S._survey_foot)_": makeEUInformation(
                "M48",
                "mi² (US survey)",
        ...
        volume: {
            ...
            "ton(register_)": makeEUInformation(
                "M70",
                "RT",
        ...
        time: {
            ...
            month: makeEUInformation(
                "MON",
                "mo",
                "month - Unit of time equal to 1/12 of a year of 365,25 days. (2,629 800 x 10⁶ s)"
            ),
    ...
    Mechanics: {
        ...
        density: {
            ...
            "pound(avoirdupois)_per_psi": makeEUInformation(
                "K77",
                "lb/psi",
        ...
        moment_of_force: {
            ...
            "ounce(avoirdupois)-force_inch": makeEUInformation(
                "L41",
                "ozf·in",
        ...
        pressure: {
            ...
            "ounce(avoirdupois)_per_square_inch_": makeEUInformation(
                "N22",
                "oz/in²",
        ...
        work: {
            ...
            "megawatt_hour(1000 kW.h)": makeEUInformation(
                "MWH",
                "MW·h",
        ...
        mass_flow_rate: {
            ...
            "pound(avoirdupois)_per_minute": makeEUInformation(
                "K78",
                "lb/min",
            ...
            "ounce(avoirdupois)_per_minute": makeEUInformation(
                "L35",
                "oz/min",
                "ounce (avoirdupois) per minute (4,724 92 x 10⁻⁴ kg/s)"
            ),
            "ounce(avoirdupois)_per_second": makeEUInformation(
                "L36",
                "oz/s",
        ...
        volume_flow_rate: {
            ...
            "bushel(US_dry)_per_hour": makeEUInformation(
                "J69",
                "bu (US dry)/h",
                "bushel (US dry) per hour (9,788 631 x 10⁻⁶ m³/s)"
            ),
            "bushel(US_dry)_per_minute": makeEUInformation(
                "J70",
                "bu (US dry)/min",
                "bushel (US dry) per minute (5,873 178 x 10⁻⁴ m³/s)"
            ),
            "bushel(US_dry)_per_second": makeEUInformation(
                "J71",
                "bu (US dry)/s",
            ...
            "ounce(UK_fluid)_per_day": makeEUInformation(
                "J95",
                "fl oz (UK)/d",
                "ounce (UK fluid) per day (3,288 549 x 10⁻¹⁰ m³/s)"
            ),
            "ounce(UK_fluid)_per_hour": makeEUInformation(
                "J96",
                "fl oz (UK)/h",
                "ounce (UK fluid) per hour (7,892 517 x 10⁻⁹ m³/s)"
            ),
            "ounce(UK_fluid)_per_minute": makeEUInformation(
                "J97",
                "fl oz (UK)/min",
                "ounce (UK fluid) per minute (4,735 51 x 10⁻⁷ m³/s)"
            ),
            "ounce(UK_fluid)_per_second": makeEUInformation(
                "J98",
                "fl oz (UK)/s",
                "ounce (UK fluid) per second (2,841 306 x 10⁻⁵ m³/s)"
            ),
            "ounce(US_fluid)_per_day": makeEUInformation(
                "J99",
                "fl oz (US)/d",
                "ounce (US fluid) per day (3,422 862 x 10⁻¹⁰ m³/s)"
            ),
            "ounce(US_fluid)_per_hour": makeEUInformation(
                "K10",
                "fl oz (US)/h",
                "ounce (US fluid) per hour (8,214 869 x 10⁻⁹ m³/s)"
            ),
            "ounce(US_fluid)_per_minute": makeEUInformation(
                "K11",
                "fl oz (US)/min",
                "ounce (US fluid) per minute (4,928 922 x 10⁻⁷ m³/s)"
            ),
            "ounce(US_fluid)_per_second": makeEUInformation(
                "K12",
                "fl oz (US)/s",
            ...
            "quart(UK_liquid)_per_day": makeEUInformation(
                "K94",
                "qt (UK liq.)/d",
                "quart (UK liquid) per day (1,315 420 x 10⁻⁸ m³/s)"
            ),
            "quart(UK_liquid)_per_hour": makeEUInformation(
                "K95",
                "qt (UK liq.)/h",
            ...
            "quart(US_liquid)_per_day": makeEUInformation(
                "K98",
                "qt (US liq.)/d",
                "quart (US liquid) per day (1,095 316 x 10⁻⁸ m³/s)"
            ),
            "quart(US_liquid)_per_hour": makeEUInformation(
                "K99",
                "qt (US liq.)/h",
            ...
            "peck(US_dry)_per_minute": makeEUInformation(
                "L50",
                "pk (US dry)/min",
                "peck (US dry) per minute (1,468 295 x 10⁻⁴ m³/s)"
            ),
            "peck(US_dry)_per_second": makeEUInformation(
                "L51",
                "pk (US dry)/s",
            ...
            "pint(US_liquid)_per_day": makeEUInformation(
                "L57",
                "pt (US liq.)/d",
                "pint (US liquid) per day (5,476 580 x 10⁻⁹ m³/s)"
            ),
            "pint(US_liquid)_per_hour": makeEUInformation(
                "L58",
                "pt (US liq.)/h",
            ...
            "pint(US_liquid)_per_second": makeEUInformation(
                "L60",
                "pt (US liq.)/s",
    ...
    Heat: {
        ...
        heat: {
            ...
            "calorie(international_table)_": makeEUInformation("D70", "calIT", "calorie (international table) (4,186 8 J)"),
            ...
            "kilocalorie(international_table)": makeEUInformation(
                "E14",
                "kcalIT",
            ...
            "British_thermal_unit(39_ºF)_": makeEUInformation(
                "N66",
                "Btu (39 ºF)",
            ...
            "British_thermal_unit(60_ºF)_": makeEUInformation(
                "N68",
                "Btu (60 ºF)",
            ...
            "calorie(20_ºC)_": makeEUInformation(
                "N69",
                "cal₂₀",
        ...
        heat_flow_rate: {
            ...
            "calorie(thermochemical)_per_second": makeEUInformation(
                "J82",
                "calth/s",
        ...
        thermal_conductivity: {
            ...
            "British_thermal_unit(international_table)_foot_per_hour square_foot_degree_Fahrenheit": makeEUInformation(
                "J40",
                "BtuIT·ft/(h·ft²·°F)",
                "British thermal unit (international table) foot per hour square foot degree Fahrenheit (1,730 735 W/(m x K))"
            ),
            "British_thermal_unit(international_table)_inch_per_hour_square foot_degree_Fahrenheit": makeEUInformation(
                "J41",
                "BtuIT·in/(h·ft²·°F)",
                "British thermal unit (international table) inch per hour square foot degree Fahrenheit (0,144 227 9 W/(m x K))"
            ),
            "British_thermal_unit(international_table)_inch_per_second_square foot_degree_Fahrenheit": makeEUInformation(
                "J42",
                "BtuIT·in/(s·ft²·°F)",
                "British thermal unit (international table) inch per second square foot degree Fahrenheit (5,192 204 x 10² W/(m x K))"
            ),
            "British_thermal_unit(thermochemical)_foot_per_hour_square foot_degree_Fahrenheit": makeEUInformation(
                "J46",
                "Btuth·ft/(h·ft²·°F)",
                "British thermal unit (thermochemical) foot per hour square foot degree Fahrenheit (1,729 577 W/(m x K))"
            ),
            "British_thermal_unit(thermochemical)_inch_per_hour_square foot_degree_Fahrenheit": makeEUInformation(
                "J48",
                "Btuth·in/(h·ft²·°F)",
                "British thermal unit (thermochemical) inch per hour square foot degree Fahrenheit (0,144 131 4 W/(m x K))"
            ),
            "British_thermal_unit(thermochemical)_inch_per_second square_foot_degree_Fahrenheit": makeEUInformation(
                "J49",
                "Btuth·in/(s·ft²·°F)",
        ...
        specific_Helmholtz_function: {
            "calorie(thermochemical)_per_gram": makeEUInformation(
                "B36",
                "calth/g",
         ...
         */
        energy_density: {
            "British_thermal_unit(international_table)_per_cubic_foot_": makeEUInformation(
                "N58",
                "BtuIT/ft³",
    ...
    Light_and_Related_Electromagnetic_Radiations: {
        ...
        radiant_energy_fluence: {
            ...
            "calorie(thermochemical)_per_square_centimetre_": makeEUInformation(
                "P39",
                "calth/cm²",
        ...
        illuminance: {
            ...
            kilolux: makeEUInformation(
                "KLX",
                "klx",
                "kilolux - A unit of illuminance equal to one thousand lux. (10³ cd x sr / m²)"
            ),
    ...
    denier: makeEUInformation(
        "A49",
        "den (g/9 km)",
        "denier - A unit of yarn density. One denier equals a mass of 1 gram per 9 kilometres of length."
    ),
