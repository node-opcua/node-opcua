...
export const allUnits = {
    ...
    "British_thermal_unit(59_ºF)": makeEUInformation(
        "N67",
        "Btu (59 ºF)",
    ...
    "British_thermal_unit(60_ºF)": makeEUInformation(
        "N68",
        "Btu (60 ºF)",
    ...
    "British_thermal_unit(international_table)": makeEUInformation(
        "BTU",
        "BtuIT",
        "British thermal unit (international table) (1,055 056 x 10³ J)"
    ),
    "British_thermal_unit(international_table)_foot_per_hour_square_foot_degree_Fahrenheit": makeEUInformation(
        "J40",
        "BtuIT·ft/(h·ft²·°F)",
        "British thermal unit (international table) foot per hour square foot degree Fahrenheit (1,730 735 W/(m x K))"
    ),
    "British_thermal_unit(international_table)_inch_per_hour_square_foot_degree_Fahrenheit": makeEUInformation(
        "J41",
        "BtuIT·in/(h·ft²·°F)",
        "British thermal unit (international table) inch per hour square foot degree Fahrenheit (0,144 227 9 W/(m x K))"
    ),
    "British_thermal_unit(international_table)_inch_per_second_square_foot_degree_Fahrenheit": makeEUInformation(
        "J42",
        "BtuIT·in/(s·ft²·°F)",
        "British thermal unit (international table) inch per second square foot degree Fahrenheit (5,192 204 x 10² W/(m x K))"
    ),
    "British_thermal_unit(international_table)_per_cubic_foot": makeEUInformation(
        "N58",
        "BtuIT/ft³",
    ...
    "British_thermal_unit(international_table)_per_degree_Fahrenheit": makeEUInformation(
        "N60",
        "BtuIT/ºF",
    ...
    "British_thermal_unit(international_table)_per_degree_Rankine": makeEUInformation(
        "N62",
        "BtuIT/ºR",
    ...
    "British_thermal_unit(international_table)_per_hour": makeEUInformation(
        "2I",
        "BtuIT/h",
        "British thermal unit (international table) per hour (2,930 711x 10⁻¹ W)"
    ),
    "British_thermal_unit(international_table)_per_hour_square_foot_degree_Fahrenheit": makeEUInformation(
        "N74",
        "BtuIT/(h·ft²·ºF)",
    ...
    "British_thermal_unit(international_table)_per_hour_square_foot_degree_Rankine": makeEUInformation(
        "A23",
        "BtuIT/(h·ft²·°R)",
        "British thermal unit (international table) per hour square foot degree Rankine (5,678 26 W/ (m² x K))"
    ),
    "British_thermal_unit(international_table)_per_minute": makeEUInformation(
        "J44",
        "BtuIT/min",
        "British thermal unit (international table) per minute (17,584 266 W)"
    ),
    "British_thermal_unit(international_table)_per_pound": makeEUInformation(
        "AZ",
        "BtuIT/lb",
        "British thermal unit (international table) per pound (2 326 J/kg)"
    ),
    "British_thermal_unit(international_table)_per_pound_degree_Fahrenheit": makeEUInformation(
        "J43",
        "BtuIT/(lb·°F)",
        "British thermal unit (international table) per pound degree Fahrenheit (4,186 8 x 10³ J/(kg x K))"
    ),
    "British_thermal_unit(international_table)_per_pound_degree_Rankine": makeEUInformation(
        "A21",
        "Btu/IT(lb·°R)",
        "British thermal unit (international table) per pound degree Rankine (4 186,8 J/(kg x K))"
    ),
    "British_thermal_unit(international_table)_per_second": makeEUInformation(
        "J45",
        "BtuIT/s",
        "British thermal unit (international table) per second (1,055 056 x 10³ W)"
    ),
    "British_thermal_unit(international_table)_per_second_foot_degree_Rankine": makeEUInformation(
        "A22",
        "BtuIT/(s·ft·°R)",
        "British thermal unit (international table) per second foot degree Rankine (6 230,64 W/(m x K))"
    ),
    "British_thermal_unit(international_table)_per_second_square_foot_degree_Fahrenheit": makeEUInformation(
        "N76",
        "BtuIT/(s·ft²·ºF)",
    ...
    "British_thermal_unit(international_table)_per_second_square_foot_degree_Rankine": makeEUInformation(
        "A20",
        "BtuIT/(s·ft²·°R)",
        "British thermal unit (international table) per second square foot degree Rankine (20 441,7 W/(m² x K))"
    ),
    "British_thermal_unit(international_table)_per_square_foot": makeEUInformation(
        "P37",
        "BtuIT/ft²",
    ...
    "British_thermal_unit(international_table)_per_square_foot_hour": makeEUInformation(
        "N50",
        "BtuIT/(ft²·h)",
    ...
    "British_thermal_unit(international_table)_per_square_foot_second": makeEUInformation(
        "N53",
        "BtuIT/(ft²·s)",
    ...
    "British_thermal_unit(international_table)_per_square_inch_second": makeEUInformation(
        "N55",
        "BtuIT/(in²·s)",
    ...
    "British_thermal_unit(mean)": makeEUInformation("J39", "Btu", "British thermal unit (mean) (1,055 87 x 10³ J)"),
    "British_thermal_unit(thermochemical)_foot_per_hour_square_foot_degree_Fahrenheit": makeEUInformation(
        "J46",
        "Btuth·ft/(h·ft²·°F)",
        "British thermal unit (thermochemical) foot per hour square foot degree Fahrenheit (1,729 577 W/(m x K))"
    ),
    "British_thermal_unit(thermochemical)_inch_per_hour_square_foot_degree_Fahrenheit": makeEUInformation(
        "J48",
        "Btuth·in/(h·ft²·°F)",
        "British thermal unit (thermochemical) inch per hour square foot degree Fahrenheit (0,144 131 4 W/(m x K))"
    ),
    "British_thermal_unit(thermochemical)_inch_per_second_square_foot_degree_Fahrenheit": makeEUInformation(
        "J49",
        "Btuth·in/(s·ft²·°F)",
        "British thermal unit (thermochemical) inch per second square foot degree Fahrenheit (5,188 732 x 10² W/(m x K))"
    ),
    "British_thermal_unit(thermochemical)_per_cubic_foot": makeEUInformation(
        "N59",
        "Btuth/ft³",
    ...
    "British_thermal_unit(thermochemical)_per_degree_Fahrenheit": makeEUInformation(
        "N61",
        "Btuth/ºF",
    ...
    "British_thermal_unit(thermochemical)_per_degree_Rankine": makeEUInformation(
        "N63",
        "Btuth/ºR",
    ...
    "British_thermal_unit(thermochemical)_per_hour": makeEUInformation(
        "J47",
        "Btuth/h",
        "British thermal unit (thermochemical) per hour (0,292 875 1 W)"
    ),
    "British_thermal_unit(thermochemical)_per_hour_square_foot_degree_Fahrenheit": makeEUInformation(
        "N75",
        "Btuth/(h·ft²·ºF)",
    ...
    "British_thermal_unit(thermochemical)_per_minute": makeEUInformation(
        "J51",
        "Btuth/min",
        "British thermal unit (thermochemical) per minute (17,572 50 W)"
    ),
    "British_thermal_unit(thermochemical)_per_pound": makeEUInformation(
        "N73",
        "Btuth/lb",
    ...
    "British_thermal_unit(thermochemical)_per_pound_degree_Fahrenheit": makeEUInformation(
        "J50",
        "Btuth/(lb·°F)",
        "British thermal unit (thermochemical) per pound degree Fahrenheit (4,184 x 10³ J/(kg x K))"
    ),
    "British_thermal_unit(thermochemical)_per_pound_degree_Rankine": makeEUInformation(
        "N64",
        "(Btuth/°R)/lb",
    ...
    "British_thermal_unit(thermochemical)_per_second": makeEUInformation(
        "J52",
        "Btuth/s",
        "British thermal unit (thermochemical) per second (1,054 350 x 10³ W)"
    ),
    "British_thermal_unit(thermochemical)_per_second_square_foot_degree_Fahrenheit": makeEUInformation(
        "N77",
        "Btuth/(s·ft²·ºF)",
    ...
    "British_thermal_unit(thermochemical)_per_square_foot": makeEUInformation(
        "P38",
        "Btuth/ft²",
    ...
    "British_thermal_unit(thermochemical)_per_square_foot_hour": makeEUInformation(
        "N51",
        "Btuth/(ft²·h)",
    ...
    "British_thermal_unit(thermochemical)_per_square_foot_minute": makeEUInformation(
        "N52",
        "Btuth/(ft²·min)",
    ...
    "British_thermal_unit(thermochemical)_per_square_foot_second": makeEUInformation(
        "N54",
        "Btuth/(ft²·s)",
    ...
    Imperial_gallon_per_minute: makeEUInformation("G3", "gal (UK) /min", "Imperial gallon per minute (7,576 82 x 10⁻⁵ m³/s)"),
    ...
    "acre-foot(based_on_U.S._survey_foot)": makeEUInformation(
        "M67",
        "acre-ft (US survey)",
    ...
    "bar[unit_of_pressure]": makeEUInformation("BAR", "bar", "bar [unit of pressure] (10⁵ Pa)"),
    ...
    "barrel(UK_petroleum)": makeEUInformation("J57", "bbl (UK liq.)", "barrel (UK petroleum) (0,159 113 15 m³)"),
    "barrel(UK_petroleum)_per_day": makeEUInformation(
        "J59",
        "bbl (UK liq.)/d",
        "barrel (UK petroleum) per day (1,841 587 4 x 10⁻⁶ m³/s)"
    ),
    "barrel(UK_petroleum)_per_hour": makeEUInformation(
        "J60",
        "bbl (UK liq.)/h",
        "barrel (UK petroleum) per hour (4,419 810 x 10⁻⁵ m³/s)"
    ),
    "barrel(UK_petroleum)_per_minute": makeEUInformation(
        "J58",
        "bbl (UK liq.)/min",
        "barrel (UK petroleum) per minute (2,651 886 m³/s)"
    ),
    "barrel(UK_petroleum)_per_second": makeEUInformation(
        "J61",
        "bbl (UK liq.)/s",
        "barrel (UK petroleum) per second (0,159 113 15 m³/s)"
    ),
    "barrel(US_petroleum)_per_hour": makeEUInformation(
        "J62",
        "bbl (US)/h",
        "barrel (US petroleum) per hour (4,416 314 x 10⁻⁵ m³/s)"
    ),
    "barrel(US_petroleum)_per_second": makeEUInformation(
        "J63",
        "bbl (US)/s",
        "barrel (US petroleum) per second (0,158 987 3 m³/s)"
    ),
    "barrel(US)": makeEUInformation("BLL", "barrel (US)", "barrel (US) (158,987 3 x 10⁻³ m³)"),
    "barrel(US)_per_minute": makeEUInformation("5A", "barrel (US)/min", "barrel (US) per minute (2,649 79 x 10⁻³ m³/s)"),
    ...
    "bushel(UK)": makeEUInformation("BUI", "bushel (UK)", "bushel (UK) (3,636 872 x 10⁻² m³)"),
    "bushel(UK)_per_day": makeEUInformation("J64", "bu (UK)/d", "bushel (UK) per day (4,209 343 x 10⁻⁷ m³/s)"),
    "bushel(UK)_per_hour": makeEUInformation("J65", "bu (UK)/h", "bushel (UK) per hour (1,010 242 x 10⁻⁵ m³/s)"),
    "bushel(UK)_per_minute": makeEUInformation("J66", "bu (UK)/min", "bushel (UK) per minute (6,061 453 x 10⁻⁴ m³/s)"),
    "bushel(UK)_per_second": makeEUInformation("J67", "bu (UK)/s", "bushel (UK) per second (3,636 872 x 10⁻² m³/s)"),
    "bushel(US_dry)_per_day": makeEUInformation("J68", "bu (US dry)/d", "bushel (US dry) per day (4,078 596 x 10⁻⁷ m³/s)"),
    "bushel(US_dry)_per_hour": makeEUInformation("J69", "bu (US dry)/h", "bushel (US dry) per hour (9,788 631 x 10⁻⁶ m³/s)"),
    "bushel(US_dry)_per_minute": makeEUInformation("J70", "bu (US dry)/min", "bushel (US dry) per minute (5,873 178 x 10⁻⁴ m³/s)"),
    "bushel(US_dry)_per_second": makeEUInformation("J71", "bu (US dry)/s", "bushel (US dry) per second (3,523 907 x 10⁻² m³/s)"),
    "bushel(US)": makeEUInformation("BUA", "bu (US)", "bushel (US) (3,523 907 x 10⁻² m³)"),
    "calorie(20_ºC)": makeEUInformation(
        "N69",
        "cal₂₀",
    ...
    "calorie(international_table)": makeEUInformation("D70", "calIT", "calorie (international table) (4,186 8 J)"),
    "calorie(international_table)_per_gram": makeEUInformation(
        "D75",
        "calIT/g",
        "calorie (international table) per gram (4 186,8 J/kg)"
    ),
    "calorie(international_table)_per_gram_degree_Celsius": makeEUInformation(
        "J76",
        "calIT/(g·°C)",
    ...
    "calorie(international_table)_per_second_centimetre_kelvin": makeEUInformation(
        "D71",
        "calIT/(s·cm·K)",
        "calorie (international table) per second centimetre kelvin (418,68 W/(m x K))"
    ),
    "calorie(international_table)_per_second_square_centimetre_kelvin": makeEUInformation(
        "D72",
        "calIT/(s·cm²·K)",
        "calorie (international table) per second square centimetre kelvin (4,186 8 x 10⁴ W/(m² x K))"
    ),
    "calorie(mean)": makeEUInformation("J75", "cal", "calorie (mean) (4,190 02 J)"),
    "calorie(thermochemical)": makeEUInformation("D35", "calth", "calorie (thermochemical) (4,184 J)"),
    "calorie(thermochemical)_per_centimetre_second_degree_Celsius": makeEUInformation(
        "J78",
        "calth/(cm·s·°C)",
        "calorie (thermochemical) per centimetre second degree Celsius (4,184 x 10² W/(m x K))"
    ),
    "calorie(thermochemical)_per_gram": makeEUInformation("B36", "calth/g", "calorie (thermochemical) per gram (4 184 J/kg)"),
    "calorie(thermochemical)_per_gram_degree_Celsius": makeEUInformation(
        "J79",
        "calth/(g·°C)",
    ...
    "calorie(thermochemical)_per_minute": makeEUInformation(
        "J81",
        "calth/min",
        "calorie (thermochemical) per minute (6,973 333 x 10⁻² W)"
    ),
    "calorie(thermochemical)_per_second": makeEUInformation("J82", "calth/s", "calorie (thermochemical) per second (4,184 W)"),
    "calorie(thermochemical)_per_second_centimetre_kelvin": makeEUInformation(
        "D38",
        "calth/(s·cm·K)",
        "calorie (thermochemical) per second centimetre kelvin (418,4 W/(m x K))"
    ),
    "calorie(thermochemical)_per_second_square_centimetre_kelvin": makeEUInformation(
        "D39",
        "calth/(s·cm²·K)",
        "calorie (thermochemical) per second square centimetre kelvin (4,184 x10⁴ W/(m² x K))"
    ),
    "calorie(thermochemical)_per_square_centimetre": makeEUInformation(
        "P39",
        "calth/cm²",
    ...
    "calorie(thermochemical)_per_square_centimetre_minute": makeEUInformation(
        "N56",
        "calth/(cm²·min)",
    ...
    "calorie(thermochemical)_per_square_centimetre_second": makeEUInformation(
        "N57",
        "calth/(cm²·s)",
    ...
    candela_per_square_inch: makeEUInformation(
        "P28",
        "cd/in²",
    ...
    "centimetre_of_water(4_ºC)": makeEUInformation(
        "N14",
        "cmH₂O (4 °C)",
    ...
    "chain(based_on_U.S._survey_foot)": makeEUInformation(
        "M49",
        "ch (US survey)",
    ...
    circular_mil: makeEUInformation(
        "M47",
        "cmil",
    ...
    conventional_centimetre_of_water: makeEUInformation("H78", "cm H₂O", "conventional centimetre of water (9,806 65 × 10¹ Pa)"),
    ...
    conventional_millimetre_of_mercury: makeEUInformation("HN", "mm Hg", "conventional millimetre of mercury (133,322 4 Pa)"),
    conventional_millimetre_of_water: makeEUInformation("HP", "mm H₂O", "conventional millimetre of water (9,806 65 Pa)"),
    "cord(128_ft3)": makeEUInformation(
        "M68",
        "cord",
    ...
    cubic_centimetre_per_minute: makeEUInformation("G49", "cm³/min", "cubic centimetre per minute (1,666 67 × 10⁻⁸ m³ x s⁻¹)"),
    ...
    cubic_metre_per_day_bar: makeEUInformation("G86", "m³/(d·bar)", "cubic metre per day bar (1,157 41 × 10⁻¹⁰ kg⁻¹ x m⁴ x s)"),
    cubic_metre_per_day_kelvin: makeEUInformation("G69", "m³/(d·K)", "cubic metre per day kelvin (1,157 41 × 10⁻⁵ m³ x s⁻¹ x K⁻¹)"),
    cubic_metre_per_hour: makeEUInformation("MQH", "m³/h", "cubic metre per hour (2,777 78 x 10⁻⁴ m³/s)"),
    cubic_metre_per_hour_bar: makeEUInformation("G87", "m³/(h·bar)", "cubic metre per hour bar (2,777 78 × 10⁻⁹ kg⁻¹ x m⁴ x s)"),
    ...
    "cubic_mile(UK_statute)": makeEUInformation(
        "M69",
        "mi³",
    ...
    cubic_yard_per_degree_Fahrenheit: makeEUInformation("M11", "yd³/°F", "cubic yard per degree Fahrenheit (1,376 199 m³/K)"),
    ...
    "cup[unit_of_volume]": makeEUInformation("G21", "cup (US)", "cup [unit of volume] (2,365 882 x 10⁻⁴ m³)"),
    ...
    "decade(logarithmic)": makeEUInformation(
        "P41",
        "dec",
    ...
    "degree_Fahrenheit_hour_per_British_thermal_unit(international_table)": makeEUInformation(
        "N84",
        "ºF/(BtuIT/h)",
    ...
    "degree_Fahrenheit_hour_per_British_thermal_unit(thermochemical)": makeEUInformation(
        "N85",
        "ºF/(Btuth/h)",
    ...
    "degree_Fahrenheit_hour_square_foot_per_British_thermal_unit(international_table)": makeEUInformation(
        "J22",
        "°F·h·ft²/BtuIT",
        "degree Fahrenheit hour square foot per British thermal unit (international table) (0,176 110 2 m² x K/W)"
    ),
    "degree_Fahrenheit_hour_square_foot_per_British_thermal_unit(international_table)_inch": makeEUInformation(
        "N88",
        "ºF·h·ft²/(BtuIT·in)",
    ...
    "degree_Fahrenheit_hour_square_foot_per_British_thermal_unit(thermochemical)": makeEUInformation(
        "J19",
        "°F·h·ft²/Btuth",
        "degree Fahrenheit hour square foot per British thermal unit (thermochemical) (0,176 228 m² x K/W)"
    ),
    "degree_Fahrenheit_hour_square_foot_per_British_thermal_unit(thermochemical)_inch": makeEUInformation(
        "N89",
        "ºF·h·ft²/(Btuth·in)",
    ...
    degree_Fahrenheit_per_minute: makeEUInformation("J24", "°F/min", "degree Fahrenheit per minute (9,259 259 x 10⁻³  K/s)"),
    degree_Fahrenheit_per_second: makeEUInformation("J25", "°F/s", "degree Fahrenheit per second (0,555 555 6 K/s)"),
    "degree_Fahrenheit_second_per_British_thermal_unit(international_table)": makeEUInformation(
        "N86",
        "ºF/(BtuIT/s)",
    ...
    "degree[unit_of_angle]": makeEUInformation("DD", "°", "degree [unit of angle] (1,745 329 x 10⁻² rad)"),
    "degree[unit_of_angle]_per_second_squared": makeEUInformation(
        "M45",
        "°/s²",
    ...
    denier: makeEUInformation(
        "M83",
        "den",
        "denier - Traditional unit for the indication of the linear mass of textile fibers and yarns. (1,111 111 x 10⁻⁷ kg/m)"
    ),
    "dry_barrel(US)": makeEUInformation("BLD", "bbl (US)", "dry barrel (US) (1,156 27 x 10⁻¹ m³)"),
    "dry_gallon(US)": makeEUInformation("GLD", "dry gal (US)", "dry gallon (US) (4,404 884 x 10⁻³ m³)"),
    "dry_pint(US)": makeEUInformation("PTD", "dry pt (US)", "dry pint (US) (5,506 105 x 10⁻⁴ m³)"),
    "dry_quart(US)": makeEUInformation("QTD", "dry qt (US)", "dry quart (US) (1,101 221 x 10⁻³ m³)"),
    ...
    dyne_second_per_cubic_centimetre: makeEUInformation("A50", "dyn·s/cm³", "dyne second per cubic centimetre (10 Pa x s/m)"),
    ...
    electronvolt_square_metre: makeEUInformation("A55", "eV·m²", "electronvolt square metre (1,602 176 487 x 10⁻¹⁹ J x m²)"),
    ...
    erg_per_second_square_centimetre: makeEUInformation("A64", "erg/(s·cm²)", "erg per second square centimetre (10⁻³ W/m²)"),
    erg_per_square_centimetre_second: makeEUInformation("A65", "erg/(cm²·s)", "erg per square centimetre second (10⁻³ W/m²)"),
    ...
    "fluid_ounce(UK)": makeEUInformation("OZI", "fl oz (UK)", "fluid ounce (UK) (2,841 306 x 10⁻⁵ m³)"),
    "fluid_ounce(US)": makeEUInformation("OZA", "fl oz (US)", "fluid ounce (US) (2,957 353 x 10⁻⁵ m³)"),
    foot: makeEUInformation("FOT", "ft", "foot (0,304 8 m)"),
    "foot(U.S._survey)": makeEUInformation(
        "M51",
        "ft (US survey)",
    ...
    "foot_of_water(39.2_ºF)": makeEUInformation(
        "N15",
        "ftH₂O (39,2 ºF)",
    ...
    "foot_pound-force_per_minute": makeEUInformation("K16", "ft·lbf/min", "foot pound-force per minute (2,259 697 x 10⁻² W)"),
    ...
    foot_to_the_fourth_power: makeEUInformation(
        "N27",
        "ft⁴",
    ...
    "gallon(UK)": makeEUInformation("GLI", "gal (UK)", "gallon (UK) (4,546 092 x 10⁻³ m³)"),
    "gallon(UK)_per_day": makeEUInformation("K26", "gal (UK)/d", "gallon (UK) per day (5,261 678 x 10⁻⁸ m³/s)"),
    "gallon(UK)_per_hour": makeEUInformation("K27", "gal (UK)/h", "gallon (UK) per hour (1,262 803 x 10⁻⁶ m³/s)"),
    "gallon(UK)_per_second": makeEUInformation("K28", "gal (UK)/s", "gallon (UK) per second (4,546 09 x 10⁻³ m³/s)"),
    "gallon(US_liquid)_per_second": makeEUInformation(
        "K30",
        "gal (US liq.)/s",
        "gallon (US liquid) per second (3,785 412 x 10⁻³ m³/s)"
    ),
    "gallon(US)": makeEUInformation("GLL", "gal (US)", "gallon (US) (3,785 412 x 10⁻³ m³)"),
    "gallon(US)_per_hour": makeEUInformation("G50", "gal/h", "gallon (US) per hour (1,051 5 × 10⁻⁶ m³ x s⁻¹)"),
    ...
    "gill(UK)_per_day": makeEUInformation("K32", "gi (UK)/d", "gill (UK) per day (1,644 274 x 10⁻⁵ m³/s)"),
    "gill(UK)_per_hour": makeEUInformation("K33", "gi (UK)/h", "gill (UK) per hour (3,946 258 x 10⁻⁸ m³/s)"),
    "gill(UK)_per_minute": makeEUInformation("K34", "gi (UK)/min", "gill (UK) per minute (0,023 677 55 m³/s)"),
    "gill(UK)_per_second": makeEUInformation("K35", "gi (UK)/s", "gill (UK) per second (1,420 653 x 10⁻⁴ m³/s)"),
    "gill(US)_per_day": makeEUInformation("K36", "gi (US)/d", "gill (US) per day (1,369 145 x 10⁻⁹ m³/s)"),
    "gill(US)_per_hour": makeEUInformation("K37", "gi (US)/h", "gill (US) per hour (3,285 947 x 10⁻⁸ m³/s)"),
    "gill(US)_per_minute": makeEUInformation("K38", "gi (US)/min", "gill (US) per minute (1,971 568 x 10⁻⁶ m³/s)"),
    "gill(US)_per_second": makeEUInformation("K39", "gi (US)/s", "gill (US) per second (1,182 941 x 10⁻⁴ m³/s)"),
    ...
    "grain_per_gallon(US)": makeEUInformation("K41", "gr/gal (US)", "grain per gallon (US) (1,711 806 x 10⁻² kg/m³)"),
    ...
    gram_per_cubic_decimetre_kelvin: makeEUInformation("G34", "g/(dm³·K)", "gram per cubic decimetre kelvin (kg x m⁻³ x K⁻¹)"),
    ...
    "gram_per_metre(gram_per_100_centimetres)": makeEUInformation(
        "GF",
        "g/m",
    ...
    gram_per_minute_kelvin: makeEUInformation("F37", "g/(min·K)", "gram per minute kelvin (1,666 67 × 10⁻⁵ kg x s⁻¹ x K⁻¹)"),
    ...
    "gram-force_per_square_centimetre": makeEUInformation("K31", "gf/cm²", "gram-force per square centimetre (98,066 5 Pa)"),
    ...
    hectopascal_litre_per_second: makeEUInformation("F93", "hPa·l/s", "hectopascal litre per second (10⁻¹ kg x m² x s⁻³)"),
    ...
    "horsepower(boiler)": makeEUInformation("K42", "boiler hp", "horsepower (boiler) (9,809 50 x 10³ W)"),
    "horsepower(electric)": makeEUInformation("K43", "electric hp", "horsepower (electric) (746 W)"),
    hour: makeEUInformation("HUR", "h", "hour (3 600 s)"),
    "hundred_pound(cwt)_/_hundred_weight_(US)": makeEUInformation(
        "CWA",
        "cwt (US)",
        "hundred pound (cwt) / hundred weight (US) (45,359 2 kg)"
    ),
    "hundred_weight(UK)": makeEUInformation("CWI", "cwt (UK)", "hundred weight (UK) (50,802 35 kg)"),
    ...
    "inch_of_mercury(32_ºF)": makeEUInformation(
        "N16",
        "inHG (32 ºF)",
    ...
    "inch_of_mercury(60_ºF)": makeEUInformation(
        "N17",
        "inHg (60 ºF)",
    ...
    "inch_of_water(39.2_ºF)": makeEUInformation(
        "N18",
        "inH₂O (39,2 ºF)",
    ...
    "inch_of_water(60_ºF)": makeEUInformation(
        "N19",
        "inH₂O (60 ºF)",
    ...
    inch_per_two_pi_radiant: makeEUInformation("H57", "in/revolution", "inch per two pi radiant (2,54 × 10⁻² m/(2 × π × rad))"),
    ...
    "inch_pound(pound_inch)": makeEUInformation("IA", "in·lb", "inch pound (pound inch) (1,152 12 x 10⁻² kg x m)"),
    ...
    international_candle: makeEUInformation(
        "P36",
        "IK",
    ...
    joule_per_square_metre: makeEUInformation("B13", "J/m²", "joule per square metre - Synonym: joule per metre squared (J/m²)"),
    ...
    "kiloampere_hour(thousand_ampere_hour)": makeEUInformation(
        "TAH",
        "kA·h",
    ...
    "kilocalorie(international_table)": makeEUInformation("E14", "kcalIT", "kilocalorie (international table) (4,186 8 x 10³ J)"),
    "kilocalorie(international_table)_per_gram_kelvin": makeEUInformation(
        "N65",
        "(kcalIT/K)/g",
    ...
    "kilocalorie(international_table)_per_hour_metre_degree_Celsius": makeEUInformation(
        "K52",
        "kcal/(m·h·°C)",
        "kilocalorie (international table) per hour metre degree Celsius (1,163 J/(m x s x K))"
    ),
    "kilocalorie(mean)": makeEUInformation("K51", "kcal", "kilocalorie (mean) (4,190 02 x 10³ J)"),
    "kilocalorie(thermochemical)": makeEUInformation("K53", "kcalth", "kilocalorie (thermochemical) (4,184 x 10³ J)"),
    "kilocalorie(thermochemical)_per_hour": makeEUInformation(
        "E15",
        "kcalth/h",
        "kilocalorie (thermochemical) per hour (1,162 22 W)"
    ),
    "kilocalorie(thermochemical)_per_minute": makeEUInformation(
        "K54",
        "kcalth/min",
        "kilocalorie (thermochemical) per minute (69,733 33 W)"
    ),
    "kilocalorie(thermochemical)_per_second": makeEUInformation(
        "K55",
        "kcalth/s",
    ...
    kilogram_per_cubic_centimetre_bar: makeEUInformation("G16", "kg/(cm³·bar)", "kilogram per cubic centimetre bar (10¹ m⁻² x s²)"),
    ...
    kilogram_per_cubic_decimetre_bar: makeEUInformation("H55", "(kg/dm³)/bar", "kilogram per cubic decimetre bar (10⁻² m⁻² x s²)"),
    ...
    kilogram_per_cubic_metre_kelvin: makeEUInformation("G40", "kg/(m³·K)", "kilogram per cubic metre kelvin (kg x m⁻³ x K⁻¹)"),
    ...
    kilogram_per_day_kelvin: makeEUInformation("F39", "kg/(d·K)", "kilogram per day kelvin (1,157 41 × 10⁻⁵ kg x s⁻¹ x K⁻¹)"),
    ...
    kilogram_per_hour_kelvin: makeEUInformation("F40", "kg/(h·K)", "kilogram per hour kelvin (2,777 78 × 10⁻⁴ kg x s⁻¹ x K⁻¹)"),
    ...
    kilogram_per_square_metre_second: makeEUInformation("H56", "kg/(m²·s)", "kilogram per square metre second (kg m⁻² x s⁻¹)"),
    ...
    "kilogram-force_per_square_metre": makeEUInformation("B40", "kgf/m²", "kilogram-force per square metre (9,806 65 Pa)"),
    ...
    kilometre_per_second: makeEUInformation(
        "M62",
        "km/s",
    ...
    kilomole_per_cubic_metre_bar: makeEUInformation("K60", "(kmol/m³)/bar", "kilomole per cubic metre bar (10⁻² (mol/m³)/Pa)"),
    kilomole_per_cubic_metre_kelvin: makeEUInformation("K59", "(kmol/m³)/K", "kilomole per cubic metre kelvin (10³ (mol/m³)/K)"),
    ...
    "kilovolt-ampere": makeEUInformation("KVA", "kV·A", "kilovolt - ampere (10³ V x A)"),
    "kilovolt_ampere(reactive)": makeEUInformation(
        "K5",
        "kvar",
    ...
    "liquid_pint(US)": makeEUInformation("PTL", "liq pt (US)", "liquid pint (US) (4, 731 765 x 10⁻⁴ m³)"),
    "liquid_quart(US)": makeEUInformation("QTL", "liq qt (US)", "liquid quart (US) (9,463 529 x 10⁻⁴ m³)"),
    ...
    litre_per_minute_kelvin: makeEUInformation("G67", "l/(min·K)", "litre per minute kelvin (1,666 67 × 10⁻⁵ m³ x s⁻¹ x K⁻¹)"),
    ...
    lumen_per_square_foot: makeEUInformation(
        "P25",
        "lm/ft²",
    ...
    "megavolt-ampere": makeEUInformation("MVA", "MV·A", "megavolt - ampere (10⁶ V x A)"),
    ...
    "megawatt_hour(1000_kW.h)": makeEUInformation(
        "MWH",
        "MW·h",
    ...
    microgram_per_cubic_metre_bar: makeEUInformation("J35", "(µg/m³)/bar", "microgram per cubic metre bar (10⁻¹⁴ (kg/m³)/Pa)"),
    microgram_per_cubic_metre_kelvin: makeEUInformation("J34", "(µg/m³)/K", "microgram per cubic metre kelvin (10⁻⁹ (kg/m³)/K)"),
    ...
    "micrometre(micron)": makeEUInformation("4H", "µm", "micrometre (micron) (10⁻⁶ m)"),
    ...
    "mile(based_on_U.S._survey_foot)": makeEUInformation(
        "M52",
        "mi (US survey)",
        "mile (based on U.S. survey foot) - Unit commonly used in the United States for ordnance survey. (1,609347 x 10³ m)"
    ),
    "mile(statute_mile)": makeEUInformation("SMI", "mile", "mile (statute mile) (1 609,344 m)"),
    "mile(statute_mile)_per_second_squared": makeEUInformation(
        "M42",
        "mi/s²",
    ...
    "mile_per_hour(statute_mile)": makeEUInformation("HM", "mile/h", "mile per hour (statute mile) (0,447 04 m/s)"),
    mile_per_minute: makeEUInformation(
        "M57",
        "mi/min",
        "mile per minute - Unit of velocity from the Imperial system of units. (26,822 4 m/s)"
    ),
    mile_per_second: makeEUInformation(
        "M58",
        "mi/s",
    ...
    millibar_cubic_metre_per_second: makeEUInformation("F96", "mbar·m³/s", "millibar cubic metre per second (10² kg x m² x s⁻³)"),
    ...
    milligram_per_cubic_metre_bar: makeEUInformation("L18", "(mg/m³)/bar", "milligram per cubic metre bar (10⁻¹¹ (kg/m³)/Pa)"),
    milligram_per_cubic_metre_kelvin: makeEUInformation("L17", "(mg/m³)/K", "milligram per cubic metre kelvin (10⁻⁶ (kg/m³)/K)"),
    ...
    milligram_per_day_kelvin: makeEUInformation("F43", "mg/(d·K)", "milligram per day kelvin (1,157 41 × 10⁻¹¹ kg x s⁻¹ x K⁻¹)"),
    ...
    milligram_per_hour_kelvin: makeEUInformation("F44", "mg/(h·K)", "milligram per hour kelvin (2,777 78 × 10⁻¹⁰ kg x s⁻¹ x K⁻¹)"),
    ...
    millilitre_per_day_bar: makeEUInformation("G90", "ml/(d·bar)", "millilitre per day bar (1,157 41 x 10⁻¹⁶ x kg⁻¹ x m⁴ x s)"),
    millilitre_per_day_kelvin: makeEUInformation("G73", "ml/(d·K)", "millilitre per day kelvin (1,157 41 × 10⁻¹¹ m³ x s⁻¹ x K⁻¹)"),
    millilitre_per_hour: makeEUInformation("G55", "ml/h", "millilitre per hour (2,777 78 × 10⁻¹⁰ m³ x s⁻¹)"),
    millilitre_per_hour_bar: makeEUInformation("G91", "ml/(h·bar)", "millilitre per hour bar (2,777 78 x 10⁻¹⁵ x kg⁻¹ x m⁴ x s)"),
    ...
    millilitre_per_second_kelvin: makeEUInformation("G76", "ml/(s·K)", "millilitre per second kelvin (10⁻⁶ m³ x s⁻¹ x K⁻¹)"),
    ...
    millimetre_per_degree_Celcius_metre: makeEUInformation("E97", "mm/(°C·m)", "millimetre per degree Celcius metre (10⁻³ K⁻¹)"),
    ...
    "millivolt-ampere": makeEUInformation("M35", "mV·A", "millivolt - ampere (10⁻³ V x A)"),
    ...
    millivolt_per_minute: makeEUInformation("H62", "mV/min", "millivolt per minute (1,666 666 667 × 10⁻⁵ m² x kg x s⁻⁴ x A⁻¹)"),
    ...
    "minute[unit_of_angle]": makeEUInformation("D61", "", "minute [unit of angle] (2,908 882 × 10⁻⁴ rad)"),
    "minute[unit_of_time]": makeEUInformation("MIN", "min", "minute [unit of time] (60 s)"),
    ...
    "ohm_circular-mil_per_foot": makeEUInformation(
        "P23",
        "Ω·cmil/ft",
    ...
    "ohm_per_mile(statute_mile)": makeEUInformation("F55", "Ω/mi", "ohm per mile (statute mile) (6,213 71 × 10⁻⁴  Ω/m)"),
    ...
    "ounce(UK_fluid)_per_day": makeEUInformation("J95", "fl oz (UK)/d", "ounce (UK fluid) per day (3,288 549 x 10⁻¹⁰ m³/s)"),
    "ounce(UK_fluid)_per_hour": makeEUInformation("J96", "fl oz (UK)/h", "ounce (UK fluid) per hour (7,892 517 x 10⁻⁹ m³/s)"),
    "ounce(UK_fluid)_per_minute": makeEUInformation("J97", "fl oz (UK)/min", "ounce (UK fluid) per minute (4,735 51 x 10⁻⁷ m³/s)"),
    "ounce(UK_fluid)_per_second": makeEUInformation("J98", "fl oz (UK)/s", "ounce (UK fluid) per second (2,841 306 x 10⁻⁵ m³/s)"),
    "ounce(US_fluid)_per_day": makeEUInformation("J99", "fl oz (US)/d", "ounce (US fluid) per day (3,422 862 x 10⁻¹⁰ m³/s)"),
    "ounce(US_fluid)_per_hour": makeEUInformation("K10", "fl oz (US)/h", "ounce (US fluid) per hour (8,214 869 x 10⁻⁹ m³/s)"),
    "ounce(US_fluid)_per_minute": makeEUInformation("K11", "fl oz (US)/min", "ounce (US fluid) per minute (4,928 922 x 10⁻⁷ m³/s)"),
    "ounce(US_fluid)_per_second": makeEUInformation("K12", "fl oz (US)/s", "ounce (US fluid) per second (2,957 353 x 10⁻⁵ m³/s)"),
    "ounce(avoirdupois)": makeEUInformation("ONZ", "oz", "ounce (avoirdupois) (2,834 952 x 10⁻² kg)"),
    "ounce(avoirdupois)_per_cubic_inch": makeEUInformation(
        "L39",
        "oz/in³",
        "ounce (avoirdupois) per cubic inch (1,729 994 x 10³ kg/m³)"
    ),
    "ounce(avoirdupois)_per_cubic_yard": makeEUInformation(
        "G32",
        "oz/yd³",
        "ounce (avoirdupois) per cubic yard (3,707 98 × 10⁻² kg x m⁻³)"
    ),
    "ounce(avoirdupois)_per_day": makeEUInformation("L33", "oz/d", "ounce (avoirdupois) per day (3,281 194 x 10⁻⁷kg/s)"),
    "ounce(avoirdupois)_per_gallon_(UK)": makeEUInformation(
        "L37",
        "oz/gal (UK)",
        "ounce (avoirdupois) per gallon (UK) (6,236 023 kg/m³)"
    ),
    "ounce(avoirdupois)_per_gallon_(US)": makeEUInformation(
        "L38",
        "oz/gal (US)",
        "ounce (avoirdupois) per gallon (US) (7,489 152 kg/m³)"
    ),
    "ounce(avoirdupois)_per_hour": makeEUInformation("L34", "oz/h", "ounce (avoirdupois) per hour (7,874 867 x 10⁻⁶ kg/s)"),
    "ounce(avoirdupois)_per_minute": makeEUInformation("L35", "oz/min", "ounce (avoirdupois) per minute (4,724 92 x 10⁻⁴ kg/s)"),
    "ounce(avoirdupois)_per_second": makeEUInformation("L36", "oz/s", "ounce (avoirdupois) per second (2,834 952 x 10⁻² kg/s)"),
    "ounce(avoirdupois)_per_square_inch": makeEUInformation(
        "N22",
        "oz/in²",
    ...
    "ounce(avoirdupois)-force": makeEUInformation("L40", "ozf", "ounce (avoirdupois)-force (0,278 013 9 N)"),
    "ounce(avoirdupois)-force_inch": makeEUInformation("L41", "ozf·in", "ounce (avoirdupois)-force inch (7,061 552 x 10⁻³ N x m)"),
    ...
    "pH(potential_of_Hydrogen)": makeEUInformation(
        "Q30",
        "pH",
    ...
    "peck(UK)": makeEUInformation("L43", "pk (UK)", "peck (UK) (9,092 181 x 10⁻³ m³)"),
    "peck(UK)_per_day": makeEUInformation("L44", "pk (UK)/d", "peck (UK) per day (1,052 336 x 10⁻⁷ m³/s)"),
    "peck(UK)_per_hour": makeEUInformation("L45", "pk (UK)/h", "peck (UK) per hour (2,525 606 x 10⁻⁶ m³/s)"),
    "peck(UK)_per_minute": makeEUInformation("L46", "pk (UK)/min", "peck (UK) per minute (1,515 363 5 x 10⁻⁴ m³/s)"),
    "peck(UK)_per_second": makeEUInformation("L47", "pk (UK)/s", "peck (UK) per second (9,092 181 x 10⁻³ m³/s)"),
    "peck(US_dry)_per_day": makeEUInformation("L48", "pk (US dry)/d", "peck (US dry) per day (1,019 649 x 10⁻⁷ m³/s)"),
    "peck(US_dry)_per_hour": makeEUInformation("L49", "pk (US dry)/h", "peck (US dry) per hour (2,447 158 x 10⁻⁶ m³/s)"),
    "peck(US_dry)_per_minute": makeEUInformation("L50", "pk (US dry)/min", "peck (US dry) per minute (1,468 295 x 10⁻⁴ m³/s)"),
    "peck(US_dry)_per_second": makeEUInformation("L51", "pk (US dry)/s", "peck (US dry) per second (8,809 768 x 10⁻³ m³/s)"),
    ...
    picosiemens: makeEUInformation("N92", "pS", "picosiemens - 0,000 000 000 001-fold of the derived SI unit siemens. (10⁻¹² S)"),
    ...
    "pint(UK)": makeEUInformation("PTI", "pt (UK)", "pint (UK) (5, 682 61 x 10⁻⁴ m³)"),
    "pint(UK)_per_day": makeEUInformation("L53", "pt (UK)/d", "pint (UK) per day (6,577 098 x 10⁻⁹ m³/s)"),
    "pint(UK)_per_hour": makeEUInformation("L54", "pt (UK)/h", "pint (UK) per hour (1,578 504 x 10⁻⁷ m³/s)"),
    "pint(UK)_per_minute": makeEUInformation("L55", "pt (UK)/min", "pint (UK) per minute (9,471 022 x 10⁻⁶ m³/s)"),
    "pint(UK)_per_second": makeEUInformation("L56", "pt (UK)/s", "pint (UK) per second (5,682 613 x 10⁻⁴ m³/s)"),
    "pint(US_dry)": makeEUInformation("L61", "pt (US dry)", "pint (US dry) - Use dry pint (common code PTD) (5,506 105 x 10⁻⁴ m³)"),
    "pint(US_liquid)_per_day": makeEUInformation("L57", "pt (US liq.)/d", "pint (US liquid) per day (5,476 580 x 10⁻⁹ m³/s)"),
    "pint(US_liquid)_per_hour": makeEUInformation("L58", "pt (US liq.)/h", "pint (US liquid) per hour (1,314 379 x 10⁻⁷ m³/s)"),
    "pint(US_liquid)_per_minute": makeEUInformation(
        "L59",
        "pt (US liq.)/min",
        "pint (US liquid) per minute (7,886 275 x 10⁻⁶ m³/s)"
    ),
    "pint(US_liquid)_per_second": makeEUInformation("L60", "pt (US liq.)/s", "pint (US liquid) per second (4,731 765 x 10⁻⁴ m³/s)"),
    "pint(US)": makeEUInformation("PT", "pt (US)", "pint (US) - Use liquid pint (common code PTL) (4, 731 76 x 10⁻⁴ m³)"),
    ...
    "pound(avoirdupois)_per_cubic_foot_degree_Fahrenheit": makeEUInformation(
        "K69",
        "(lb/ft³)/°F",
        "pound (avoirdupois) per cubic foot degree Fahrenheit (28,833 23 (kg/m³)/K)"
    ),
    "pound(avoirdupois)_per_cubic_foot_psi": makeEUInformation(
        "K70",
        "(lb/ft³)/psi",
        "pound (avoirdupois) per cubic foot psi (2,323 282 x 10⁻³)"
    ),
    "pound(avoirdupois)_per_cubic_inch_degree_Fahrenheit": makeEUInformation(
        "K75",
        "(lb/in³)/°F",
        "pound (avoirdupois) per cubic inch degree Fahrenheit (4,982 384 x 10⁴ (kg/m³)/K)"
    ),
    "pound(avoirdupois)_per_cubic_inch_psi": makeEUInformation(
        "K76",
        "(lb/in³)/psi",
        "pound (avoirdupois) per cubic inch psi (4,014 632 (kg/m³)/Pa)"
    ),
    "pound(avoirdupois)_per_day": makeEUInformation("K66", "lb/d", "pound (avoirdupois) per day (5,249 912 x 10⁻⁶ kg/s)"),
    "pound(avoirdupois)_per_degree_Fahrenheit": makeEUInformation(
        "K64",
        "lb/°F",
        "pound (avoirdupois) per degree Fahrenheit (0,816 466 3 kg/K)"
    ),
    "pound(avoirdupois)_per_gallon_(UK)": makeEUInformation(
        "K71",
        "lb/gal (UK)",
        "pound (avoirdupois) per gallon (UK) (99,776 37 kg/m³)"
    ),
    "pound(avoirdupois)_per_hour_degree_Fahrenheit": makeEUInformation(
        "K73",
        "(lb/h)/°F",
    ...
    "pound(avoirdupois)_per_minute": makeEUInformation("K78", "lb/min", "pound (avoirdupois) per minute (7,559 873 x 10⁻³ kg/s)"),
    "pound(avoirdupois)_per_minute_degree_Fahrenheit": makeEUInformation(
        "K79",
        "lb/(min·°F)",
    ...
    "pound(avoirdupois)_per_psi": makeEUInformation("K77", "lb/psi", "pound (avoirdupois) per psi (6,578 802 x 10⁻⁵ kg/Pa)"),
    "pound(avoirdupois)_per_second": makeEUInformation("K81", "lb/s", "pound (avoirdupois) per second (0,453 592 4 kg/s)"),
    "pound(avoirdupois)_per_second_degree_Fahrenheit": makeEUInformation(
        "K82",
        "(lb/s)/°F",
        "pound (avoirdupois) per second degree Fahrenheit (0,816 466 3 (kg/s)/K)"
    ),
    "pound(avoirdupois)_per_second_psi": makeEUInformation(
        "K83",
        "(lb/s)/psi",
        "pound (avoirdupois) per second psi (6,578 802 x 10⁻⁵ (kg/s)/Pa)"
    ),
    "pound(avoirdupois)_square_foot": makeEUInformation(
        "K65",
        "lb·ft²",
    ...
    "pound_per_gallon(US)": makeEUInformation("GE", "lb/gal (US)", "pound per gallon (US) (1,198 264 x 10² kg/m³)"),
    ...
    pound_per_square_inch_absolute: makeEUInformation("80", "lb/in²", "pound per square inch absolute (7,030 696 x 10² kg/m²)"),
    ...
    pound_per_yard: makeEUInformation(
        "M84",
        "lb/yd",
    ...
    "pound-force_per_square_inch": makeEUInformation("PS", "lbf/in²", "pound-force per square inch (6,894 757 x 10³ Pa)"),
    ...
    poundal_per_square_foot: makeEUInformation(
        "N21",
        "pdl/ft²",
    ...
    poundal_second_per_square_foot: makeEUInformation(
        "N34",
        "(pdl/ft²)·s",
    ...
    psi_cubic_metre_per_second: makeEUInformation("K89", "psi·m³/s", "psi cubic metre per second (6,894 757  x 10³ Pa x m³/s)"),
    psi_cubic_yard_per_second: makeEUInformation("K90", "psi·yd³/s", "psi cubic yard per second (5,271 420 x 10³ Pa x m³/s)"),
    ...
    "quad(1015_BtuIT)": makeEUInformation(
        "N70",
        "quad",
        "quad (1015 BtuIT) - Unit of heat energy according to the imperial system of units. (1,055 056 × 10¹⁸ J)"
    ),
    "quart(UK_liquid)_per_day": makeEUInformation("K94", "qt (UK liq.)/d", "quart (UK liquid) per day (1,315 420 x 10⁻⁸ m³/s)"),
    "quart(UK_liquid)_per_hour": makeEUInformation("K95", "qt (UK liq.)/h", "quart (UK liquid) per hour (3,157 008 x 10⁻⁷ m³/s)"),
    "quart(UK_liquid)_per_minute": makeEUInformation(
        "K96",
        "qt (UK liq.)/min",
        "quart (UK liquid) per minute (1,894 205 x 10⁻⁵ m³/s)"
    ),
    "quart(UK_liquid)_per_second": makeEUInformation(
        "K97",
        "qt (UK liq.)/s",
        "quart (UK liquid) per second (1,136 523 x 10⁻³ m³/s)"
    ),
    "quart(UK)": makeEUInformation("QTI", "qt (UK)", "quart (UK) (1,136 522 5 x 10⁻³ m³)"),
    "quart(US_dry)": makeEUInformation(
        "L62",
        "qt (US dry)",
        "quart (US dry) - Use dry quart (US) (common code QTD) (1,101 221 x 10⁻³ m³)"
    ),
    "quart(US_liquid)_per_day": makeEUInformation("K98", "qt (US liq.)/d", "quart (US liquid) per day (1,095 316 x 10⁻⁸ m³/s)"),
    "quart(US_liquid)_per_hour": makeEUInformation("K99", "qt (US liq.)/h", "quart (US liquid) per hour (2,628 758 x 10⁻⁷ m³/s)"),
    "quart(US_liquid)_per_minute": makeEUInformation(
        "L10",
        "qt (US liq.)/min",
        "quart (US liquid) per minute (1,577 255 x 10⁻⁵ m³/s)"
    ),
    "quart(US_liquid)_per_second": makeEUInformation(
        "L11",
        "qt (US liq.)/s",
        "quart (US liquid) per second (9,463 529 x 10⁻⁴ m³/s)"
    ),
    "quart(US)": makeEUInformation("QT", "qt (US)", "quart (US) - Use liquid quart (common code QTL) (0,946 352 9 x 10⁻³ m³)"),
    ...
    radian_per_second_squared: makeEUInformation("2B", "rad/s²", "radian per second squared - Refer ISO/TC12 SI Guide (rad/s²)"),
    radian_square_metre_per_kilogram: makeEUInformation("C83", "rad·m²/kg", "radian square metre per kilogram (rad x m²/kg)"),
    ...
    "reciprocal_kilovolt-ampere_reciprocal_hour": makeEUInformation(
        "M21",
        "1/kVAh",
    ...
    reciprocal_square_metre: makeEUInformation("C93", "m⁻²", "reciprocal square metre - Synonym: reciprocal metre squared (m⁻²)"),
    "reciprocal_volt-ampere_reciprocal_second": makeEUInformation(
        "M30",
        "1/(V·A·s)",
    ...
    revolution_per_minute: makeEUInformation(
        "M46",
        "r/min",
        "revolution per minute - Unit of the angular velocity. (0,104 719 8 rad/s)"
    ),
    revolutions_per_minute: makeEUInformation("RPM", "r/min", "revolutions per minute - Refer ISO/TC12 SI Guide (1,67 x 10⁻²/s)"),
    revolutions_per_second: makeEUInformation("RPS", "r/s", "revolutions per second - Refer ISO/TC12 SI Guide (1/s)"),
    "rod[unit_of_distance]": makeEUInformation(
        "F49",
        "rd (US)",
    ...
    "second[unit_of_angle]": makeEUInformation("D62", '"', "second [unit of angle] (4,848 137 × 10⁻⁶ rad)"),
    "second[unit_of_time]": makeEUInformation("SEC", "s", "second [unit of time] (s)"),
    ...
    square_foot_per_hour: makeEUInformation(
        "M79",
        "ft²/h",
    ...
    "square_metre_hour_degree_Celsius_per_kilocalorie(international_table)": makeEUInformation(
        "L14",
        "m²·h·°C/kcal",
    ...
    square_metre_per_steradian_joule: makeEUInformation("D25", "m²/(sr·J)", "square metre per steradian joule (m²/(sr x J))"),
    square_metre_per_volt_second: makeEUInformation("D26", "m²/(V·s)", "square metre per volt second (m²/(V x s))"),
    "square_micrometre(square_micron)": makeEUInformation("H30", "µm²", "square micrometre (square micron) (10⁻¹² m²)"),
    "square_mile(based_on_U.S._survey_foot)": makeEUInformation(
        "M48",
        "mi² (US survey)",
    ...
    "square_mile(statute_mile)": makeEUInformation("MIK", "mi²", "square mile (statute mile) (2,589 988 km²)"),
    ...
    standard_acceleration_of_free_fall: makeEUInformation("K40", "gn", "standard acceleration of free fall (9,806 65 m/s²)"),
    ...
    "stone(UK)": makeEUInformation("STI", "st", "stone (UK) (6,350 293 kg)"),
    "tablespoon(US)": makeEUInformation("G24", "tablespoon (US)", "tablespoon (US) (1,478 676 x 10⁻⁵ m³)"),
    "teaspoon(US)": makeEUInformation("G25", "teaspoon (US)", "teaspoon (US) (4,928 922 x 10⁻⁶ m³)"),
    ...
    "therm(EC)": makeEUInformation(
        "N71",
        "thm (EC)",
        "therm (EC) - Unit of heat energy in commercial use, within the EU defined: 1 thm (EC) = 100 000 BtuIT. (1,055 06 × 10⁸ J)"
    ),
    "therm(U.S.)": makeEUInformation(
        "N72",
        "thm (US)",
        "therm (U.S.) - Unit of heat energy in commercial use. (1,054 804 × 10⁸ J)"
    ),
    "ton(UK_long)_per_cubic_yard": makeEUInformation(
        "L92",
        "ton.l/yd³ (UK)",
        "ton (UK long) per cubic yard (1,328 939 x 10³ kg/m³)"
    ),
    "ton(UK_shipping)": makeEUInformation("L84", "British shipping ton", "ton (UK shipping) (1,189 3 m³)"),
    "ton(UK)_or_long_ton_(US)": makeEUInformation(
        "LTN",
        "ton (UK)",
        "ton (UK) or long ton (US) - Synonym: gross ton (2240 lb) (1,016 047 x 10³ kg)"
    ),
    "ton(US_shipping)": makeEUInformation("L86", "(US) shipping ton", "ton (US shipping) (1,132 6 m³)"),
    "ton(US_short)_per_cubic_yard": makeEUInformation(
        "L93",
        "ton.s/yd³ (US)",
        "ton (US short) per cubic yard (1,186 553 x 10³ kg/m³)"
    ),
    "ton(US)_or_short_ton_(UK/US)": makeEUInformation(
        "STN",
        "ton (US)",
        "ton (US) or short ton (UK/US) - Synonym: net ton (2000 lb) (0,907184 7 x 10³ kg)"
    ),
    "ton(US)_per_hour": makeEUInformation("4W", "ton (US) /h", "ton (US) per hour (2,519 958 x 10⁻¹ kg/s)"),
    ...
    ton_short_per_hour_psi: makeEUInformation("L90", "(ton (US)/h)/psi", "ton short per hour psi (3,654 889 x 10⁻⁵ (kg/s)/Pa)"),
    ton_short_per_psi: makeEUInformation("L91", "ton (US)/psi", "ton short per psi (0,131 576)"),
    "ton(assay)": makeEUInformation(
        "M85",
        "",
    ...
    "ton(register)": makeEUInformation("M70", "RT", "ton, register - Traditional unit of the cargo capacity. (2,831 685 m³)"),
    "ton-force(US_short)": makeEUInformation("L94", "ton.sh-force", "ton-force (US short) (8,896 443 x 10³ N)"),
    "tonne(metric_ton)": makeEUInformation("TNE", "t", "tonne (metric ton) - Synonym: metric ton (10³ kg)"),
    ...
    "volt-ampere": makeEUInformation("D46", "V·A", "volt - ampere (W)"),
    ...
    volt_per_litre_minute: makeEUInformation("F87", "V/(l·min)", "volt per litre minute (1,666 67 × 10¹ kg x m⁻¹ x s⁻⁴ x A⁻¹)"),
    ...
    watt_per_square_centimetre: makeEUInformation(
        "N48",
        "W/cm²",
    ...
    watt_per_square_inch: makeEUInformation(
        "N49",
        "W/in²",
    ...
    "30-day_month": makeEUInformation(
        "M36",
        "mo (30 days)",
        "30-day month - A unit of count defining the number of months expressed in multiples of 30 days, one day equals 24 hours. (2,592 000 x 10⁶ s)"
    ),
    ...
    Beaufort: makeEUInformation(
        "M19",
        "Bft",
        "Beaufort - An empirical measure for describing wind speed based mainly on observed sea conditions. The Beaufort scale indicates the wind speed by numbers that typically range from 0 for calm, to 12 for hurricane."
    ),
    Decibel_watt: makeEUInformation(
        "DBW",
        "dBW",
        "Decibel watt - The decibel watt or dBW is a unit for the measurement of the strength of a signal expressed in decibels relative to one watt. (10^[Power in dBW/10] W)"
    ),
    "Decibel-milliwatts": makeEUInformation(
        "DBM",
        "dBm",
        "Decibel-milliwatts - dBm (sometimes dBmW or decibel-milliwatts) is unit of level used to indicate that a power ratio is expressed in decibels (dB) with reference to one milliwatt (mW). (10^[(Power in dBm-30)/10] W)"
    ),
    Formazin_nephelometric_unit: makeEUInformation(
        "FNU",
        "FNU",
        "Formazin nephelometric unit - Formazin nephelometric unit (FNU) is used for water turbidity level evaluation"
    ),
    "MMSCF/day": makeEUInformation(
        "5E",
        "",
        "MMSCF/day - A unit of volume equal to one million (1000000) cubic feet of gas per day."
    ),
    Nephelometric_turbidity_unit: makeEUInformation(
        "NTU",
        "NTU",
        "Nephelometric turbidity unit - Nephelometric turbidity unit (NTU) is used for water turbidity level evaluation"
    ),
    ODS_Grams: makeEUInformation(
        "ODG",
        "",
    ...
    ODS_Kilograms: makeEUInformation(
        "ODK",
        "",
    ...
    ODS_Milligrams: makeEUInformation(
        "ODM",
        "",
    ...
    active_unit: makeEUInformation(
        "E25",
        "",
        "active unit - A unit of count defining the number of active units within a substance."
    ),
    activity: makeEUInformation(
        "ACT",
        "",
        "activity - A unit of count defining the number of activities (activity: a unit of work or action)."
    ),
    "actual/360": makeEUInformation(
        "M37",
        "y (360 days)",
        "actual/360 - A unit of count defining the number of years expressed in multiples of 360 days, one day equals 24 hours. (3,110 400 0 x 10⁷ s)"
    ),
    additional_minute: makeEUInformation(
        "AH",
        "",
        "additional minute - A unit of time defining the number of minutes in addition to the referenced minutes."
    ),
    air_dry_metric_ton: makeEUInformation(
        "MD",
        "",
    ...
    baud: makeEUInformation("J38", "Bd", "baud - A unit of signal transmission speed equal to one signalling event per second."),
    beats_per_minute: makeEUInformation("BPM", "BPM", "beats per minute - The number of beats per minute. (1.667 x 10-2 /s)"),
    big_point: makeEUInformation(
        "H82",
        "bp",
        "big point - A unit of length defining the number of big points (big point: Adobe software(US) defines the big point to be exactly 1/72 inch (0.013 888 9 inch or 0.352 777 8 millimeters)) (0,352 777 8 × 10⁻³ m)"
    ),
    "billion(EUR)": makeEUInformation("BIL", "", "billion (EUR) - Synonym: trillion (US) (10¹²)"),
    bit: makeEUInformation("A99", "bit", "bit - A unit of information equal to one binary digit."),
    bit_per_cubic_metre: makeEUInformation(
        "F01",
        "bit/m³",
        "bit per cubic metre - A unit of information equal to 1 bit (binary digit) per cubic metre."
    ),
    bit_per_metre: makeEUInformation(
        "E88",
        "bit/m",
        "bit per metre - A unit of information equal to 1 bit (binary digit) per metre."
    ),
    bit_per_second: makeEUInformation(
        "B10",
        "bit/s",
        "bit per second - A unit of information equal to one binary digit per second."
    ),
    bit_per_square_metre: makeEUInformation(
        "E89",
        "bit/m²",
        "bit per square metre - A unit of information equal to 1 bit (binary digit) per square metre."
    ),
    blank: makeEUInformation("H21", "", "blank - A unit of count defining the number of blanks."),
    board_foot: makeEUInformation(
        "BFT",
        "fbm",
        "board foot - A unit of volume defining the number of cords (cord: a stack of firewood of 128 cubic feet)."
    ),
    book: makeEUInformation(
        "D63",
        "",
    ...
    content_gram: makeEUInformation(
        "CTG",
        "",
        "content gram - A unit of mass defining the number of grams of a named item in a product."
    ),
    "content_ton(metric)": makeEUInformation(
        "CTN",
        "",
        "content ton (metric) - A unit of mass defining the number of metric tons of a named item in a product."
    ),
    cord: makeEUInformation(
        "WCD",
        "",
        "cord - A unit of volume used for measuring lumber. One board foot equals 1/12 of a cubic foot. (3,63 m³)"
    ),
    credit: makeEUInformation(
        "B17",
        "",
        "credit - A unit of count defining the number of entries made to the credit side of an account."
    ),
    cubic_foot_per_second: makeEUInformation(
        "E17",
        "ft³/s",
        "cubic foot per second - A unit of volume equal to one cubic foot passing a given point in a period of one second. (2,831 685 x 10⁻² m³/s)"
    ),
    cycle: makeEUInformation(
        "B7",
        "",
        "cycle - A unit of count defining the number of cycles (cycle: a recurrent period of definite duration)."
    ),
    deadweight_tonnage: makeEUInformation(
        "A43",
        "dwt",
        "deadweight tonnage - A unit of mass defining the difference between the weight of a ship when completely empty and its weight when completely loaded, expressed as the number of tons."
    ),
    decade: makeEUInformation(
        "DEC",
        "",
        "decade - A unit of count defining the number of decades (decade: quantity equal to 10 or time equal to 10 years)."
    ),
    decitex: makeEUInformation(
        "A47",
        "dtex (g/10km)",
        "decitex - A unit of yarn density. One decitex equals a mass of 1 gram per 10 kilometres of length."
    ),
    degree_API: makeEUInformation(
        "J13",
        "°API",
        "degree API - A unit of relative density as a measure of how heavy or light a petroleum liquid is compared to water (API: American Petroleum Institute)."
    ),
    degree_Balling: makeEUInformation(
        "J17",
        "°Balling",
        "degree Balling - A unit of density as a measure of sugar content, especially of beer wort. Named after Karl Balling."
    ),
    "degree_Baume(US_heavy)": makeEUInformation(
        "J15",
        "°Bé (US heavy)",
        "degree Baume (US heavy) - A unit of relative density for liquids heavier than water."
    ),
    "degree_Baume(US_light)": makeEUInformation(
        "J16",
        "°Bé (US light)",
        "degree Baume (US light) - A unit of relative density for liquids lighter than water."
    ),
    "degree_Baume(origin_scale)": makeEUInformation(
        "J14",
        "°Bé",
        "degree Baume (origin scale) - A traditional unit of relative density for liquids. Named after Antoine Baumé."
    ),
    degree_Brix: makeEUInformation(
        "J18",
        "°Bx",
        "degree Brix - A unit of proportion used in measuring the dissolved sugar-to-water mass ratio of a liquid. Named after Adolf Brix."
    ),
    degree_Oechsle: makeEUInformation(
        "J27",
        "°Oechsle",
        "degree Oechsle - A unit of density as a measure of sugar content of must, the unfermented liqueur from which wine is made. Named after Ferdinand Oechsle."
    ),
    degree_Plato: makeEUInformation(
        "PLA",
        "°P",
        "degree Plato - A unit of proportion defining the sugar content of a product, especially in relation to beer."
    ),
    degree_Twaddell: makeEUInformation(
        "J31",
        "°Tw",
        "degree Twaddell - A unit of density for liquids that are heavier than water.  1 degree Twaddle represents a difference in specific gravity of 0.005."
    ),
    degree_day: makeEUInformation(
        "E10",
        "deg da",
        "degree day - A unit of measure used in meteorology and engineering to measure the demand for heating or cooling over a given period of days."
    ),
    digit: makeEUInformation("B19", "", "digit - A unit of information defining the quantity of numerals used to form a number."),
    dioptre: makeEUInformation(
        "Q25",
        "dpt",
        "dioptre - Unit used at the statement of relative refractive indexes of optical systems as complement of the focal length with correspondence to: 1 dpt = 1/m. (m⁻¹)"
    ),
    displacement_tonnage: makeEUInformation(
        "DPT",
        "",
        "displacement tonnage - A unit of mass defining the volume of sea water a ship displaces, expressed as the number of tons."
    ),
    dose: makeEUInformation(
        "E27",
        "",
        "dose - A unit of count defining the number of doses (dose: a definite quantity of a medicine or drug)."
    ),
    dots_per_inch: makeEUInformation(
        "E39",
        "dpi",
        "dots per inch - A unit of information defining the number of dots per linear inch as a measure of the resolution or sharpness of a graphic image."
    ),
    dozen: makeEUInformation("DZN", "DOZ", "dozen - A unit of count defining the number of units in multiples of 12. (12)"),
    dozen_pack: makeEUInformation(
        "DZP",
        "",
        "dozen pack - A unit of count defining the number of packs in multiples of 12 (pack: standard packaging unit)."
    ),
    dozen_pair: makeEUInformation(
        "DPR",
        "",
        "dozen pair - A unit of count defining the number of pairs in multiples of 12 (pair: item described by twos)."
    ),
    dozen_piece: makeEUInformation(
        "DPC",
        "",
        "dozen piece - A unit of count defining the number of pieces in multiples of 12 (piece: a single item, article or exemplar)."
    ),
    dozen_roll: makeEUInformation(
        "DRL",
        "",
    ...
    electronic_mail_box: makeEUInformation(
        "EB",
        "",
        "electronic mail box - A unit of count defining the number of electronic mail boxes."
    ),
    equivalent_gallon: makeEUInformation(
        "EQ",
        "",
        "equivalent gallon - A unit of volume defining the number of gallons of product produced from concentrate."
    ),
    erlang: makeEUInformation(
        "Q11",
        "E",
        "erlang - Unit of the market value according to the feature of a single feature as a statistical measurement of the existing utilization. (1 E)"
    ),
    exabit_per_second: makeEUInformation(
        "E58",
        "Ebit/s",
        "exabit per second - A unit of information equal to 10¹⁸ bits (binary digits) per second."
    ),
    exbibit_per_cubic_metre: makeEUInformation(
        "E67",
        "Eibit/m³",
        "exbibit per cubic metre - A unit of information equal to 2⁶⁰ bits (binary digits) per cubic metre."
    ),
    exbibit_per_metre: makeEUInformation(
        "E65",
        "Eibit/m",
        "exbibit per metre - A unit of information equal to 2⁶⁰ bits (binary digits) per metre."
    ),
    exbibit_per_square_metre: makeEUInformation(
        "E66",
        "Eibit/m²",
        "exbibit per square metre - A unit of information equal to 2⁶⁰ bits (binary digits) per square metre."
    ),
    exbibyte: makeEUInformation("E59", "Eibyte", "exbibyte - A unit of information equal to 2⁶⁰ bytes."),
    failures_in_time: makeEUInformation(
        "FIT",
        "FIT",
        "failures in time - A unit of count defining the number of failures that can be expected over a specified time interval. Failure rates of semiconductor components are often specified as FIT (failures in time unit) where 1 FIT = 10⁻⁹ /h. (2,777 78 × 10⁻¹³ s⁻¹)"
    ),
    fibre_metre: makeEUInformation("FBM", "", "fibre metre - A unit of length defining the number of metres of individual fibre."),
    five_pack: makeEUInformation(
        "P5",
        "",
        "five pack - A unit of count defining the number of five-packs (five-pack: set of five items packaged together)."
    ),
    fixed_rate: makeEUInformation(
        "1I",
        "",
        "fixed rate - A unit of quantity expressed as a predetermined or set rate for usage of a facility or service."
    ),
    flake_ton: makeEUInformation(
        "FL",
        "",
        "flake ton - A unit of mass defining the number of tons of a flaked substance (flake: a small flattish fragment)."
    ),
    foot_per_thousand: makeEUInformation(
        "E33",
        "",
        "foot per thousand - A unit of count defining the number of feet per thousand units. (3,048 x 10⁻⁴ m)"
    ),
    forty_foot_container: makeEUInformation(
        "21",
        "",
        "forty foot container - A unit of count defining the number of shipping containers that measure 40 foot in length."
    ),
    freight_ton: makeEUInformation(
        "A75",
        "",
    ...
    "gallon(US)_per_day": makeEUInformation("GB", "gal (US)/d", "gallon (US) per day (4,381 264 x 10⁻⁸ m³/s)"),
    gibibit: makeEUInformation("B30", "Gibit", "gibibit - A unit of information equal to 2³⁰ bits (binary digits)."),
    gibibit_per_cubic_metre: makeEUInformation(
        "E71",
        "Gibit/m³",
        "gibibit per cubic metre - A unit of information equal to 2³⁰ bits (binary digits) per cubic metre."
    ),
    gibibit_per_metre: makeEUInformation(
        "E69",
        "Gibit/m",
        "gibibit per metre - A unit of information equal to 2³⁰ bits (binary digits) per metre."
    ),
    gibibit_per_square_metre: makeEUInformation(
        "E70",
        "Gibit/m²",
        "gibibit per square metre - A unit of information equal to 2³⁰ bits (binary digits) per square metre."
    ),
    gibibyte: makeEUInformation("E62", "Gibyte", "gibibyte - A unit of information equal to 2³⁰ bytes."),
    gigabit: makeEUInformation("B68", "Gbit", "gigabit - A unit of information equal to 10⁹ bits (binary digits)."),
    gigabit_per_second: makeEUInformation(
        "B80",
        "Gbit/s",
        "gigabit per second - A unit of information equal to 10⁹ bits (binary digits) per second."
    ),
    gigabyte: makeEUInformation("E34", "Gbyte", "gigabyte - A unit of information equal to 10⁹ bytes."),
    gigabyte_per_second: makeEUInformation(
        "E68",
        "Gbyte/s",
        "gigabyte per second - A unit of information equal to 10⁹ bytes per second."
    ),
    "gill(UK)": makeEUInformation("GII", "gi (UK)", "gill (UK) (1,420 653 x 10⁻⁴ m³)"),
    "gill(US)": makeEUInformation("GIA", "gi (US)", "gill (US) (1,182 941 x 10⁻⁴ m³)"),
    gram_of_fissile_isotope: makeEUInformation(
        "GFI",
        "gi F/S",
        "gram of fissile isotope - A unit of mass defining the number of grams of a fissile isotope (fissile isotope: an isotope whose nucleus is able to be split when irradiated with low energy neutrons)."
    ),
    "gram(dry_weight)": makeEUInformation(
        "GDW",
        "",
        "gram, dry weight - A unit of mass defining the number of grams of a product, disregarding the water content of the product."
    ),
    "gram(including_container)": makeEUInformation(
        "GIC",
        "",
        "gram, including container - A unit of mass defining the number of grams of a product, including its container."
    ),
    "gram(including_inner_packaging)": makeEUInformation(
        "GIP",
        "",
    ...
    hartley: makeEUInformation(
        "Q15",
        "Hart",
        "hartley - Logarithmic unit for information equal to the content of decision of a sentence of ten mutually exclusive events, expressed as a logarithm to base 10."
    ),
    hartley_per_second: makeEUInformation(
        "Q18",
        "Hart/s",
        "hartley per second - Time related logarithmic unit for information equal to the content of decision of a sentence of ten mutually exclusive events, expressed as a logarithm to base 10. (Hart/s)"
    ),
    head: makeEUInformation(
        "HEA",
        "",
        "head - A unit of count defining the number of heads (head: a person or animal considered as one of a number)."
    ),
    hectolitre_of_pure_alcohol: makeEUInformation(
        "HPA",
        "",
    ...
    hundred_pack: makeEUInformation(
        "CNP",
        "",
    ...
    hydraulic_horse_power: makeEUInformation(
        "5J",
        "",
    ...
    joule_per_tesla: makeEUInformation(
        "Q10",
        "J/T",
        "joule per tesla - Unit of the magnetic dipole moment of the molecule as derived SI unit joule divided by the derived SI unit tesla. (m² x A)"
    ),
    kibibit: makeEUInformation("C21", "Kibit", "kibibit - A unit of information equal to 2¹⁰ (1024) bits (binary digits)."),
    kibibit_per_cubic_metre: makeEUInformation(
        "E74",
        "Kibit/m³",
        "kibibit per cubic metre - A unit of information equal to 2¹⁰ bits (binary digits) per cubic metre."
    ),
    kibibit_per_metre: makeEUInformation(
        "E72",
        "Kibit/m",
        "kibibit per metre - A unit of information equal to 2¹⁰ bits (binary digits) per metre."
    ),
    kibibit_per_square_metre: makeEUInformation(
        "E73",
        "Kibit/m²",
        "kibibit per square metre - A unit of information equal to 2¹⁰ bits (binary digits) per square metre."
    ),
    kibibyte: makeEUInformation("E64", "Kibyte", "kibibyte - A unit of information equal to 2¹⁰ bytes."),
    kilobaud: makeEUInformation(
        "K50",
        "kBd",
        "kilobaud - A unit of signal transmission speed equal to 10³ (1000) signaling events per second. (10³ Bd)"
    ),
    kilobit: makeEUInformation("C37", "kbit", "kilobit - A unit of information equal to 10³ (1000) bits (binary digits)."),
    kilobit_per_second: makeEUInformation(
        "C74",
        "kbit/s",
        "kilobit per second - A unit of information equal to 10³ (1000) bits (binary digits) per second. (10³ bit/s)"
    ),
    kilobyte: makeEUInformation("2P", "kbyte", "kilobyte - A unit of information equal to 10³ (1000) bytes."),
    kilobyte_per_second: makeEUInformation(
        "P94",
        "kbyte/s",
        "kilobyte per second - 1000-fold of the unit byte divided by the SI base unit second. (10³ byte/s)"
    ),
    kilocharacter: makeEUInformation("KB", "", "kilocharacter - A unit of information equal to 10³ (1000) characters."),
    kilogram_drained_net_weight: makeEUInformation(
        "KDW",
        "kg/net eda",
        "kilogram drained net weight - A unit of mass defining the net number of kilograms of a product, disregarding the liquid content of the product."
    ),
    kilogram_named_substance: makeEUInformation(
        "KNS",
        "",
        "kilogram named substance - A unit of mass equal to one kilogram of a named substance."
    ),
    kilogram_of_choline_chloride: makeEUInformation(
        "KCC",
        "kg C₅ H₁₄ClNO",
        "kilogram of choline chloride - A unit of mass equal to one thousand grams of choline chloride."
    ),
    kilogram_of_hydrogen_peroxide: makeEUInformation(
        "KHY",
        "kg H₂O₂",
        "kilogram of hydrogen peroxide - A unit of mass equal to one thousand grams of hydrogen peroxide."
    ),
    "kilogram_of_imported_meat(less_offal)": makeEUInformation(
        "TMS",
        "",
    ...
    kilogram_of_methylamine: makeEUInformation(
        "KMA",
        "kg met.am.",
        "kilogram of methylamine - A unit of mass equal to one thousand grams of methylamine."
    ),
    kilogram_of_nitrogen: makeEUInformation(
        "KNI",
        "kg N",
        "kilogram of nitrogen - A unit of mass equal to one thousand grams of nitrogen."
    ),
    "kilogram_of_phosphorus_pentoxide(phosphoric_anhydride)": makeEUInformation(
        "KPP",
        "",
    ...
    kilogram_of_potassium_oxide: makeEUInformation(
        "KPO",
        "kg K₂O",
        "kilogram of potassium oxide - A unit of mass equal to one thousand grams of potassium oxide."
    ),
    "kilogram_of_sodium_hydroxide(caustic_soda)": makeEUInformation(
        "KSH",
        "kg NaOH",
        "kilogram of sodium hydroxide (caustic soda) - A unit of mass equal to one thousand grams of sodium hydroxide (caustic soda)."
    ),
    "kilogram_of_substance_90_%_dry": makeEUInformation(
        "KSD",
        "kg 90 % sdt",
        "kilogram of substance 90 % dry - A unit of mass equal to one thousand grams of a named substance that is 90% dry."
    ),
    kilogram_of_tungsten_trioxide: makeEUInformation(
        "KWO",
        "kg WO₃",
        "kilogram of tungsten trioxide - A unit of mass equal to one thousand grams of tungsten trioxide."
    ),
    kilogram_of_uranium: makeEUInformation(
        "KUR",
        "kg U",
        "kilogram of uranium - A unit of mass equal to one thousand grams of uranium."
    ),
    kilogram_per_millimetre_width: makeEUInformation("KI", "", "kilogram per millimetre width (10³ kg/m)"),
    kilogram_per_square_metre_pascal_second: makeEUInformation(
        "Q28",
        "kg/(m²·Pa·s)",
        "kilogram per square metre pascal second - Unit for the ability of a material to allow the transition of steam. (kg/(m² x Pa x s))"
    ),
    "kilogram(dry_weight)": makeEUInformation(
        "MND",
        "",
    ...
    "kilogram-force_metre_per_square_centimetre": makeEUInformation(
        "E44",
        "kgf·m/cm²",
        "kilogram-force metre per square centimetre - A unit of torsion defining the torque kilogram-force metre per square centimetre."
    ),
    kilosegment: makeEUInformation("KJ", "", "kilosegment - A unit of information equal to 10³ (1000) segments."),
    kilovolt_ampere_hour: makeEUInformation(
        "C79",
        "kVAh",
        "kilovolt ampere hour - A unit of accumulated energy of 1000 volt amperes over a period of one hour."
    ),
    kilovolt_ampere_reactive_demand: makeEUInformation(
        "K2",
        "",
    ...
    kilovolt_ampere_reactive_hour: makeEUInformation(
        "K3",
        "kvar·h",
        "kilovolt ampere reactive hour - A unit of measure defining the accumulated reactive energy equal to one kilovolt ampere of reactive power per hour."
    ),
    kilowatt_demand: makeEUInformation(
        "K1",
        "",
        "kilowatt demand - A unit of measure defining the power load measured at predetermined intervals."
    ),
    kilowatt_hour_per_cubic_metre: makeEUInformation(
        "E46",
        "kW·h/m³",
        "kilowatt hour per cubic metre - A unit of energy consumption expressed as kilowatt hour per cubic metre. (3,6 x 10⁶ J/m³)"
    ),
    kilowatt_hour_per_hour: makeEUInformation(
        "D03",
        "kW·h/h",
        "kilowatt hour per hour - A unit of accumulated energy of a thousand watts over a period of one hour."
    ),
    kilowatt_hour_per_kelvin: makeEUInformation(
        "E47",
        "kW·h/K",
        "kilowatt hour per kelvin - A unit of energy consumption expressed as kilowatt hour per kelvin. (3,6 x 10⁶ J/K)"
    ),
    ...
    litre_of_pure_alcohol: makeEUInformation(
        "LPA",
        "",
        "litre of pure alcohol - A unit of volume equal to one litre of pure alcohol."
    ),
    litre_per_hour: makeEUInformation(
        "E32",
        "l/h",
        "litre per hour - A unit of count defining the number of litres per hour. (2,777 78 x 10⁻⁷ m³/s)"
    ),
    load: makeEUInformation(
        "NL",
        "",
        "load - A unit of volume defining the number of loads (load: a quantity of items carried or processed at one time)."
    ),
    "lot[unit_of_procurement]": makeEUInformation(
        "LO",
        "",
        "lot [unit of procurement] - A unit of count defining the number of lots (lot: a collection of associated items)."
    ),
    "lot[unit_of_weight]": makeEUInformation(
        "D04",
        "",
        "lot [unit of weight] - A unit of weight equal to about 1/2 ounce or 15 grams."
    ),
    lump_sum: makeEUInformation(
        "LS",
        "",
        "lump sum - A unit of count defining the number of whole or a complete monetary amounts."
    ),
    manmonth: makeEUInformation(
        "3C",
        "",
        "manmonth - A unit of count defining the number of months for a person or persons to perform an undertaking."
    ),
    meal: makeEUInformation(
        "Q3",
        "",
        "meal - A unit of count defining the number of meals (meal: an amount of food to be eaten on a single occasion)."
    ),
    mebibit: makeEUInformation("D11", "Mibit", "mebibit - A unit of information equal to 2²⁰ (1048576) bits (binary digits)."),
    mebibit_per_cubic_metre: makeEUInformation(
        "E77",
        "Mibit/m³",
        "mebibit per cubic metre - A unit of information equal to 2²⁰ bits (binary digits) per cubic metre."
    ),
    mebibit_per_metre: makeEUInformation(
        "E75",
        "Mibit/m",
        "mebibit per metre - A unit of information equal to 2²⁰ bits (binary digits) per metre."
    ),
    mebibit_per_square_metre: makeEUInformation(
        "E76",
        "Mibit/m²",
        "mebibit per square metre - A unit of information equal to 2²⁰ bits (binary digits) per square metre."
    ),
    mebibyte: makeEUInformation("E63", "Mibyte", "mebibyte - A unit of information equal to 2²⁰ bytes."),
    megabaud: makeEUInformation(
        "J54",
        "MBd",
        "megabaud - A unit of signal transmission speed equal to 10⁶ (1000000) signaling events per second. (10⁶ Bd)"
    ),
    megabit: makeEUInformation("D36", "Mbit", "megabit - A unit of information equal to 10⁶ (1000000) bits (binary digits)."),
    megabit_per_second: makeEUInformation(
        "E20",
        "Mbit/s",
        "megabit per second - A unit of information equal to 10⁶ (1000000) bits (binary digits) per second."
    ),
    megabyte: makeEUInformation("4L", "Mbyte", "megabyte - A unit of information equal to 10⁶ (1000000) bytes."),
    megabyte_per_second: makeEUInformation(
        "P95",
        "Mbyte/s",
        "megabyte per second - 1 000 000-fold of the unit byte divided by the SI base unit second. (10⁶ byte/s)"
    ),
    megajoule_per_second: makeEUInformation(
        "D78",
        "MJ/s",
        "megajoule per second - A unit of accumulated energy equal to one million joules per second."
    ),
    megapixel: makeEUInformation("E38", "", "megapixel - A unit of count equal to 10⁶ (1000000) pixels (picture elements)."),
    megavolt_ampere_reactive_hour: makeEUInformation(
        "MAH",
        "Mvar·h",
        "megavolt ampere reactive hour - A unit of electrical reactive power defining the total amount of reactive power across a power system."
    ),
    megawatt_hour_per_hour: makeEUInformation(
        "E07",
        "MW·h/h",
        "megawatt hour per hour - A unit of accumulated energy of a million watts over a period of one hour."
    ),
    megawatt_per_hertz: makeEUInformation(
        "E08",
        "MW/Hz",
        "megawatt per hertz - A unit of energy expressed as the load change in million watts that will cause a frequency shift of one hertz."
    ),
    mesh: makeEUInformation(
        "57",
        "",
    ...
    "metric_ton(lubricating_oil)": makeEUInformation(
        "LUB",
        "",
    ...
    milliequivalence_caustic_potash_per_gram_of_product: makeEUInformation(
        "KO",
        "",
    ...
    "million_Btu(IT)_per_hour": makeEUInformation(
        "E16",
        "BtuIT/h",
        "million Btu(IT) per hour - A unit of power equal to one million British thermal units per hour. (293 071,1 W)"
    ),
    million_cubic_metre: makeEUInformation(
        "HMQ",
        "Mm³",
        "million cubic metre - A unit of volume equal to one million cubic metres."
    ),
    million_international_unit: makeEUInformation(
        "MIU",
        "",
        "million international unit - A unit of count defining the number of international units in multiples of 10⁶."
    ),
    module_width: makeEUInformation(
        "H77",
        "MW",
        "module width - A unit of measure used to describe the breadth of electronic assemblies as an installation standard or mounting dimension."
    ),
    mole_per_cubiv_metre_to_the_power_sum_of_stoichiometric_numbers: makeEUInformation(
        "P99",
        "(mol/m³)∑νB",
        "mole per cubiv metre to the power sum of stoichiometric numbers - Unit of the equilibrium constant on the basis of the concentration (ISO 80000-9:2009, 9-36.a)."
    ),
    monetary_value: makeEUInformation("M4", "", "monetary value - A unit of measure expressed as a monetary amount."),
    mutually_defined: makeEUInformation(
        "ZZ",
        "",
        "mutually defined - A unit of measure as agreed in common between two or more parties."
    ),
    natural_unit_of_information: makeEUInformation(
        "Q16",
        "nat",
        "natural unit of information - Logarithmic unit for information equal to the content of decision of a sentence of ,718 281 828 459 mutually exclusive events, expressed as a logarithm to base Euler value e. (nat)"
    ),
    natural_unit_of_information_per_second: makeEUInformation(
        "Q19",
        "nat/s",
        "natural unit of information per second - Time related logarithmic unit for information equal to the content of decision of a sentence of 2,718 281 828 459 mutually exclusive events, expressed as a logarithm to base of the Euler value e. (nat/s)"
    ),
    net_kilogram: makeEUInformation(
        "58",
        "",
        "net kilogram - A unit of mass defining the total number of kilograms after deductions."
    ),
    net_ton: makeEUInformation(
        "NT",
        "",
        "net ton - A unit of mass equal to 2000 pounds, see ton (US).  Refer International Convention on tonnage measurement of Ships."
    ),
    newton_metre_per_metre: makeEUInformation(
        "Q27",
        "N·m/m²",
        "newton metre per metre - Unit for length-related rotational moment as product of the derived SI unit newton and the SI base unit metre divided by the SI base unit metre. (m x kg x s⁻²)"
    ),
    nil: makeEUInformation("NIL", "()", "nil - A unit of count defining the number of instances of nothing."),
    number_of_articles: makeEUInformation(
        "NAR",
        "",
        "number of articles - A unit of count defining the number of articles (article: item)."
    ),
    number_of_cells: makeEUInformation(
        "NCL",
        "",
        "number of cells - A unit of count defining the number of cells (cell: an enclosed or circumscribed space, cavity, or volume)."
    ),
    number_of_international_units: makeEUInformation(
        "NIU",
        "",
        "number of international units - A unit of count defining the number of international units."
    ),
    number_of_jewels: makeEUInformation(
        "JWL",
        "",
        "number of jewels - A unit of count defining the number of jewels (jewel: precious stone)."
    ),
    number_of_packs: makeEUInformation(
        "NMP",
        "",
        "number of packs - A unit of count defining the number of packs (pack: a collection of objects packaged together)."
    ),
    number_of_parts: makeEUInformation(
        "NPT",
        "",
    ...
    octet: makeEUInformation("Q12", "o", "octet - Synonym for byte: 1 octet = 8 bit = 1 byte. (8 bit)"),
    octet_per_second: makeEUInformation(
        "Q13",
        "o/s",
        "octet per second - Unit octet divided by the SI base unit second. (8 bit/s)"
    ),
    one_per_one: makeEUInformation(
        "Q26",
        "1/1",
        "one per one - Value of the quotient from two physical units of the same kind as a numerator and denominator whereas the units are shortened mutually. (1/1)"
    ),
    outfit: makeEUInformation(
        "11",
        "",
    ...
    ozone_depletion_equivalent: makeEUInformation(
        "ODE",
        "",
    ...
    "page-hardcopy": makeEUInformation(
        "QB",
        "",
    ...
    page_per_inch: makeEUInformation(
        "PQ",
        "ppi",
        "page per inch - A unit of quantity defining the degree of thickness of a bound publication, expressed as the number of pages per inch of thickness."
    ),
    pair: makeEUInformation("PR", "", "pair - A unit of count defining the number of pairs (pair: item described by twos). (2)"),
    panel: makeEUInformation(
        "OA",
        "",
        "panel - A unit of count defining the number of panels (panel: a distinct, usually rectangular, section of a surface)."
    ),
    "part_per_billion(US)": makeEUInformation(
        "61",
        "ppb",
        "part per billion (US) - A unit of proportion equal to 10⁻⁹. (1 x 10⁻⁹)"
    ),
    part_per_hundred_thousand: makeEUInformation(
        "E40",
        "ppht",
        "part per hundred thousand - A unit of proportion equal to 10⁻⁵. (1 x 10⁻⁵)"
    ),
    part_per_million: makeEUInformation("59", "ppm", "part per million - A unit of proportion equal to 10⁻⁶. (1 x 10⁻⁶)"),
    ...
    pascal_to_the_power_sum_of_stoichiometric_numbers: makeEUInformation(
        "P98",
        "PaΣνB",
        "pascal to the power sum of stoichiometric numbers - Unit of the equilibrium constant on the basis of the pressure(ISO 80000-9:2009, 9-35.a)."
    ),
    pebibit_per_cubic_metre: makeEUInformation(
        "E82",
        "Pibit/m³",
        "pebibit per cubic metre - A unit of information equal to 2⁵⁰ bits (binary digits) per cubic metre."
    ),
    pebibit_per_metre: makeEUInformation(
        "E80",
        "Pibit/m",
        "pebibit per metre - A unit of information equal to 2⁵⁰ bits (binary digits) per metre."
    ),
    pebibit_per_square_metre: makeEUInformation(
        "E81",
        "Pibit/m²",
        "pebibit per square metre - A unit of information equal to 2⁵⁰ bits (binary digits) per square metre."
    ),
    pebibyte: makeEUInformation("E60", "Pibyte", "pebibyte - A unit of information equal to 2⁵⁰ bytes."),
    pen_calorie: makeEUInformation(
        "N1",
        "",
        "pen calorie - A unit of count defining the number of calories prescribed daily for parenteral/enteral therapy."
    ),
    "pen_gram(protein)": makeEUInformation(
        "D23",
        "",
    ...
    per_mille_per_psi: makeEUInformation(
        "J12",
        "‰/psi",
        "per mille per psi - A unit of pressure equal to one thousandth of a psi (pound-force per square inch). (1,450 377 x 10⁻⁷ Pa⁻¹)"
    ),
    percent: makeEUInformation("P1", "% or pct", "percent - A unit of proportion equal to 0.01. (1 x 10⁻²)"),
    percent_per_bar: makeEUInformation(
        "H96",
        "%/bar",
        "percent per bar - A unit of proportion, equal to 0.01, in relation to an atmospheric pressure of one bar. (10⁻⁷ Pa⁻¹)"
    ),
    percent_per_decakelvin: makeEUInformation(
        "H73",
        "%/daK",
        "percent per decakelvin - A unit of proportion, equal to 0.01, in relation to 10-fold of the SI base unit Kelvin. (10⁻³ K⁻¹)"
    ),
    percent_per_degree: makeEUInformation(
        "H90",
        "%/°",
        "percent per degree - A unit of proportion, equal to 0.01, in relation to an angle of one degree. (0,572 957 8 rad⁻¹)"
    ),
    percent_per_degree_Celsius: makeEUInformation(
        "M25",
        "%/°C",
        "percent per degree Celsius - A unit of proportion, equal to 0.01, in relation to a temperature of one degree. (10⁻² °C⁻¹)"
    ),
    percent_per_hectobar: makeEUInformation(
        "H72",
        "%/hbar",
        "percent per hectobar - A unit of proportion, equal to 0.01, in relation to 100-fold of the unit bar."
    ),
    percent_per_hundred: makeEUInformation(
        "H93",
        "%/100",
        "percent per hundred - A unit of proportion, equal to 0.01, in relation to multiples of one hundred. (10⁻⁴)"
    ),
    percent_per_inch: makeEUInformation(
        "H98",
        "%/in",
        "percent per inch - A unit of proportion, equal to 0.01, in relation to an inch. (0,393 700 8 m⁻¹)"
    ),
    percent_per_kelvin: makeEUInformation(
        "H25",
        "%/K",
        "percent per kelvin - A unit of proportion, equal to 0.01, in relation to the SI base unit Kelvin. (10⁻² K⁻¹)"
    ),
    percent_per_metre: makeEUInformation(
        "H99",
        "%/m",
        "percent per metre - A unit of proportion, equal to 0.01, in relation to a metre. (10⁻² m⁻¹)"
    ),
    percent_per_millimetre: makeEUInformation(
        "J10",
        "%/mm",
        "percent per millimetre - A unit of proportion, equal to 0.01, in relation to a millimetre. (10 m⁻¹)"
    ),
    percent_per_month: makeEUInformation(
        "H71",
        "%/mo",
        "percent per month - A unit of proportion, equal to 0.01, in relation to a month."
    ),
    percent_per_ohm: makeEUInformation(
        "H89",
        "%/Ω",
        "percent per ohm - A unit of proportion, equal to 0.01, in relation to the SI derived unit ohm. (10⁻² Ω⁻¹)"
    ),
    percent_per_one_hundred_thousand: makeEUInformation(
        "H92",
        "%/100000",
        "percent per one hundred thousand - A unit of proportion, equal to 0.01, in relation to multiples of one hundred thousand. (10⁻⁷)"
    ),
    percent_per_ten_thousand: makeEUInformation(
        "H91",
        "%/10000",
        "percent per ten thousand - A unit of proportion, equal to 0.01, in relation to multiples of ten thousand. (10⁻⁶)"
    ),
    percent_per_thousand: makeEUInformation(
        "H94",
        "%/1000",
        "percent per thousand - A unit of proportion, equal to 0.01, in relation to multiples of one thousand. (10⁻⁵)"
    ),
    percent_per_volt: makeEUInformation(
        "H95",
        "%/V",
        "percent per volt - A unit of proportion, equal to 0.01, in relation to the SI derived unit volt. (10⁻² V⁻¹)"
    ),
    percent_volume: makeEUInformation(
        "VP",
        "",
    ...
    "perm(0_ºC)": makeEUInformation(
        "P91",
        "perm (0 ºC)",
        "perm (0 ºC) - Traditional unit for the ability of a material to allow the transition of the steam, defined at a temperature of 0 °C as steam transmittance, where the mass of one grain steam penetrates an area of one foot squared at a pressure from one inch mercury per hour. (5,721 35 x 10⁻¹¹ kg/(m² x Pa x s))"
    ),
    "perm(23_ºC)": makeEUInformation(
        "P92",
        "perm (23 ºC)",
        "perm (23 ºC) - Traditional unit for the ability of a material to allow the transition of the steam, defined at a temperature of 23 °C as steam transmittance at which the mass of one grain of steam penetrates an area of one square foot at a pressure of one inch mercury per hour. (5,745 25 x 10⁻¹¹ kg/(m² x Pa x s))"
    ),
    person: makeEUInformation("IE", "", "person - A unit of count defining the number of persons."),
    petabit: makeEUInformation("E78", "Pbit", "petabit - A unit of information equal to 10¹⁵ bits (binary digits)."),
    petabit_per_second: makeEUInformation(
        "E79",
        "Pbit/s",
        "petabit per second - A unit of information equal to 10¹⁵ bits (binary digits) per second."
    ),
    petabyte: makeEUInformation("E36", "Pbyte", "petabyte - A unit of information equal to 10¹⁵ bytes."),
    pica: makeEUInformation(
        "R1",
        "",
    ...
    portion: makeEUInformation("PTN", "PTN", "portion - A quantity of allowance of food allotted to, or enough for, one person."),
    pound_per_ream: makeEUInformation(
        "RP",
        "",
        "pound per ream - A unit of mass for paper, expressed as pounds per ream. (ream: a large quantity of paper, typically 500 sheets)."
    ),
    "pound-force_foot_per_inch": makeEUInformation(
        "P89",
        "lbf·ft/in",
        "pound-force foot per inch - Unit for length-related rotational moment according to the Anglo-American and Imperial system of units. (53,378 66 m x kg / s²)"
    ),
    "pound-force_inch_per_inch": makeEUInformation(
        "P90",
        "lbf·in/in",
        "pound-force inch per inch - Unit for length-related rotational moment according to the Anglo-American and Imperial system of units. (4,448 222 m x kg / s²)"
    ),
    print_point: makeEUInformation("N3", "", "print point (0,013 8 in (approx))"),
    proof_gallon: makeEUInformation(
        "PGL",
        "",
    ...
    "quarter(UK)": makeEUInformation(
        "QTR",
        "Qr (UK)",
        "quarter (UK) - A traditional unit of weight equal to 1/4 hundredweight. In the United Kingdom, one quarter equals 28 pounds. (12,700 59 kg)"
    ),
    "quarter(of_a_year)": makeEUInformation(
        "QAN",
        "",
        "quarter (of a year) - A unit of time defining the number of quarters (3 months)."
    ),
    quire: makeEUInformation(
        "QR",
        "qr",
        "quire - A unit of count for paper, expressed as the number of quires (quire: a number of paper sheets, typically 25)."
    ),
    rack_unit: makeEUInformation(
        "H80",
        "U or RU",
        "rack unit - A unit of measure used to describe the height in rack units of equipment intended for mounting in a 19-inch rack or a 23-inch rack. One rack unit is 1.75 inches (44.45 mm) high. (4,445 × 10⁻² m)"
    ),
    rate: makeEUInformation("A9", "", "rate - A unit of quantity expressed as a rate for usage of a facility or service."),
    ration: makeEUInformation(
        "13",
        "",
        "ration - A unit of count defining the number of rations (ration: a single portion of provisions)."
    ),
    ream: makeEUInformation(
        "RM",
        "",
        "ream - A unit of count for paper, expressed as the number of reams (ream: a large quantity of paper sheets, typically 500)."
    ),
    reciprocal_centimetre: makeEUInformation("E90", "cm⁻¹", "reciprocal centimetre (10² m⁻¹)"),
    reciprocal_day: makeEUInformation("E91", "d⁻¹", "reciprocal day (1,157 41 × 10⁻⁵ s⁻¹)"),
    reciprocal_inch: makeEUInformation(
        "Q24",
        "1/in",
        "reciprocal inch - Complement of the unit inch according to the Anglo-American and Imperial system of units. (39,370 08 m⁻¹)"
    ),
    reciprocal_radian: makeEUInformation("P97", "1/rad", "reciprocal radian - Reciprocal of the unit radian. (1/rad)"),
    reciprocal_volt: makeEUInformation(
        "P96",
        "1/V",
        "reciprocal volt - Reciprocal of the derived SI unit volt. (m⁻² x kg⁻¹ x s³ x A)"
    ),
    revenue_ton_mile: makeEUInformation(
        "RT",
        "",
    ...
    rhe: makeEUInformation("P88", "rhe", "rhe - Non SI-conforming unit of fluidity of dynamic viscosity. (10 m x kg⁻¹ x s)"),
    room: makeEUInformation("ROM", "", "room - A unit of count defining the number of rooms."),
    round: makeEUInformation(
        "D65",
        "",
    ...
    running_or_operating_hour: makeEUInformation(
        "RH",
        "",
    ...
    second_per_kilogramm: makeEUInformation(
        "Q20",
        "s/kg",
        "second per kilogramm - Unit of the Einstein transition probability for spontaneous or inducing emissions and absorption according to ISO 80000-7:2008, expressed as SI base unit second divided by the SI base unit kilogram. (kg⁻¹ x s)"
    ),
    second_per_radian_cubic_metre: makeEUInformation(
        "Q22",
        "1/(Hz·rad·m³)",
        "second per radian cubic metre - Unit of the density of states as an expression of angular frequency as complement of the product of hertz and radiant and the power of SI base unit metre by exponent 3 . (m⁻³ x s x rad⁻¹)"
    ),
    segment: makeEUInformation("SG", "", "segment - A unit of information equal to 64000 bytes."),
    service_unit: makeEUInformation(
        "E48",
        "",
    ...
    set: makeEUInformation(
        "SET",
        "",
        "set - A unit of count defining the number of sets (set: a number of objects grouped together)."
    ),
    shannon: makeEUInformation(
        "Q14",
        "Sh",
        "shannon - Logarithmic unit for information equal to the content of decision of a sentence of two mutually exclusive events, expressed as a logarithm to base 2."
    ),
    shannon_per_second: makeEUInformation(
        "Q17",
        "Sh/s",
        "shannon per second - Time related logarithmic unit for information equal to the content of decision of a sentence of two mutually exclusive events, expressed as a logarithm to base 2. (Sh/s)"
    ),
    shares: makeEUInformation(
        "E21",
        "",
    ...
    square_metre_per_litre: makeEUInformation(
        "E31",
        "m²/l",
        "square metre per litre - A unit of count defining the number of square metres per litre."
    ),
    "square(roofing)": makeEUInformation(
        "SQR",
        "",
    ...
    standard_litre: makeEUInformation(
        "STL",
        "",
    ...
    "stick(military)": makeEUInformation(
        "15",
        "",
    ...
    tablet: makeEUInformation(
        "U2",
        "",
        "tablet - A unit of count defining the number of tablets (tablet: a small flat or compressed solid object)."
    ),
    tebibit_per_cubic_metre: makeEUInformation(
        "E86",
        "Tibit/m³",
        "tebibit per cubic metre - A unit of information equal to 2⁴⁰ bits (binary digits) per cubic metre."
    ),
    tebibit_per_metre: makeEUInformation(
        "E85",
        "Tibit/m",
        "tebibit per metre - A unit of information equal to 2⁴⁰ bits (binary digits) per metre."
    ),
    tebibit_per_square_metre: makeEUInformation(
        "E87",
        "Tibit/m²",
        "tebibit per square metre - A unit of information equal to 2⁴⁰ bits (binary digits) per square metre."
    ),
    tebibyte: makeEUInformation("E61", "Tibyte", "tebibyte - A unit of information equal to 2⁴⁰ bytes."),
    teeth_per_inch: makeEUInformation("TPI", "TPI", "teeth per inch - The number of teeth per inch. (0.0254 /m)"),
    telecommunication_line_in_service: makeEUInformation(
        "T0",
        "",
        "telecommunication line in service - A unit of count defining the number of lines in service."
    ),
    telecommunication_line_in_service_average: makeEUInformation(
        "UB",
        "",
        "telecommunication line in service average - A unit of count defining the average number of lines in service."
    ),
    telecommunication_port: makeEUInformation(
        "UC",
        "",
    ...
    terabit: makeEUInformation("E83", "Tbit", "terabit - A unit of information equal to 10¹² bits (binary digits)."),
    terabit_per_second: makeEUInformation(
        "E84",
        "Tbit/s",
        "terabit per second - A unit of information equal to 10¹² bits (binary digits) per second."
    ),
    ...
    tex: makeEUInformation(
        "D34",
        "tex (g/km)",
        "tex - A unit of yarn density. One decitex equals a mass of 1 gram per 1 kilometre of length. (10⁻⁶ kg/m)"
    ),
    theoretical_pound: makeEUInformation(
        "24",
        "",
        "theoretical pound - A unit of mass defining the expected mass of material expressed as the number of pounds."
    ),
    theoretical_ton: makeEUInformation(
        "27",
        "",
    ...
    thousand_cubic_foot: makeEUInformation(
        "FC",
        "kft³",
        "thousand cubic foot - A unit of volume equal to one thousand cubic foot."
    ),
    thousand_cubic_metre: makeEUInformation(
        "R9",
        "",
        "thousand cubic metre - A unit of volume equal to one thousand cubic metres. (10³m³)"
    ),
    thousand_cubic_metre_per_day: makeEUInformation(
        "TQD",
        "km³/d",
        "thousand cubic metre per day - A unit of volume equal to one thousand cubic metres per day. (1,157 41 x 10⁻² m³/s)"
    ),
    thousand_piece: makeEUInformation(
        "T3",
        "",
    ...
    thousand_standard_brick_equivalent: makeEUInformation(
        "MBE",
        "",
        "thousand standard brick equivalent - A unit of count defining the number of one thousand brick equivalent units."
    ),
    tonne_kilometre: makeEUInformation(
        "TKM",
        "t·km",
        "tonne kilometre - A unit of information typically used for billing purposes, expressed as the number of tonnes (metric tons) moved over a distance of one kilometre. (10⁶ kg x m)"
    ),
    total_acid_number: makeEUInformation(
        "TAN",
        "TAN",
        "total acid number - A unit of chemistry defining the amount of potassium hydroxide (KOH) in milligrams that is needed to neutralize the acids in one gram of oil. It is an important quality measurement of crude oil. (mg KOH/g )"
    ),
    treatment: makeEUInformation(
        "U1",
        "",
    ...
    "volt-ampere_per_kilogram": makeEUInformation("VA", "V·A / kg", "volt - ampere per kilogram (V x A / kg)"),
    volt_AC: makeEUInformation("2G", "V", "volt AC - A unit of electric potential in relation to alternating current (AC). (V)"),
    volt_DC: makeEUInformation("2H", "V", "volt DC - A unit of electric potential in relation to direct current (DC). (V)"),
    watt_per_kilogram: makeEUInformation("WA", "W/kg", "watt per kilogram (1 W/kg)"),
    watt_square_metre: makeEUInformation(
        "Q21",
        "W·m²",
        "watt square metre - Unit of the first radiation constants c1 = 2·p·h·c0², the value of which is 3,741 771 18·10?¹6-fold   that of the comparative value of the product of the derived SI unit watt multiplied with the power of the SI base unit metre with the exponent 2. (m⁴ x kg x s⁻³)"
    ),
    weber_to_the_power_minus_one: makeEUInformation(
        "Q23",
        "1/Wb",
        "weber to the power minus one - Complement of the derived SI unit weber as unit of the Josephson constant, which value is equal to the 384 597,891-fold of the reference value gigahertz divided by volt. (m⁻² x kg⁻¹ x s² x A)"
    ),
    well: makeEUInformation("E56", "", "well - A unit of count defining the number of wells."),
    wet_kilo: makeEUInformation(
        "W2",
        "",
        "wet kilo - A unit of mass defining the number of kilograms of a product, including the water content of the product."
    ),
    wet_pound: makeEUInformation(
        "WB",
        "",
        "wet pound - A unit of mass defining the number of pounds of a material, including the water content of the material."
    ),
    wet_ton: makeEUInformation(
        "WE",
        "",
