...
export function utest_limit_alarm(test: MochaSuiteEx): void {
    describe("Limit Alarms ", () => {
        ...
        it("should instantiate a ExclusiveLimitAlarm", () => {
            ...
            alarm.constructor.name.should.eql("UAExclusiveLimitAlarmImplBase");
            ...
            alarm.removeListener("event", spyOnEvent);
        });
        ...
        describe("Testing alarms with enabledState false", () => {
            it("should not raise alarm if the alarm is not enabled", () => {
                ...
                const _alarm = addressSpace.getOwnNamespace().instantiateNonExclusiveLimitAlarm("NonExclusiveLimitAlarmType", {
        ...
        [
            ...
            it(`VM1 it should raise an exception if the input node has an invalid dataType : ${DataType[dataType]}`, () => {
                ...
                (function instantiateExclusiveLimitAlarm() {
                    const _alarm = namespace.instantiateExclusiveLimitAlarm("ExclusiveLimitAlarmType", {
                        browseName: "MyExclusiveAlarm",
                        conditionSource: source,
                        highHighLimit: 100.0,
                        highLimit: 10.0,
