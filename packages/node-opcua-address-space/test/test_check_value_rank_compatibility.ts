...
import { checkValueRankCompatibility } from "../impl/check_value_rank_compatibility.js";
...
describe("test value rank compatibility", () => {
    ...
    describe("when base valueRank is AnyDimension", () => {
        ...
        it("AnyDimension", () => {
            const { result, errorMessage: _ } = checkValueRankCompatibility(AnyDimension, referencedValueRank);
            result.should.equal(true);
        });
        it("OneOrMoreDimensions", () => {
            const { result, errorMessage: _ } = checkValueRankCompatibility(OneOrMoreDimensions, referencedValueRank);
