...
describe("Extending extension object variables", function (this: Mocha.Suite) {
    ...
    function addVariable_setValueFromSource_installExtensionObjectVariable_array() {
        ...
        uaVariable.setValueFromSource(
            ...
            StatusCodes.Good,
            new Date(Date.UTC(nextYear, 0, 1))
        );
    ...
    function addVariable_bindExtensionObject_matrix() {
        ...
        uaVariable.bindExtensionObjectArray([p1.clone(), p2.clone(), p3.clone(), p1.clone(), p2.clone(), p3.clone()], {
            createMissingProp: true
        });
        return uaVariable;
    }

    [addVariable_setValueFromSource_installExtensionObjectVariable_matrix, addVariable_bindExtensionObject_matrix].forEach(
        (build, index) => {
