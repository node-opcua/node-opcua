...
export class UAReferenceType extends BaseNode implements UAReferenceTypePublic {
     ...
     * @private
     */
    public _slow_isSupertypeOf: (baseType: UAReferenceType) => boolean = tools.construct_slow_isSupertypeOf<UAReferenceType>(UAReferenceType);
    ...
    public checkHasSubtype(ref: Reference | NodeId) {
        const _index = _getSubtypeIndex(this);
        const referenceTypeNodeId = ref instanceof Reference ? ref.nodeId : ref as NodeId;
