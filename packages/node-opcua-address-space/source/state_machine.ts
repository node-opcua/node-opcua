...
export interface StateVariableType extends UAVariableTypeT<LocalizedText>, StateVariableB {
}
...
export interface StateMachineType extends StateMachineB, UAObjectType {
}

export declare class StateMachine extends UAObject implements StateMachineB {

    public static promote(node: UAObject): StateMachine;

    public readonly currentState: StateVariable;
    public readonly lastTransition?: TransitionVariable | null;
    public readonly initialState: InitialState | null;
    ...
    public setState(toStateNode: State | string): void;
}
