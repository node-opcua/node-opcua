...
describe("Testing AccessRestrictionsFlag", function() {
    ...
    it("AccessRestrictionsFlagToString", () => {
        ...
        accessRestrictionsFlagToString(AccessRestrictionsFlag.EncryptionRequired | AccessRestrictionsFlag.ApplyRestrictionsToBrowse)
            .should.eql("EncryptionRequired | ApplyRestrictionsToBrowse");
        accessRestrictionsFlagToString(AccessRestrictionsFlag.SessionRequired)
            .should.eql("SessionRequired");
