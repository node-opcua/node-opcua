...
describe("Testing AccessLevelExFlag", function () {
    ...
    it("should create a access level extended flags from a string", function () {
        ...
        makeAccessLevelExFlag("CurrentWrite | CurrentRead | NonatomicRead")
            .should.equal(AccessLevelExFlag.CurrentRead + AccessLevelExFlag.CurrentWrite + AccessLevelExFlag.NonatomicRead);
        makeAccessLevelExFlag("NonatomicWrite | WriteFullArrayOnly | NonatomicRead")
        .should.equal(AccessLevelExFlag.NonatomicWrite + AccessLevelExFlag.WriteFullArrayOnly + AccessLevelExFlag.NonatomicRead);
    ...
    it("should have a accessLevel Flag Basic Type", function () {
        (findBuiltInType("AccessLevelExFlag") !== null && typeof findBuiltInType("AccessLevelExFlag") === "object").should.equal(true);
    });
    ...
    it("accessLevelExFlagToString", () => {
        ...
        accessLevelExFlagToString(AccessLevelExFlag.HistoryRead | AccessLevelExFlag.CurrentRead).should.eql("CurrentRead | HistoryRead");
        accessLevelExFlagToString(0x3F | AccessLevelExFlag.TimestampWrite).should.eql("CurrentRead | CurrentWrite | StatusWrite | TimestampWrite | HistoryRead | HistoryWrite | SemanticChange");
        ...
        accessLevelExFlagToString(AccessLevelExFlag.NoSubDataTypes | AccessLevelExFlag.NonatomicWrite | AccessLevelExFlag.NonatomicRead)
