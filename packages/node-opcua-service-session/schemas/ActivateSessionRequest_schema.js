...
const ActivateSessionRequest_Schema = {
    ...
    fields: [
        ...
        },
        {
            ...
            documentation: "A signature created with the client certificate from the last server nonce returned by the server."
        },
        {
            name: "clientSoftwareCertificates",
            isArray: true,
            fieldType: "SignedSoftwareCertificate",
            documentation: "The software certificates owned by the client."
        },
        ...
        { name: "userIdentityToken", fieldType: "ExtensionObject", documentation: "The user identity to use with the session." },
        {
            ...
            fieldType: "SignatureData",
            documentation: "A digital signature created with the user identity token."
        }
    ]
};
