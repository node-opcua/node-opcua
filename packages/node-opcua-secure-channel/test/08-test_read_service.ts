...
describe("Read Service", () => {
    it("should decode a real ReadRequest 1/2", (done) => {
        redirectToFile(
            "ws_ReadRequest.log",
            () => {
    ...
    it("should decode a real ReadRequest 2/2", (done) => {
        redirectToFile(
            "ws_ReadRequest2.log",
            () => {
    ...
    it("should decode a real ReadResponse 1/2", (done) => {
        redirectToFile(
            "ws_ReadResponse.log",
            () => {
    ...
    it("should decode a real ReadResponse 2/2", (done) => {
        redirectToFile(
            "ws_ReadResponse2.log",
            () => {
    ...
    it("should encode and decode a ReadRequest ", () => {
