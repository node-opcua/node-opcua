...
describe("Testing multi chunk", () => {
    it("should decode a real BrowseRequest", (done) => {
        redirectToFile(
            "ws_BrowseRequest.log",
            () => {
    ...
    it("should decode a real BrowseResponse", (done) => {
        redirectToFile(
            "ws_BrowseResponse.log",
            () => {
    ...
    it("should decode a real BrowseResponse with StatusCode error and some diagnostic info", (done) => {
        redirectToFile(
            "ws_BrowseResponse2.log",
            () => {
