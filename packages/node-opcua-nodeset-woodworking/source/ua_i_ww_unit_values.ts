...
export interface UAIWwUnitValues_Base extends UABaseInterface_Base {
     ...
     * msec.
     */
    absoluteErrorTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absoluteLength
     * The AbsoluteLength Variable provides the absolute
     * produced length in mm.
     */
    absoluteLength?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     */
    absoluteMachineOffTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     */
    absoluteMachineOnTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absolutePiecesIn
     ...
     * machine.
     */
    absolutePiecesIn?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absolutePiecesOut
     ...
     * machine.
     */
    absolutePiecesOut?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     */
    absolutePowerPresentTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     */
    absoluteProductionTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     * and WaitLoad state.
     */
    absoluteProductionWaitWorkpieceTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     * !PiecesPresent state.
     */
    absoluteProductionWithoutWorkpieceTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absoluteReadyTime
     ...
     * msec.
     */
    absoluteReadyTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absoluteRunsAborted
     * The AbsoluteRunsAborted Variable provides the
     * absolute count of aborted runs.
     */
    absoluteRunsAborted?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absoluteRunsGood
     * The AbsoluteRunsGood Variable provides the
     * absolute count of finished runs.
     */
    absoluteRunsGood?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absoluteRunsTotal
     * The AbsoluteRunsTotal Variable provides the
     * absolute count of total runs.
     */
    absoluteRunsTotal?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absoluteStandbyTime
     ...
     * msec.
     */
    absoluteStandbyTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * absoluteWorkingTime
     ...
     * msec.
     */
    absoluteWorkingTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * actualCycle
     * The ActualCycle Variable provides the parts per
     * minutes.
     */
    actualCycle?: UABaseAnalog<number, /*z*/DataType.Double>;
    /**
     * axisOverride
     * The AxisOverride Variable provides the override
     * for the axis in percent.
     */
    axisOverride?: UABaseAnalog<UInt32, /*z*/DataType.UInt32>;
    /**
     * feedSpeed
     * The FeedSpeed Variable provides the feed speed in
     * m/min for throughfeed machines.
     */
    feedSpeed?: UABaseAnalog<number, /*z*/DataType.Double>;
    /**
     * relativeErrorTime
     ...
     * in msec.
     */
    relativeErrorTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativeLength
     ...
     * started.
     */
    relativeLength?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     */
    relativeMachineOnTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativePiecesIn
     ...
     */
    relativePiecesIn?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativePiecesOut
     ...
     * machine since the machine has started.
     */
    relativePiecesOut?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     * state.
     */
    relativePowerPresentTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     */
    relativeProductionTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     * WaitLoad state.
     */
    relativeProductionWaitWorkpieceTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     ...
     * !PiecesPresent state.
     */
    relativeProductionWithoutWorkpieceTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativeReadyTime
     ...
     * in msec.
     */
    relativeReadyTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativeRunsAborted
     ...
     * has started.
     */
    relativeRunsAborted?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativeRunsGood
     ...
     * has started.
     */
    relativeRunsGood?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativeRunsTotal
     ...
     * has started.
     */
    relativeRunsTotal?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativeStandbyTime
     ...
     * state in msec.
     */
    relativeStandbyTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * relativeWorkingTime
     ...
     * state in msec.
     */
    relativeWorkingTime?: UABaseAnalog<UInt64, /*z*/DataType.UInt64>;
    /**
     * spindleOverride
     * The SpindleOverride Variable provides the
     * override for the spindle in percent.
     */
    spindleOverride?: UABaseAnalog<UInt32, /*z*/DataType.UInt32>;
}
