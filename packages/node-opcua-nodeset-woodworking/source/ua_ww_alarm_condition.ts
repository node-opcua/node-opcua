...
import type { UAAlarmCondition, UAAlarmCondition_Base } from "node-opcua-nodeset-ua/dist/ua_alarm_condition.js";
...
/**
 * The WwAlarmContitionType represents an
 * acknowledgeable and confirmable state of a
 * woodworking system or one of its components
 * containing an active state.
 *
 * |                |                                                            |
 * |----------------|------------------------------------------------------------|
 * |namespace       |http://opcfoundation.org/UA/Woodworking/                    |
 * |nodeClass       |ObjectType                                                  |
 * |typedDefinition |WwAlarmConditionType i=1007                                 |
 * |isAbstract      |false                                                       |
 */
export interface UAWwAlarmCondition_Base extends UAAlarmCondition_Base {
    /**
     * arguments
...
export interface UAWwAlarmCondition extends UAAlarmCondition, UAWwAlarmCondition_Base {}