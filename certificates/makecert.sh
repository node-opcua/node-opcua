...
openssl req -x509 -days 365 -nodes -newkey rsa:2048 -keyout ../test/helpers/demo_client_key256.pem -out ../test/helpers/demo_client_cert256.pem -config cert.cnf
openssl rsa -in ../test/helpers/demo_client_key256.pem -pubout > ../test/helpers/demo_client_public_key256.pub
